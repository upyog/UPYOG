...
<script type="text/javascript">
		function validateAndSubmit(obj){
			...
			var value = obj.value;
			document.chartOfAccountsForm.action='${pageContext.request.contextPath}/masters/chartOfAccounts-modifySearchSecondary.action';
...
<body class="yui-skin-sam">
	...
	<div class="formmainbox">
		<div class="subheadnew">
			<s:text name="chartOfAccount.secondary" />
		</div>
	...
	<script type="text/javascript">
	var allGlcodes = [];
	<s:iterator value="allSecondaryChartOfAccounts">
