...
<html>
<head>
<title><s:text name="lbl.add.secondary.chart.of.accounts"/></title>
<script type="text/javascript">
		function validateAndSubmit(){
			...
			document.chartOfAccountsForm.action = '${pageContext.request.contextPath}/masters/chartOfAccounts-createSecondary.action';
		...
		function generateGlCode(){
			...
			var transaction = YAHOO.util.Connect.asyncRequest('GET', 'chartOfAccounts-ajaxNextSecondaryGlCode.action?parentGlcode='+value.split("-")[0], callback, null);
...
<body class="yui-skin-sam">
	...
	<div class="formmainbox">
		<div class="subheadnew"><s:text name="lbl.add.secondary.chart.of.accounts"/></div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td class="bluebox" width="10%"><input type="text"
						...
						size="3" maxlength='<s:property value="glCodeLengths[5l]"/>' /></td>
				</tr>
				<tr>
