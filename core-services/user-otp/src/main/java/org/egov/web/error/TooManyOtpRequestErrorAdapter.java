...
public class TooManyOtpRequestErrorAdapter implements ErrorAdapter<Void> {
	...
	private static final String OTP_TIMED_OUT = "OTP.OTP_LIMIT_REACHED";
	private static final String OTP_TIMED_OUT_MESSAGE = "Reached Limit to Send OTP Please wait 20 Minutes";
