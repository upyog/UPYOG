const envVariables = {
  ...
  EGOV_LOCALISATION_HOST:
    process.env.EGOV_LOCALISATION_HOST || "http://localhost:8087",
  EGOV_LOCALISATION_SEARCH:
    process.env.EGOV_LOCALISATION_SEARCH || "/localization/messages/v2/_search",
  EGOV_FILESTORE_SERVICE_HOST:
    process.env.EGOV_FILESTORE_SERVICE_HOST || "http://localhost:8086",
  SERVER_PORT: process.env.SERVER_PORT || 8093,
  ...
  EGOV_EXTERNAL_HOST: process.env.EGOV_EXTERNAL_HOST || "http://localhost" ,
  ...
  DEFAULT_LOCALISATION_LOCALE:
    ...
    DATA_CONFIG_URLS: process.env.DATA_CONFIG_URLS || "file://C:/Users/Administrator/DIGIT/upyog_configs_forked_Dev2.0/upyog-configs/configs/pdf-service/data-config/property-receipt.json",
    FORMAT_CONFIG_URLS: process.env.FORMAT_CONFIG_URLS || "file://C:/Users/Administrator/DIGIT/upyog_configs_forked_Dev2.0/upyog-configs/configs/pdf-service/format-config/property-receipt.json"
};
