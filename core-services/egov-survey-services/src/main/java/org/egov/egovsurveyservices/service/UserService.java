...
import org.egov.egovsurveyservices.web.models.user.UserDetailResponse;
...
public class UserService {
    ...
    @Autowired
    public UserService(ApplicationProperties config, ServiceRequestRepository serviceRequestRepository, ObjectMapper mapper) {
        this.config = config;
     ...
     */
    public Map<String,UserSearchResponseContent> searchUser(RequestInfo requestInfo,List<String> uuids){
        ...
        Map<String, UserSearchResponseContent> idToUserMap = new HashMap<>();
    ...
    private UserDetailResponse userCall(Object userRequest, StringBuilder uri) {
        ...
        try{
            LinkedHashMap responseMap = (LinkedHashMap)serviceRequestRepository.fetchResult(uri, userRequest).orElse(null);
