...
public class CacheConfig {
	...
	public KeyGenerator subschemeSearchKeyGenerator() {
		return (target, method, params) -> {
			...
			addIfNotNull(parts, "createdDate",
					subSchemeModel.getCreatedDate() != null ? subSchemeModel.getCreatedDate().getTime() : null);
			addIfNotNull(parts, "lastModifiedBy", subSchemeModel.getLastModifiedBy());
			addIfNotNull(parts, "lastModifiedDate",
					subSchemeModel.getLastModifiedDate() != null ? subSchemeModel.getLastModifiedDate().getTime()
							: null);
