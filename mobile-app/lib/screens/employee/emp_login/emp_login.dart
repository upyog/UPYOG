...
class _EmpLoginScreen2State extends State<EmpLoginScreen2> {
  ...
  Future<void> validateLoginForm() async {
    ...
    await _authController.otpValidate(userType: UserType.EMPLOYEE);
      ...
      body:
        ...
        child: SingleChildScrollView(
          child: SizedBox(
            ...
            child: Stack(
              children: [
                SliderImageWidget(height: 320.h),
                Positioned(
                  top: 50.h,
                  left: 25.w,
                  child: Image.asset(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SmallTextNotoSans(
                                  text:
                                      'Please select how you want to login to the ${BaseConfig.APP_NAME} application',
                          ...
                          SizedBox(
                            ...
                            child: Obx(() {
                              final isUsernameValid =
                                  _authController.usernameText.value.isNotEmpty;
                              final isPasswordValid =
                                  _authController.passwordText.value.isNotEmpty;
                              final isCityValid = _cityController
                                  .empSelectedCity.value.isNotEmpty;
        ...
        children: [
          ...
          Obx(
            () => TextFormFieldApp(
              ...
              label:
                  Text('${getLocalizedString(i18.common.EMPLOYEE_PASSWORD)} *'),
              maxLine: 1,
          ...
          DropdownSearch<String>(
            items: _languageController.mdmsResTenant.tenants?.map((tenant) {
                  return '${tenant.code} | ${tenant.name} | ${tenant.city?.name}';
                }).toList() ??
                [],
            selectedItem:
                isNotNullOrEmpty(_cityController.empSelectedCity.value)
            ...
            dropdownBuilder: (context, selectedItem) {
              final code = selectedItem?.split(' | ').first ?? '';
              final item =
                  _languageController.mdmsResTenant.tenants?.firstWhere(
                (tenant) => tenant.code == code,
                orElse: () =>
              ...
              itemBuilder: (context, item, isSelected) {
                ...
                return ListTile(
                  title: SmallTextNotoSans(
                    text: (!isNotNullOrEmpty(tenant?.code) &&
  ...
  //         SizedBox(height: 10.h),
  //         DropdownSearch<String>(
  //           items: _languageController.mdmsResTenant.tenants?.map((item) {
  //                 return item.code ?? "";
  //               }).toList() ??
  //               [],
