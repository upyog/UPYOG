                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        border: Border.all(
                            width: 2, color: BaseConfig.appThemeColor1,),
                      ),
                      child: Row(
                        children: [
                          IconButton(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                contentPadding: EdgeInsets.all(
                                    o == Orientation.portrait ? 8.w : 1.w,),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => Center(
                          child: Card(
                            ...
                            if (filteredTopServicesData[index].title ==
                                    'Property Tax' ||
                                BaseConfig
                        ...
                        for (DashboardIcon search in searchHistory.reversed)
                          ListTile(
                            ...
                            leading: const Icon(Icons.history,
                                color: BaseConfig.textColor, size: 20,),
                            onTap: () {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        if (filteredData[index].title ==
                            'OBPS Permit Applications') {
                          Get.toNamed(AppRoutes.BPA_PERMIT_APPLICATION);
                        }
                        if (filteredData[index].title ==
                            'OBPS Occupancy Certificate') {
