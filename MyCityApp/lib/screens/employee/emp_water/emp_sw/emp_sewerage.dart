...
class EmpSewerageScreen extends StatefulWidget {
  const EmpSewerageScreen({super.key});

  @override
  State<EmpSewerageScreen> createState() => _EmpSewerageScreenState();
}

class _EmpSewerageScreenState extends State<EmpSewerageScreen> {
  ...
  Future<void> _fetchInbox() async {
    ...
    await _waterController.getEmpSwInboxApplications(
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final serviceCode = BusinessServicesEmp.NEW_SW1.name;
              ...
              return businessObject != null
                  ? ComplainCard(
                      title: getLocalizedString(
                        '${i18.common.EMP_INBOX}${statusMap?.businessService ?? BusinessServicesEmp.NEW_SW1.name}'
                            .toUpperCase(),
                      ),
