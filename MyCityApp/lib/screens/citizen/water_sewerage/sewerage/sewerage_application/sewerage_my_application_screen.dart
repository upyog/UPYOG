...
class SewerageMyApplicationsScreen extends StatefulWidget {
  const SewerageMyApplicationsScreen({super.key});

  @override
  State<SewerageMyApplicationsScreen> createState() =>
      _SewerageMyApplicationsScreenState();
}

class _SewerageMyApplicationsScreenState
    extends State<SewerageMyApplicationsScreen> {
  ...
  void goPayment(SewerageConnection sewerageConnection) async {
    ...
    Get.to(
      () => PaymentScreen(
        ...
        cityTenantId: sewerageConnection.tenantId!,
