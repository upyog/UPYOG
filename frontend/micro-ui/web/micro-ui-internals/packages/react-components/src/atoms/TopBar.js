      ...
      <div className="center-container back-wrapper" style={{display:"flex",justifyContent:"space-between"}}>
        ...
        <div className="hambuger-back-wrapper" style={{display:"flex"}}>
          ...
          <a style={{display: 'inline-flex'}} href={window.location.href.includes("citizen")?"/digit-ui/citizen":"/digit-ui/employee"}><img
            className="city"
            id="topbar-logo"
            src={"https://mnptapp-terraform.s3.ap-south-1.amazonaws.com/images/trlogo2.png" || "https://cdn.jsdelivr.net/npm/@upyog/digit-ui-css@1.0.7/img/m_seva_white_logo.png"}
            // {"https://in-egov-assets.s3.ap-south-1.amazonaws.com/images/Upyog-logo.png" || "https://cdn.jsdelivr.net/npm/@upyog/digit-ui-css@1.0.7/img/m_seva_white_logo.png"}
            alt="UPYOG"
          />
        ...
        <div className="RightMostTopBarOptions">
          ...
          className="city"
          id="topbar-logo" 
          src={"https://mnptapp-terraform.s3.ap-south-1.amazonaws.com/images/logo2.png" || "https://cdn.jsdelivr.net/npm/@upyog/digit-ui-css@1.0.7/img/m_seva_white_logo.png"}
          alt="mSeva"
