...
const MDMSEdit = ({...props}) => {
  ...
  const { isLoading, data, isFetching } = Digit.Hooks.useWorkBenchCustomAPIHook(reqCriteria);
  const { isLoading:isLoadingSchema,data: schemaData,isFetching: isFetchingSchema,...rest } = Digit.Hooks.useWorkBenchCustomAPIHook(reqCriteriaSchema);
