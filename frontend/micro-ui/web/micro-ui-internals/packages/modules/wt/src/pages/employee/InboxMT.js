...
import MTDesktopInbox from "../../components/MTDesktopInbox";
import MobileInbox from "../../components/MobileInbox";

/**
 * `Inbox` is a responsive React component that displays and manages Mobile Toilet (MT) service requests.
...
const InboxMT = ({
  ...
  const [TableConfig, setTableConfig] = useState(() => Digit.ComponentRegistryService?.getComponent("MTInboxTableConfig"));
