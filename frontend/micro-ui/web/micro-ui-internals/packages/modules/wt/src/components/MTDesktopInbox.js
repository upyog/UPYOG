...
/**
 * `MTDesktopInbox` is a desktop view component for managing and displaying Mobile Toilet (MT) service applications.
 ...
 * - Displays a loader if data is loading.
 ...
 * 
 * The component also handles the display of filters, search functionality, and conditionally shows additional links related to the MT service.
 * 
 */


const MTDesktopInbox = ({ tableConfig, filterComponent, ...props }) => {
