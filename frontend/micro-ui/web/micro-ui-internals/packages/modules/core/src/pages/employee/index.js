...
import { PrivateRoute } from "@demodigit/digit-ui-react-components";
    ...
    <div className="employee">
      <Switch>
        <Route path={`${path}/user`}>
          ...
          >
            <div className="loginnn">
              ...
              <picture>
              <source id="backgroung-login" media="(min-width: 950px)" srcset="https://i.postimg.cc/3xf8zSH0/photo-1694667509674-676629c9d069-4.jpg" style={{"position":"absolute","height":"100%","width":"100%"}} />
                  <source media="(min-width: 250px)" srcset="https://i.postimg.cc/3xf8zSH0/photo-1694667509674-676629c9d069-4.jpg" />
                    <img src="https://i.postimg.cc/3xf8zSH0/photo-1694667509674-676629c9d069-4.jpg" alt="imagealttext" style={{"position":"absolute","height":"100%","width":"100%","zIndex":"1","display":window.location.href.includes("user/profile")?"none":""}}/>
                    </picture>
            ...
            <Switch>
              <Route path={`${path}/user/login`}>
                <EmployeeLogin style={{display:"flex",alignItems:"flex-start"}}/>
              </Route>
          ...
          <div className={`main ${DSO ? "m-auto" : ""}`}>
            ...
            {/* <div className="footerr" style={{ width: '100%', bottom: 0,backgroundColor:"white",color:"black !important"}}>
              <div style={{ display: 'flex', justifyContent: 'center', color:"color","backgroundColor":"#808080b3"  }}>
                ...
                <span style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Copyright © 2025  Nashik Municipal Corporation </span>
                <span style={{ margin: "0 10px" }}>|</span>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', color:"black" }}>
          <span  className="upyog-copyright-footer" style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} onClick={() => { window.open('', '_blank').focus();}} >Copyright © 2025  Nashik Municipal Corporation </span>
          
          {/* <a style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} href="#" target='_blank'>MEA</a> */}
        </div>
        <div className="upyog-copyright-footer-web">
          <span className="" style={{ cursor: "pointer", fontSize:  window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Copyright © 2025  Nashik Municipal Corporation </span>
          </div>
      </div>
          </div>
        </Route>
