...
import { Card, DateWrap, KeyNote } from "@demodigit/digit-ui-react-components";
import { CardSubHeader } from "@demodigit/digit-ui-react-components";
...
const Complaint = ({ data, path }) => {
  ...
  const handleClick = () => {
    history.push(`${path}/inc/${serviceRequestId}`);
  };
