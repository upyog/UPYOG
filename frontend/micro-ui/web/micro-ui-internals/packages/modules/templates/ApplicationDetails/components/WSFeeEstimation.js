...
import { Card, CardSectionHeader, CardLabel } from "@demodigit/digit-ui-react-components";
import { Modal, Dropdown, Row, StatusTable, TextInput, Toast } from "@demodigit/digit-ui-react-components";
        ...
        <Fragment>
            <div style={{ lineHeight: "19px", maxWidth: "950px", minWidth: "280px" }}>
                    ...
                    </StatusTable>}
                {
                    ...
                    >
                        <span style={{ cursor: "pointer", color: "#162f6a" }}>{t("WS_PAYMENT_ADD_REBATE_PENALTY")}</span>
                    </div> : null
                }
                {popup &&
                    <Modal
