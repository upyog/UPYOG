        ...
        <React.Fragment>
            <div style={{ marginBottom: "16px" }}>
                <div style={{ border: "1px solid #E3E3E3", padding: "16px", marginTop: "8px" }}>
                    ...
                    <CardLabelError style={errorStyle}>{localFormState.touched.modeOfPossessionOrAcquisition ? errors?.modeOfPossessionOrAcquisition?.message : ""}</CardLabelError>
                    ...
                    <CardLabelError style={errorStyle}>{localFormState.touched.bookValue ? errors?.bookValue?.message : ""}</CardLabelError>            </div>
            </div>
            {showToast?.label && (
                <Toast
