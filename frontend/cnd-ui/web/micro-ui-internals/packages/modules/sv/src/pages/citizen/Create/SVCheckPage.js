      ...
      <Card>
        ...
        <div>
          ...
          <Row
              ...
              actionButton={(isRenew)?null:<ActionButton jumpTo={`/cnd-ui/citizen/sv/apply/applicant-details`} />}
          />
          <Row
          ...
          <Row
              ...
              actionButton={(isRenew)?null:<ActionButton jumpTo={`/cnd-ui/citizen/sv/apply/business-details`} />}
          />
          <Row
          ...
          bankdetails?.accountHolderName&&(
            <React.Fragment>
              ...
              actionButton={(isRenew)?null:<ActionButton jumpTo={`/cnd-ui/citizen/sv/apply/bank-details`} />}
              />
              <Row
          ...
          <Row
              ...
              actionButton={(isRenew)?null:<ActionButton jumpTo={`/cnd-ui/citizen/sv/apply/address-details`} />}
              />
              <Row
          ...
          <Row
            ...
            actionButton={(isRenew)?null:<ActionButton jumpTo={`/cnd-ui/citizen/sv/apply/special-category`} />}
            />
        ...
        {/* If Make Payment application, renders Make payment button otherwise renders the submit button */}
        {
          !isMakePayment ?
            ...
            :
            <Link to={{ pathname: `/cnd-ui/citizen/payment/my-bills/sv-services/${renewalData?.applicationNo}`, state: { tenantId: renewalData?.tenantId, applicationNumber: renewalData?.applicationNo } }}>
