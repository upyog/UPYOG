...
const StreetVendingApplication = ({ application, buttonLabel,previousDraftId,onDiscard }) => {
  ...
  const handleEditClick = () => {
    ...
    history.push(`/cnd-ui/citizen/sv/edit`);
  };
  ...
  return (
    <Card>
      ...
      <div style={{ display: "flex", gap: "5px" }}>
        <Link to={isDraft ? `/cnd-ui/citizen/sv/apply/info` : `/cnd-ui/citizen/sv/application/${application?.applicationNo}/${application?.tenantId}`}>
