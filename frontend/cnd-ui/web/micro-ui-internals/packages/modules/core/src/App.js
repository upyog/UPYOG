...
export const CndApp = ({ stateCode, modules, appTenants, logoUrl, initData }) => {
  ...
  return (
    <Routes>
      <Route path="/cnd-ui/employee/*" element={<EmployeeApp {...commonProps} />} />
      <Route path="/cnd-ui/citizen/*" element={<CitizenApp {...commonProps} />} />
      <Route path="*" element={<Navigate to="/cnd-ui/citizen" />} />
    </Routes>
  );
};
