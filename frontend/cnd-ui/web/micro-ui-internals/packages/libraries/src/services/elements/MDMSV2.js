...
export const MdmsServiceV2 = {
  ...
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetClassificationList(tenantId, moduleCode, type), moduleCode);
  // },
  // getAssetparentsubcategory: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetparentsubcategoryList(tenantId, moduleCode, type), moduleCode);
  // },
  ...
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetSubParentList(tenantId, moduleCode, type), moduleCode);
  // },
  ...
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetParentList(tenantId, moduleCode, type), moduleCode);
  // },
  // getAssetParent: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetParentList(tenantId, moduleCode, type), moduleCode);
  // },
  // getAssetDocuments: (tenantId, moduleCode) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetDocumentsCategory(tenantId, moduleCode), moduleCode);
  // },
  
  // Assetcommondetail: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getAssetcommonList(tenantId, moduleCode, type), moduleCode);
  // },
  ...
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getPetDocumentsRequiredScreenCategory(tenantId, moduleCode), moduleCode);
  // },

  // getPetType: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getPetTypeList(tenantId, moduleCode, type), moduleCode);
  // },

  // getBreedType: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getBreedTypeList(tenantId, moduleCode, type), moduleCode);
  // },
  ...
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getSVDocumentsCategory(tenantId, moduleCode), moduleCode);
  // },
  // getADSDocuments: (tenantId, moduleCode) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getADSDocumentsCategory(tenantId, moduleCode), moduleCode);
  // },
  // EWProductPrice: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getProductPriceList(tenantId, moduleCode, type), moduleCode);
  // },
  // EWVendor: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getVendorDetailsList(tenantId, moduleCode, type), moduleCode);
  // },
  // getChbSpecialCategory: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbSpecialCategoryList(tenantId, moduleCode, type), moduleCode);
  // },
  // getChbCommunityHalls: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbCommunityHallsList(tenantId, moduleCode, type), moduleCode);
  // },
  // getChbResidentType: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbResidentTypeList(tenantId, moduleCode, type), moduleCode);
  // },
  // getChbHallCode: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbHallCodeList(tenantId, moduleCode, type), moduleCode);
  // },

  // getChbPurpose: (tenantId, moduleCode, type) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbPurposeList(tenantId, moduleCode, type), moduleCode);
  // },

  // getChbDocuments: (tenantId, moduleCode) => {
  //   return MdmsServiceV2.getDataByCriteria(tenantId, getChbDocumentsCategory(tenantId, moduleCode), moduleCode);
  // },
