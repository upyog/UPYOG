...
export const SelectPaymentType = (props) => {
    ...
    const filterData = {
      Transaction: {
        ...
        callbackUrl: window.location.href.includes("mcollect")
          ? `${window.location.protocol}//${window.location.host}/upyog-ui/citizen/payment/success/${businessService}/${consumerCode}/${tenantId}?workflow=mcollect`
          : `${window.location.protocol}//${window.location.host}/upyog-ui/citizen/payment/success/${businessService}/${consumerCode}/${tenantId}`,
        additionalDetails: {
          isWhatsapp: false,
        },
      },
  ...
  if (authorization === "true" && !userInfo.access_token) {
    ...
    return <Redirect to={`/upyog-ui/citizen/login?from=${encodeURIComponent(pathname + search)}`} />;
  }
