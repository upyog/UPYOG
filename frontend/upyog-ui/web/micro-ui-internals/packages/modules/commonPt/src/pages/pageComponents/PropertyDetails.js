                ...
                <Link
                  to={
                    window.location.href.includes("/edit-application/") || window.location.href.includes("/renew-trade/")
                      ? `/upyog-ui/citizen/tl/tradelicence/edit-application/${formData?.applicationNumber}/${formData?.tenantId}/know-your-property`
                      : `/upyog-ui/citizen/tl/tradelicence/new-application/know-your-property`
                  }
                >
