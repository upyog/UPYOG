  ...
  return (
    <div style={{ marginTop: "16px", marginBottom: "16px" ,backgroundColor:"white"}}>
      ...
      <span className="link" style={{display:"flex", justifyContent:"center",paddingBottom:"16px"}}>
        <Link to={window.location.href.includes("/tl/tradelicence/") ? "/upyog-ui/citizen/tl/tradelicence/new-application/create-property" : "/upyog-ui/citizen/commonpt/property/new-application"}>{t("CPT_REG_NEW_PROPERTY")}</Link>
      </span>
      {showToast && (
        <Toast
          isDleteBtn={true}
