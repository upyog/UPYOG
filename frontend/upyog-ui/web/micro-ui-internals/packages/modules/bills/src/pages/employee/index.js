...
const BILLSBreadCrumbs = ({ location }) => {
  ...
  const crumbs = [
    ...
    {
      path: "/mycity-ui/employee/bills/cancel-bill",
      content: t("ABG_CANCEL_BILL"),
      show: location.pathname.includes("/cancel-bill") ? true : false,
    },
    {
      path: "/mycity-ui/employee/bills/bill-details",
