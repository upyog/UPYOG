import { CardHeader, CardLabel, CardLabelError, Dropdown, FormStep, LabelFieldPair, LinkButton, MobileNumber, CardSectionHeader, TextInput } from "@upyog/digit-ui-react-components";
...
const OwnerForm = _props => {
  ...
  const ownerTypesMenu = useMemo(() => mdmsData?.PropertyTax?.OwnerType?.map?.(e => ({
  ...
  const genderTypeMenu = useMemo(() => genderFilterTypeMenu?.map?.(e => ({
        ...
        background: "#FAFAFA"
            ...
            {typeOfOwner === "INSTITUTIONAL" && <React.Fragment>
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name="instituionName" defaultValue={owner?.instituionName} rules={{
                required: t("REQUIRED_FIELD"),
                validate: {
                  pattern: val => /^[a-zA-Z_@./()#&+-\s]*$/.test(val) ? true : t("TL_NAME_ERROR_MESSAGE")
                }
              }} render={props => <TextInput t={t} type={"text"} isMandatory={false} value={props.value} disable={isSameAsPropertyOwner} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "instituionName"} errorStyle={localFormState.touched.instituionName && errors?.instituionName?.message ? true : false} onChange={e => {
                if (e != owner?.instituionName && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"subOwnerShipCategory"} defaultValue={window.location.href.includes("tl/edit-application-details") || window.location.href.includes("tl/renew-application-details/") ? owner?.subOwnerShipCategory : ""} render={props => <Dropdown t={t} option={institutionOwnershipTypeOptions} errorStyle={localFormState.touched.subOwnerShipCategory && errors?.subOwnerShipCategory?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "subOwnerShipCategory"} selected={props.value} disable={isSameAsPropertyOwner} select={e => {
                if (e?.code != owner?.subOwnerShipCategory?.code && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
              ...
              }} onBlur={props.onBlur} optionKey="i18nKey" />}></Controller>
                  </div>
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} defaultValue={owner?.name} name={"name"} rules={{
                required: t("REQUIRED_FIELD"),
                validate: {
                  pattern: val => /^[a-zA-Z ]+$/.test(val) ? true : t("TL_NAME_ERROR_MESSAGE")
                }
              }} render={props => <TextInput t={t} type={"text"} isMandatory={false} name="name" value={props.value} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.name && errors?.name?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "name"} onChange={e => {
                if (e != owner?.name && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"designation"} defaultValue={owner?.designation} rules={{
                /* required: t("REQUIRED_FIELD"), */validate: {
                  pattern: val => /^[a-zA-Z ]*$/.test(val) ? true : t("TL_NAME_ERROR_MESSAGE")
                }
              }} render={props => <TextInput t={t} type={"text"} isMandatory={false} name="designation" value={props.value} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.designation && errors?.designation?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "designation"} onChange={e => {
                if (e != owner?.designation && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"mobileNumber"} defaultValue={owner?.mobileNumber} rules={{
                required: t("REQUIRED_FIELD"),
                validate: {
                  pattern: val => /^([6-9]{1}[0-9]{9})$/.test(val) ? true : t("CORE_COMMON_APPLICANT_MOBILE_NUMBER_INVALID")
                }
              }} render={props => <MobileNumber type={""} t={t} isMandatory={false} name="mobileNumber" value={props.value} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.mobileNumber && errors?.mobileNumber?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "mobileNumber"} onChange={e => {
                if (e != owner?.mobileNumber && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"altContactNumber"} defaultValue={owner?.altContactNumber}
              ...
              render={props => <MobileNumber type={"text"} t={t} isMandatory={false} maxLength={11} name="altContactNumber" value={owner.altContactNumber} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.altContactNumber && errors?.altContactNumber?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "altContactNumber"} onChange={e => {
                if (e != owner?.altContactNumber && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} defaultValue={owner?.emailId} name={"emailId"} rules={{
                /* required: t("REQUIRED_FIELD"),*/validate: {
                  pattern: val => /^$|^(?=^.{1,64}$)((([^<>()\[\]\\.,;:\s$*@'"]+(\.[^<>()\[\]\\.,;:\s@'"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,})))$/.test(val) ? true : t("TL_EMAIL_ERROR_MESSAGE")
                }
              }} render={props => <TextInput t={t} type={"text"} isMandatory={false} name={"emailId"} value={props.value} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.emailId && errors?.emailId?.message ? true : false} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "emailId"} onChange={e => {
                if (e != owner?.emailId && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e);
            ...
            {typeOfOwner !== "INSTITUTIONAL" && <React.Fragment>
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"name"} defaultValue={owner?.name} rules={{
                required: t("REQUIRED_FIELD"),
                validate: {
                  pattern: val => /^[A-Za-z]+( [A-Za-z]+)*$/.test(val) ? true : t("INVALID_NAME")
                }
              }} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "name"} errorStyle={localFormState.touched.name && errors?.name?.message ? true : false} onChange={e => {
                ...
                props.onBlur(e);
              }} disable={isSameAsPropertyOwner} style={isMulitpleOwners ? {
                background: "#FAFAFA"
              } : ""} />} />
                  </div>
                </LabelFieldPair>
              ...
              }} render={props => <MobileNumber value={props.value} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "mobileNumber"} onChange={e => {
                if (e != owner?.mobileNumber && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                ...
                borderRight: "none"
              }} onBlur={props.onBlur} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.mobileNumber && errors?.mobileNumber?.message ? true : false} style={isMulitpleOwners ? {
                background: "#FAFAFA"
              } : ""} />} />
                  </div>
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"fatherOrHusbandName"} defaultValue={owner?.fatherOrHusbandName} rules={{
                required: "NAME_REQUIRED",
                validate: {
                  pattern: val => /^[A-Za-z]+( [A-Za-z]+)*$/.test(val) ? true : t("INVALID_NAME")
                }
              }} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "fatherOrHusbandName"} errorStyle={localFormState.touched.fatherOrHusbandName && errors?.fatherOrHusbandName?.message ? true : false} onChange={e => {
              ...
              }} disable={isSameAsPropertyOwner} onBlur={props.onBlur} />} />
                  </div>
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <Controller control={control} name={"relationship"} defaultValue={owner?.relationship} rules={{
              required: "RelationShip Required"
            }} render={props => <Dropdown className="form-field" selected={props.value} errorStyle={localFormState.touched.relationship && errors?.relationship?.message ? true : false} select={e => {
              if (e?.code != owner?.relationship?.code && isRenewal) setPreviousLicenseDetails({
                ...previousLicenseDetails,
                checkForRenewal: true
              });
              props.onChange(e);
            }} onBlur={props.onBlur} disable={isSameAsPropertyOwner} option={[{
              ...
              code: "HUSBAND"
                ...
                <LabelFieldPair>
                  ...
                  <Controller control={control} name={"gender"} defaultValue={owner?.gender} rules={{
              required: t("REQUIRED_FIELD")
            }} render={props => <Dropdown className="form-field" selected={props.value} disable={isSameAsPropertyOwner} errorStyle={localFormState.touched.gender && errors?.gender?.message ? true : false} select={e => {
              if (e?.code != owner?.gender?.code && isRenewal) setPreviousLicenseDetails({
                ...previousLicenseDetails,
                checkForRenewal: true
              });
              props.onChange(e);
            }} onBlur={props.onBlur} option={genderTypeMenu} optionKey="i18nKey" t={t} />} />
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"emailId"} defaultValue={owner?.emailId} rules={{
                validate: e => {
                  if (!e) return true;
                  /^[a-zA-Z0-9._%+-]+@[a-z.-]+\.(com|org|in)$/.test(e) || t("CORE_INVALID_EMAIL_ID_PATTERN");
                }
              }} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "emailId"} errorStyle={localFormState.touched.emailId && errors?.emailId?.message ? true : false} onChange={e => {
                if (e.target.value != owner?.emailId && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                ...
                marginTop: "unset"
              }} onBlur={props.onBlur} disable={isSameAsPropertyOwner} style={isMulitpleOwners ? {
                background: "#FAFAFA"
              } : ""} />} />
                  </div>
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <Controller control={control} name={"ownerType"} defaultValue={owner?.ownerType}
            // rules={}
            render={props => <Dropdown className="form-field" selected={props.value} errorStyle={localFormState.touched.ownerType && errors?.ownerType?.message ? true : false} select={e => {
              if (e?.code != owner?.ownerType?.code && isRenewal) setPreviousLicenseDetails({
                ...previousLicenseDetails,
                checkForRenewal: true
              });
              props.onChange(e);
            }} onBlur={props.onBlur} disable={isSameAsPropertyOwner} option={ownerTypesMenu ? ownerTypesMenu.sort((a, b) => a.name.localeCompare(b.name)) : []} optionKey="i18nKey" t={t} />} />
                </LabelFieldPair>
                ...
                <LabelFieldPair>
                  ...
                  <div className="field">
                    <Controller control={control} name={"permanentAddress"} defaultValue={owner?.permanentAddress} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === owner?.key && focusIndex.type === "permanentAddress"} errorStyle={localFormState.touched.permanentAddress && errors?.permanentAddress?.message ? true : false} onChange={e => {
                if (e.target.value != owner?.permanentAddress && isRenewal) setPreviousLicenseDetails({
                  ...previousLicenseDetails,
                  checkForRenewal: true
                });
                props.onChange(e.target.value);
