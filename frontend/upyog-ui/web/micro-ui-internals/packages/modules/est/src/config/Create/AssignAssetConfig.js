...
export const Config = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        // NOTE: this "form" array is routing-metadata documentation only. ESTAssignAssets.js does
        // `{ ...config, ...estateAllotmentFormConfig }`, and estateAllotmentFormConfig.js also
        // defines "form" — its version wins at runtime. The real, maintained field definitions
        // live in estateAllotmentFormConfig.js, not here. Kept populated (rather than empty) so
        // this file stays genuinely equivalent to EST_ALLOTMENT_CONFIG_MDMS.js.
        form: [
          {
            order: 1,
          ...
          },
          {
            ...
            field: {
              ...
              name: "allotmentType",
              placeholder: "EST_SELECT_PROPERTY_TYPE",
              type: "dropdown",
          ...
          },
          {
            ...
            field: { code: "EST_ALLOTTEE_NAME", name: "alloteeName", placeholder: "EST_ENTER_ALLOTTEE_NAME", type: "text" },
            validation: {
              pattern: "^[a-zA-Z ]+$",
          ...
          },
          {
            ...
            field: { code: "EST_PHONE_NUMBER", name: "phoneNumber", placeholder: "EST_ENTER_PHONE_NUMBER", type: "text" },
            validation: {
              maxLength: 10,
              pattern: "^[0-9]{10}$",
          ...
          },
          {
            ...
            field: { code: "EST_ALTERNATE_PHONE_NUMBER", name: "altPhoneNumber", placeholder: "EST_ENTER_ALTERNATE_PHONE_NUMBER", type: "text" },
            validation: {
              maxLength: 10,
              pattern: "^[0-9]{10}$",
              regex: { pattern: "\\D", flags: "g" },
          ...
          },
          {
            order: 12,
            key: "EST_EMAIL_ID",
            field: { code: "EST_EMAIL_ID", name: "emailId", placeholder: "EST_ENTER_EMAIL_ID", type: "text" },
            validation: {
          ...
          },
          {
            ...
            field: { code: "EST_AGREEMENT_START_DATE", name: "agreementStartDate", type: "date", placeholder: "DD/MM/YY" },
            validation: { required: true, disabled: false },
          ...
          },
          {
            ...
            field: { code: "EST_AGREEMENT_END_DATE", name: "agreementEndDate", type: "date", placeholder: "DD/MM/YY" },
            validation: { required: true, disabled: false },
          ...
          },
          {
            ...
            field: {
              code: "EST_DURATION",
              name: "duration",
              placeholder: "EST_DURATION_AUTO_POPULATE",
              type: "text",
              unit: "In months",
          ...
          },
          {
            ...
            field: { code: "EST_RATE_PER_SQFT", name: "rentRate", placeholder: "EST_ENTER_RATE", type: "text", unit: "Per sq. ft." },
            validation: {
              maxLength: 12,
              pattern: "^[0-9]+(\\.[0-9]{1,2})?$",
          ...
          },
          {
            ...
            field: { code: "EST_MONTHLY_RENT_IN_INR", name: "monthlyRent", placeholder: "EST_ENTER_MONTHLY_RENT", type: "text", unit: "In INR" },
            validation: {
              maxLength: 12,
              pattern: "^[0-9]+(\\.[0-9]{1,2})?$",
              regex: { pattern: "[^0-9.]", flags: "g" },
          ...
          },
          {
            ...
            field: { code: "EST_ADVANCE_PAYMENT_IN_INR", name: "advancePayment", placeholder: "EST_ENTER_ADVANCE_PAYMENT", type: "text", unit: "In INR" },
            validation: {
              maxLength: 12,
              pattern: "^[0-9]+(\\.[0-9]{1,2})?$",
              regex: { pattern: "[^0-9.]", flags: "g" },
          ...
          },
          {
            ...
            field: { code: "EST_ADVANCE_PAYMENT_DATE", name: "advancePaymentDate", type: "date", placeholder: "DD/MM/YY" },
          ...
          },
          {
            ...
            field: { code: "FILE_REFERENCE_NUMBER", name: "eOfficeFileNo", placeholder: "EST_ENTER_FILE_NO", type: "text" },
            validation: {
              maxLength: 20,
              pattern: "^[0-9]+$",
              regex: { pattern: "\\D", flags: "g" },
          ...
          },
          {
            ...
            field: { code: "EST_CITIZEN_REQUEST_LETTER", name: "citizenLetter", type: "file", accept: ".png,.jpg,.jpeg,.pdf" },
            validation: { required: false, disabled: false },
          },
          {
            order: 25,
            key: "EST_ALLOTMENT_LETTER",
            field: { code: "EST_ALLOTMENT_LETTER", name: "allotmentLetter", type: "file", accept: ".png,.jpg,.jpeg,.pdf" },
            validation: { required: false, disabled: false },
          },
          {
            order: 26,
            key: "EST_SIGNED_DEED",
            field: { code: "EST_SIGNED_DEED", name: "signedDeed", type: "file", accept: ".png,.jpg,.jpeg,.pdf" },
            validation: { required: false, disabled: false },
          },
        ],
        actionButton: {
