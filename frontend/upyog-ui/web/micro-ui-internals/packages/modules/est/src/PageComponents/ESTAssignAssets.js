...
const ESTAssignAssets = ({ onSelect, onDraftSave, onDraftClear, config, formData, isEditMode, editData }) => {
  ...
  const dbBaselineData = useMemo(
    () =>
      mergeAllotmentPrefill(apiAllotment || {}, {}, {
        ...assetDisplay,
        ...(editData || {}),
      }),
    [apiAllotment, assetDisplay, editData]
  );
    ...
    <div className="employeeCard">
      ...
      {loadingAllotment ? (
        ...
        <DynamicForm
          ...
          resetBaseline={dbBaselineData}
          tenantId={tenantId}
          t={t}
          showCancel
          onCancel={handleCancel}
          showDraftButton={Boolean(onDraftSave)}
          draftLabel={routeConfig.draftButton?.label || "EST_ADD_AS_DRAFT"}
          draftSuccessLabel={routeConfig.draftButton?.successMessage || "EST_DRAFT_SAVED"}
          onSaveDraft={onDraftSave ? handlePersistDraft : undefined}
        />
