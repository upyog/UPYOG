...
// Estate number is EST-… (generated by estate-management). Never fall back to
// applicationNo / asset module refs (PG-… = refAssetNo).
const extractEstateNo = (response) => {
  ...
  try {
    ...
    return (asset0?.estateNo || response?.estateNo || "").trim();
  } catch {
    return "";
  }
};
