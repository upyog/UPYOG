  ...
  return <React.Fragment>
      ...
      padding: user?.type === "CITIZEN" ? "0 24px 0 24px" : ""
                  ...
                  <SearchField>
                      ...
                      <Controller control={control} name="status" render={props => <Dropdown selected={props.value} select={props.onChange} onBlur={props.onBlur} option={moduleCode === "TP" ? statusOptionForTreePruning : statusOptions} optionKey="i18nKey" t={t} disable={false} />} />
                  </SearchField>
                  <SearchField>
          ...
          })} type="number" componentInFront={<div className="employee-card-input employee-card-input--front">+91</div>} maxlength={10} />
            ...
            setShowToast(null);
            previousPage();
          }} className="wt-auto-7">{t(`ES_COMMON_CLEAR_ALL`)}</p>
                  </SearchField>
              </SearchForm>
