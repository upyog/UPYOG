# upyog-ui-module-engagement

This module handles citizen engagement features in the upyog-UI project — including surveys, events, notifications, and charts.
...
In your `frontend/upyog-ui/web/package.json`, add:
