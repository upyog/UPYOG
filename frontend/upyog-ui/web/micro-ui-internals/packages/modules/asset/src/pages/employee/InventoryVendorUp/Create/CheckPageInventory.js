        ...
        <div>
          ...
          <StatusTable>
            <Row
              ...
              actionButton={<ActionButton jumpTo={`/upyog-ui/employee/asset/assetservice-up/vendor/create`} />}
            />
            <Row
            ...
            <Row
              label={t("INV_GSTN")}
              text={`${t(checkForNA(inventoryVendor?.gstin))}`}
              actionButton={<ActionButton jumpTo={`/upyog-ui/employee/asset/assetservice-up/vendor/create`} />}
            />
            <Row
              label={t("INV_PAN")}
              text={`${t(checkForNA(inventoryVendor?.pan))}`}
              actionButton={<ActionButton jumpTo={`/upyog-ui/employee/asset/assetservice-up/vendor/create`} />}
            />

            <Row
              label={t("INV_OTHER_DETAILS")}
