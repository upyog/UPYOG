...
import { assetRegistryForUPConfig } from "../../../../config/Create/assetRegistryForUPConfig";

const AssetRegistryUp = ({ parentRoute }) => {
 ...
 let commonFields = assetRegistryForUPConfig;
  ...
  const CheckPageUP = Digit?.ComponentRegistryService?.getComponent("ASTCheckPageForUP");
  const NewResponse = Digit?.ComponentRegistryService?.getComponent("NewResponseForUP");
  ...
  return (
    <Switch>
      ...
      <Route path={`${match.path}/check`}>
        <CheckPageUP onSubmit={astcreate} value={params} />
      </Route>
...
export default AssetRegistryUp;