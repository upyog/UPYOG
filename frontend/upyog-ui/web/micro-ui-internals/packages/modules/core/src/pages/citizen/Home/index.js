...
console.log("citizenServicesObjcitizenServicesObj",citizenServicesObj)
  const allCitizenServicesProps = {
    ...
    sideOption: {
      ...
      onClick: () => history.push(citizenServicesObj?.sideOption?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
    },
    options: [
      {
        name: t(citizenServicesObj?.props?.[0]?.label),
        Icon: <ComplaintIcon />,
        onClick: () => history.push(citizenServicesObj?.props?.[0]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      {
        name: t(citizenServicesObj?.props?.[1]?.label),
        Icon: <PTIcon className="fill-path-primary-main" />,
        onClick: () => history.push(citizenServicesObj?.props?.[1]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      {
        name: t(citizenServicesObj?.props?.[2]?.label),
        Icon: <CaseIcon className="fill-path-primary-main" />,
        onClick: () => history.push(citizenServicesObj?.props?.[2]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      // {
      ...
      // },
      {
        ...
        Icon: <WSICon />,
        onClick: () => history.push(citizenServicesObj?.props?.[3]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
    ],
  ...
  const allInfoAndUpdatesProps = {
    ...
    sideOption: {
      ...
      onClick: () => history.push(infoAndUpdatesObj?.sideOption?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
    },
    options: [
      {
        name: t(infoAndUpdatesObj?.props?.[0]?.label),
        Icon: <HomeIcon />,
        onClick: () => history.push(infoAndUpdatesObj?.props?.[0]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      {
        name: t(infoAndUpdatesObj?.props?.[1]?.label),
        Icon: <Calender />,
        onClick: () => history.push(infoAndUpdatesObj?.props?.[1]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      {
        name: t(infoAndUpdatesObj?.props?.[2]?.label),
        Icon: <DocumentIcon />,
        onClick: () => history.push(infoAndUpdatesObj?.props?.[2]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      {
        name: t(infoAndUpdatesObj?.props?.[3]?.label),
        Icon: <DocumentIcon />,
        onClick: () => history.push(infoAndUpdatesObj?.props?.[3]?.navigationUrl.replace("/upyog-ui/","/upyog-ui/")),
      },
      // {
