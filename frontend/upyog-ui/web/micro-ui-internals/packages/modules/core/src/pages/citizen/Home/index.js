...
const Home = () => {
  ...
  const allCitizenServicesProps = {
    ...
    sideOption: {
      ...
      onClick: () => history.push("/upyog-ui/citizen/all-services"),
    },
    options: [
      {
        name: t("ES_PGR_HEADER_COMPLAINT"),
        Icon: <ComplaintIcon />,
        onClick: () => history.push("/upyog-ui/citizen/pgr-home"),
      },
      {
        name: t("MODULE_PT"),
        Icon: <PTIcon className="fill-path-primary-main" />,
        onClick: () => history.push("/upyog-ui/citizen/pt-home"),
      },
      {
        name: t("MODULE_TL"),
        Icon: <CaseIcon className="fill-path-primary-main" />,
        onClick: () => history.push("/upyog-ui/citizen/tl-home"),
      },
      // {
      ...
      // },
      {
        ...
        Icon: <OBPSIcon />,
        onClick: () => history.push("/upyog-ui/citizen/obps-home"),
      },
    ],
  ...
  const allInfoAndUpdatesProps = {
    ...
    options: [
      ...
      },
      {
        ...
        Icon: <Calender />,
        onClick: () => history.push("/upyog-ui/citizen/engagement/events"),
      },
      {
        name: t("CS_COMMON_DOCUMENTS"),
        Icon: <DocumentIcon />,
        onClick: () => history.push("/upyog-ui/citizen/engagement/docs"),
      },
      {
        name: t("CS_COMMON_SURVEYS"),
        Icon: <DocumentIcon />,
        onClick: () => history.push("/upyog-ui/citizen/engagement/surveys/list"),
      },
      // {
        ...
        EventsDataLoading ? (
          ...
          <div className="WhatsNewSection">
            <div className="headSection">
              ...
              <p onClick={() => history.push("/upyog-ui/citizen/engagement/whats-new")}>{t("DASHBOARD_VIEW_ALL_LABEL")}</p>
            </div>
