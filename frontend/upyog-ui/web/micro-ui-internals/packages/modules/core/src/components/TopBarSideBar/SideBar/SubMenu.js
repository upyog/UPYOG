          ...
          <div className="actions">
            ...
            {item.navigationURL?.indexOf("/digit-ui")||item.navigationURL?.indexOf("/upyog-ui") === -1? (
              <a
                ...
                href={getOrigin + window.location.href.includes("/upyog-ui") && (item.navigationURL.includes("digit-ui") || item.navigationURL.includes("/workbench-ui"))? item.navigationURL.replace("digit-ui","upyog-ui") : "/employee/"+item.navigationURL}
              >
              ...
              if (item.navigationURL.indexOf("/upyog-ui") || item.navigationURL.indexOf("/digit-ui")=== -1) {
                ...
                return (
                  <a
                    ...
                    href={getOrigin + window.location.href.includes("/upyog-ui") && item.navigationURL.includes("digit-ui") ? item.navigationURL.replace("digit-ui","upyog-ui") : "/employee/"+item.navigationURL}
                  >
