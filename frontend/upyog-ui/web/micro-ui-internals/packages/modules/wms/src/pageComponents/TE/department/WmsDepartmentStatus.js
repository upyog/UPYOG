...
const WmsDepartmentStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsDepartmentStatus);
...
export default WmsDepartmentStatus;
