...
const WmsTMAdditionalPerformanceSD = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  ...
  const inputs = [

    {
      ...
      label: "WMS_TE_COMMON_ADDITIONAL_PERFORMANCE_SD",

      type: "text",

      name: "additional-performance-sd",
...
export default WmsTMAdditionalPerformanceSD;
