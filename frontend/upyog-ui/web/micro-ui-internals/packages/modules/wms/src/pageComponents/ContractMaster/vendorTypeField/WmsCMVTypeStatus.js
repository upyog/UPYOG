...
const WmsCMVTypeStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsCMVTypeStatus);
...
export default WmsCMVTypeStatus;
