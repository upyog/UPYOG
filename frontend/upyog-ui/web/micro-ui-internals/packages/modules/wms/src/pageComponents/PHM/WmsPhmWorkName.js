...
const WmsPhmWorkName = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [fund, setfund] = useState(formData?.WmsPhmWorkName);
  function WmsPhmWorkName(value) {
    setfund(value);
  }
