...
const WmsTETecnicalBidOpenDate = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  
  const { pathname: url } = useLocation();
  const inputs = [
    {
      label: t("WMS_TE_COMMON_TECHNICAL_BID_OPEN_DATE"),
      type: "date",
      name: "technical_bid_open_date",
      validation: {
        isRequired: true,
...
export default WmsTETecnicalBidOpenDate;
