...
const DataLinks = ({ parentRoute, businessService, allLinks, headerText }) => {
...
export default DataLinks;import { Card, PersonIcon } from "@egovernments/digit-ui-react-components";
import React, { useEffect, useState } from "react";
import { useTranslation } from "react-i18next";
import { Link } from "react-router-dom";
...
const DataLinks = ({ parentRoute, businessService, allLinks, headerText }) => {
  ...
  console.log(allLinks,"this is links");
  return (
    <Card className="employeeCard filter inboxLinks">
      <div className="complaint-links-container">
        {GetLogo()}
