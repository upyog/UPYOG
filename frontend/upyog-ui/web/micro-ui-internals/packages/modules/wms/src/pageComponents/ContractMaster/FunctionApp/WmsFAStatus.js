...
const WmsFAStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsFAStatus);
