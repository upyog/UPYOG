...
useEffect(() => {
  ...
  function filterTableList(departmentName,prebidMeetingDate){
    ...
    if(prebidMeetingDate!=null && departmentName==null || prebidMeetingDate!="" && departmentName=="" || prebidMeetingDate!=undefined && departmentName==undefined){
     ...
     return formData;
  }else if(departmentName!=null && prebidMeetingDate==null || departmentName!="" && prebidMeetingDate=="" || departmentName!=undefined && prebidMeetingDate==undefined){
   formData = `?departmentName=${departmentName}`
   return formData;
  }else if(departmentName!="" && prebidMeetingDate!="" || departmentName!=null && prebidMeetingDate!=null || departmentName!=undefined && prebidMeetingDate!=undefined){
  ...
  return (
    <div>
      <Header>
        {t("WMS_CA_ADD_CONTRACT_AGREEMENT_LIST")}
      </Header>
      <Link
                  to={`add`}
                >
