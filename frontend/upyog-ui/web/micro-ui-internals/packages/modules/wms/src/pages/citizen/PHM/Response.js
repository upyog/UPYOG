...
const WmsPhmResponse = (props) => {
  ...
  const mutation = state.key === "UPDATE" ? Digit.Hooks.wms.phm.useWmsPhmUpdate(tenantId) : Digit.Hooks.wms.phm.useWmsPhmCreate(tenantId);
