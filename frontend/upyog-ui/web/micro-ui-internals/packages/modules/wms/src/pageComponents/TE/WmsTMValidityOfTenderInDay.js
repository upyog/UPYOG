...
const WmsTMValidityOfTenderInDay = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  ...
  const inputs = [

    {
      ...
      label: "WMS_TE_COMMON_VALIDITY_OF_TENDER_IN_DAYS",

      type: "text",

      name: "validity-of-tender-in-days",
...
export default WmsTMValidityOfTenderInDay;
