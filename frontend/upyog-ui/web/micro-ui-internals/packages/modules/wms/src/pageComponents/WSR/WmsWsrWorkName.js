...
const WmsWsrWorkName = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [fund, setfund] = useState(formData?.WmsWsrWorkName);
  function WmsWsrWorkName(value) {
    setfund(value);
  }
