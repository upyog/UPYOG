...
const WmsAHLocation = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  ...
  const inputs = [
    ...
    {
      label: "Account Head Location",
      type: "text",
      name: "primary_accounthead_location",
      validation: {
        isRequired: true,
