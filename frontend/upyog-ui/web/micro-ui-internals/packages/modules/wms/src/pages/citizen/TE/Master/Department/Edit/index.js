...
const AccountHeadEdit =()=>{
    ...
    const { isLoading, isError, error, data, ...rest } = Digit?.Hooks?.wms?.te?.useWMSTEMaster(id,"WMS_DEPARTMENT_SINGLE_RECORD");
...
// ]
  ...
  return <EditForm data={data?.WMSDepartmentApplications[0]} tenantId={tenantId} />;
