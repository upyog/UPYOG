...
const WmsPrTypeOfWork = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [fund, setfund] = useState(formData?.WmsPrTypeOfWork);
  function WmsPrTypeOfWork(value) {
    setfund(value);
  }
...
export default WmsPrTypeOfWork;
