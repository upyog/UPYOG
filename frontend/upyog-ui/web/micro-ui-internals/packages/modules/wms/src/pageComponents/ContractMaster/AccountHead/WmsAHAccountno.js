...
const WmsAHAccountno = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  ...
  const inputs = [
    ...
    {
      label: "Account Head Number",
      type: "number",
      name: "primary_accounthead_accountno",
      validation: {
        isRequired: true,
