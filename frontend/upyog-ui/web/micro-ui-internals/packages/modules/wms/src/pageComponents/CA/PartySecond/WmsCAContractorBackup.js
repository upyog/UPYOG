...
// import {StepContext}
const WmsCAContractor = ({ t, config, onSelect, formData = {}, userType, /*setError,*/ clearErrors, onBlur, onSubmit, onNext, draftData }) => {
  // const {formData}=useContext(StepContext)

  console.log("onSelect Contractor TLInfo ", {draftData,"draftData?.length":draftData?.length, config, formData, userType /*,setError*/, clearErrors, onBlur, onSelect });
  ...
  // },
    ...
    {defaultValues:{
      // party2:{
        contractors: (draftData[0]?.contractors?.length>0) ? [...draftData[0]?.contractors] : [{ vendor_type: "", vendor_name: "", primary_party: "", represented_by: ""/*, upload_doc: ""*/ }],
        ...
        party2_witness: (draftData[0]?.party2_witness?.length>0) ? [...draftData[0]?.party2_witness] : [{ witness_name: "", address: "", aadhaarNo: ""/*, upload_thumb: "" */}]
      // }
    },}
  );
...
//   }
  ...
  return (
    <>
    <div style={{backgroundColor: "rgb(238 238 238)",marginBottom:"5px",lineHeight: "30px",color: "#000",fontSize: "12px",fontWeight: "600"}}><strong style={{backgroundColor: "#ad2f33",display: "inline-block",color: "#fff",width: "30px",textAlign:"center",fontSize: "20px",lineHeight: "30px",float: "left", marginRight: "5px"}}> - </strong> Party II {'(Contractor)'}</div>
      <table style={{marginBottom:"15px"}}>
        <thead style={{backgroundColor:"#eee",lineHeight:"40px",textAlign:"center",fontSize:"12px"}} >
          ...
          <th style={{border:  "1px solid #b3b3b3", padding:"4px"}} width="20%">Represented By </th>
        ...
        <tbody>
          ...
          {party2fields?.map((item, index) => (
            ...
            /> */}
              ...
              <td style={{border:  "1px solid #b3b3b3", padding:"4px"}}  textAlign="center">
                <Controller
                  ...
                  render={({ field, fieldState }) => (<>
                    ...
                    />
                    {fieldState?.error && (
                  <p style={{ color: 'red' }}>{"fieldState.error.message mandatory"}</p>
                )}
                    {/* <p>{errors?.(`primary_party`) && errors?.(`primary_party`).message}</p> */}
              ...
              <td style={{border:  "1px solid #b3b3b3", padding:"4px",textAlign:"center"}}>
                <button type="button" style={{backgroundColor:"#b2383c",color:"#fff",borderRadius:"4px",padding:"5px 10px"}} onClick={() => party2remove(index)}>
                  Delete
                </button>
              </td>
            </tr>
      ...
      <table style={{marginBottom:"15px"}}>
        <thead style={{backgroundColor:"#eee",lineHeight:"40px",textAlign:"center",fontSize:"12px"}} >
          ...
          <th style={{border:  "1px solid #b3b3b3", padding:"4px"}} width="20%">Aadhaar No</th>
        ...
        <tbody>
          ...
          {party2_witness_fields?.map((item, index) => (
            <tr key={item.id}>
              ...
              <td style={{border:  "1px solid #b3b3b3", padding:"4px",textAlign:"center"}}>
                <button type="button" style={{backgroundColor:"#b2383c",color:"#fff",borderRadius:"4px",padding:"5px 10px"}} onClick={() => party2_witness_remove(index)}>
                  Delete
                </button>
              </td>
            </tr>
