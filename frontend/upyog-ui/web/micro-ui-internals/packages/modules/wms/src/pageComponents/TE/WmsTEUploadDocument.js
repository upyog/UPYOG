...
const WmsTEUploadDocument = ({ t, config, onSelect, userType, formData, setError: setFormError, clearErrors: clearFormErrors, formState }) => {
...
export default WmsTEUploadDocument;
