...
const WmsTenderCategoryName = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  ...
  const inputs = [
    ...
    {
      label: "Tender Category Name",
      type: "text",
      name: "tender_category_name",
      validation: {
        isRequired: true,
...
export default WmsTenderCategoryName;
