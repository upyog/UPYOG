...
const WmsCMVendorStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [ venderStatusTypes,setEmployeeTypes ] = useState(vendorStatus)
  const [ isLoading,setisLoading ] = useState(false)
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsCMVendorStatus);
...
export default WmsCMVendorStatus;
