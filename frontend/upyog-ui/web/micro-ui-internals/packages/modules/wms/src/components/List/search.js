...
const SearchData = ({ onSearch, type, onClose, searchFields, searchParams, isInboxPage, defaultSearchParams }) => {
      ...
      <React.Fragment>
        ...
        {(type === "mobile" || mobileView) && (
          <ActionBar className="clear-search-container">
            ...
            <SubmitBar label={t("WMS_COMMON_SEARCH")} style={{ flex: 1 }} submit={true} />
          </ActionBar>
        )}
      </React.Fragment>
    </form>
