...
const getAction = (flow) => {
  switch (flow) {
    case "STAKEHOLDER": actions = []
      break;
    default: actions = [
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_PROJECT_INFORMATION',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_PREVIOUS_RUNNING_BILL_INFORMATION',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_MB_NOT_PAID',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_TENDER_WORK_DETAILS',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_WITHHELD_DEDUCTIONS_DETAILS',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_RA_BILL_TAX_DETAILS',
      'WMS_RUNNING_ACCOUNT_FINAL_BILL_SUMMARY',
    ]
  }
}
