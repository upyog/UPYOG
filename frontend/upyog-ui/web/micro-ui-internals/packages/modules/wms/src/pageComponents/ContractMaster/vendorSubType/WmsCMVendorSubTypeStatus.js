...
const WmsCMVendorSubTypeStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsCMVendorSubTypeStatus);
...
export default WmsCMVendorSubTypeStatus;
