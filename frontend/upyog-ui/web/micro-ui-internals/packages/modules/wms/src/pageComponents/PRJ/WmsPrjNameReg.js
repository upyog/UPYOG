...
const WmsPrjNameReg = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  const { pathname: url } = useLocation();
  const inputs = [
    {
      label: "WMS_PRJ_PROJECT_NAME_REG_LABEL",
      type: "text",
      name: "project_name_reg",
      validation: {
        isRequired: true,
