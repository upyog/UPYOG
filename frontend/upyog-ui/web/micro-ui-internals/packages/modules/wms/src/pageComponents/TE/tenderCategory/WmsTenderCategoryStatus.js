...
const WmsTenderCategoryStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsTenderCategoryStatus);
...
export default WmsTenderCategoryStatus;
