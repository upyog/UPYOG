...
const WmsTEIssueFromDate = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  
  const { pathname: url } = useLocation();
  const inputs = [
    {
      label: t("WMS_TE_COMMON_ISSUE_FROM_DATE"),
      type: "date",
      name: "issue-from-date",
      validation: {
        isRequired: true,
...
export default WmsTEIssueFromDate;
