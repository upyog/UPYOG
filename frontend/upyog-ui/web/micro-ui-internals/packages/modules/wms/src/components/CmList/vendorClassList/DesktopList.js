...
// console.log("data ",data)
  ...
  const columns = React.useMemo(() => {
    return [
      ...
      // },
      {
        Header: "Vendor Class Type",
        disableSortBy: true,
        Cell: ({ row }) => {
          return GetCell(`${row.original?.vendor_class_name}`);
        },
      },
      {
        Header: "Status",
        ...
        Cell: ({ row }) => {
          ...
          return GetSlaCell(`${row?.original?.vendor_class_status==="Active" ? row?.original?.vendor_class_status?.toUpperCase() : row?.original?.vendor_class_status?.toUpperCase()}`);
        },
      },
      {
        Header: "Action",
