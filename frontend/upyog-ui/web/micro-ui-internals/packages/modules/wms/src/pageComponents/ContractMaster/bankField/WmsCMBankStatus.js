...
const WmsCMBankStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsCMBankStatus);
...
export default WmsCMBankStatus;
