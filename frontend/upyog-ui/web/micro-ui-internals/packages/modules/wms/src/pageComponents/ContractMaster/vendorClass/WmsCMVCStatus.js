...
const WmsCMVCStatus = ({ t, config, onSelect, formData = {}, userType }) => {
  ...
  const [venderStatusType, setvenderStatusType] = useState(formData?.WmsCMVCStatus);
