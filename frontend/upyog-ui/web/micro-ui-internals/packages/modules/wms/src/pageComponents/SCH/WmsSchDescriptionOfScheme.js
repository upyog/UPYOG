...
const WmsSchDescriptionOfScheme = ({ t, config, onSelect, formData = {}, userType, register, errors }) => {
  const { pathname: url } = useLocation();
  const inputs = [
    {
      label: "WMS_SCH_DESC_OF_SCHEME_LABEL",
      type: "text",
      name: "description_of_the_scheme",
      validation: {
        isRequired: true,
...
export default WmsSchDescriptionOfScheme;
