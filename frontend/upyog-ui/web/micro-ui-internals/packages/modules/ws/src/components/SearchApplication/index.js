          ...
          return (
            <div>
              {row.original["connectionNo"] ? (
                <span className={"link"}>
                  <Link
                    to={`/mycity-ui/employee/ws/connection-details?applicationNumber=${
                      row.original["connectionNo"]
          ...
          if (row.original["applicationType"] === "MODIFY_SEWERAGE_CONNECTION" || row.original["applicationType"] === "MODIFY_WATER_CONNECTION") {
            ...
            return (
              <div>
                <span className="link">
                  <Link
                    to={`/mycity-ui/employee/ws/${application}-details?applicationNumber=${
            ...
            return (
              <div>
                <span className="link">
                  <Link
                    to={`/mycity-ui/employee/ws/${application}-details?applicationNumber=${row.original["applicationNo"]}&tenantId=${tenantId}&service=${service}&from=WS_SEWERAGE_APPLICATION_SEARCH`}
                  >
                    {row.original["applicationNo"]}
                  </Link>
                </span>
