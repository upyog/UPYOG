...
const SearchApplication = ({
  ...
  const columns = useMemo(() => [{
    ...
    Cell: ({
      ...
      let service = "WATER";
      if (row?.original?.["applicationType"] == "NEW_WATER_CONNECTION" || row?.original?.["applicationType"] == "MODIFY_WATER_CONNECTION" || row?.original?.["applicationType"] == "DISCONNECT_WATER_CONNECTION" || row?.original?.["applicationType"] == "WATER_RECONNECTION") {
        service = "WATER";
      } else if (row?.original?.["applicationType"] == "NEW_SEWERAGE_CONNECTION" || row?.original?.["applicationType"] == "MODIFY_SEWERAGE_CONNECTION" || row?.original?.["applicationType"] == "DISCONNECT_SEWERAGE_CONNECTION" || row?.original?.["applicationType"] == "SEWERAGE_RECONNECTION") {
        service = "SEWERAGE";
      }
      return <div>
