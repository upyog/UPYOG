...
const WSActivationConnectionDetails = ({
  config,
  onSelect,
  userType,
  formData,
  ...
  const [connectionDetails, setConnectionDetails] = window.location.href.includes("modify") ? useState(formData?.connectionDetails ? [formData?.connectionDetails?.[0]] : [createConnectionDetails(filters?.service?.toUpperCase())]) : useState(formData?.connectionDetails || [createConnectionDetails(filters?.service?.toUpperCase())]);
  ...
  return <React.Fragment>
            {connectionDetails.map((connectionDetail, index) => <ConnectionDetails key={connectionDetail.key} index={index} connectionDetail={connectionDetail} {...commonProps} />)}
        </React.Fragment>;
};
const ConnectionDetails = _props => {
  ...
  return <div>
            ...
            fontWeight: "700"
              ...
              marginTop: "-5px",
              fontWeight: "700"
            }} className="card-label-smaller">{`${t("WS_SERV_DETAIL_CONN_TYPE")}`}<span className="check-page-link-button"> *</span></CardLabel>
                            <Controller control={control} name={"connectionType"} defaultValue={connectionDetail?.connectionType} rules={{
              required: t("REQUIRED_FIELD")
            }} isMandatory={true} render={props => <Dropdown className="form-field" selected={getValues("connectionType")} disable={false} option={connectionTypeList} errorStyle={localFormState.touched.connectionType && errors?.connectionType?.message ? true : false} select={e => {
              props.onChange(e);
              ...
              marginTop: "-5px",
              fontWeight: "700"
            }} className="card-label-smaller">{`${t("WS_SERV_DETAIL_WATER_SOURCE")}`}<span className="check-page-link-button"> *</span></CardLabel>
                            <Controller control={control} name={"waterSource"} defaultValue={connectionDetail?.waterSource} rules={{
              required: t("REQUIRED_FIELD")
            }} isMandatory={true} render={props => <Dropdown className="form-field" selected={getValues("waterSource")} disable={false} option={waterSourceList} errorStyle={localFormState.touched.waterSource && errors?.waterSource?.message ? true : false} select={e => {
              let obj = {
                ...connectionDetails?.[0],
                waterSource: e?.code,
                waterSubSource: ""
              ...
              marginTop: "-5px",
              fontWeight: "700"
            }} className="card-label-smaller">{`${t("WS_SERV_DETAIL_WATER_SUB_SOURCE")}`}<span className="check-page-link-button"> *</span></CardLabel>
                            <Controller control={control} name={"sourceSubData"} defaultValue={connectionDetail?.sourceSubData} rules={{
              required: t("REQUIRED_FIELD")
            }} isMandatory={true} render={props => <Dropdown className="form-field" selected={getValues("sourceSubData")} disable={false} option={waterSubSourceList} errorStyle={localFormState.touched.sourceSubData && errors?.sourceSubData?.message ? true : false} select={e => {
              props.onChange(e);
            }} optionKey="i18nKey" onBlur={props.onBlur} t={t} />} />
                        </LabelFieldPair>
              ...
              marginTop: "-5px",
              fontWeight: "700"
            }} className="card-label-smaller">{`${t("WS_PIPE_SIZE_IN_INCHES_LABEL")}`}<span className="check-page-link-button"> *</span></CardLabel>
                            <Controller control={control} name={"pipeSize"} defaultValue={connectionDetail?.pipeSize} rules={{
              required: t("REQUIRED_FIELD")
            }} isMandatory={true} render={props => <Dropdown className="form-field" selected={getValues("pipeSize")} disable={false} option={pipeSizeList} errorStyle={localFormState.touched.pipeSize && errors?.pipeSize?.message ? true : false} select={e => {
              props.onChange(e);
            }} optionKey="i18nKey" onBlur={props.onBlur} t={t} />} />
                        </LabelFieldPair>
              ...
              fontWeight: "700"
                            ...
                            <div className="field">
                                <Controller control={control} name="noOfTaps" defaultValue={connectionDetail?.noOfTaps} rules={{
                validate: e => e && getPattern("WSOnlyNumbers").test(e) || !e ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"),
                required: t("REQUIRED_FIELD")
              }} type="number" isMandatory={true} render={props => <TextInput type="number" value={props.value} autoFocus={focusIndex.index === connectionDetail?.key && focusIndex.type === "noOfTaps"} errorStyle={localFormState.touched.noOfTaps && errors?.noOfTaps?.message ? true : false} onChange={e => {
              ...
              fontWeight: "700"
                                ...
                                <div className="field">
                                    <Controller control={control} name="noOfWaterClosets" defaultValue={connectionDetail?.noOfWaterClosets} rules={{
                validate: e => e && getPattern("WSOnlyNumbers").test(e) || !e ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"),
                required: t("REQUIRED_FIELD")
              }} type="number" isMandatory={true} render={props => <TextInput value={props.value} type="number" autoFocus={focusIndex.index === connectionDetail?.key && focusIndex.type === "noOfWaterClosets"} errorStyle={localFormState.touched.noOfWaterClosets && errors?.noOfWaterClosets?.message ? true : false} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: connectionDetail?.key,
              ...
              fontWeight: "700"
                                ...
                                <div className="field">
                                    <Controller control={control} name="noOfToilets" defaultValue={connectionDetail?.noOfToilets} rules={{
                validate: e => e && getPattern("WSOnlyNumbers").test(e) || !e ? true : t("ERR_DEFAULT_INPUT_FIELD_MSG"),
                required: t("REQUIRED_FIELD")
              }} type="number" isMandatory={true} render={props => <TextInput value={props.value} type="number" autoFocus={focusIndex.index === connectionDetail?.key && focusIndex.type === "noOfToilets"} errorStyle={localFormState.touched.noOfToilets && errors?.noOfToilets?.message ? true : false} onChange={e => {
                props.onChange(e.target.value);
                setFocusIndex({
                  index: connectionDetail?.key,
                  type: "noOfToilets"
