...
const ConnectionDetails = _props => {
  ...
  return <div>{window.location.href.includes("modify-application") ? <div>
          ...
          fontWeight: "700"
                    ...
                    <div className="field">
                        <Controller control={control} name="applicationNo" defaultValue={connectionDetail?.applicationNo} isMandatory={true} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === connectionDetail?.key && focusIndex.type === "applicationNo"} errorStyle={localFormState.touched.applicationNo && errors?.applicationNo?.message ? true : false} onChange={e => {
            ...
            marginTop: "unset"
          }} onBlur={props.onBlur} disabled={true} disable={true} />} />
                    </div>
                </LabelFieldPair>
                <LabelFieldPair>
                    <CardLabel style={isMobile && isEmployee ? {
          ...
          fontWeight: "700"
                    ...
                    <div className="field">
                        <Controller control={control} name="serviceName" defaultValue={connectionDetail?.serviceName} isMandatory={true} render={props => <TextInput value={props.value} autoFocus={focusIndex.index === connectionDetail?.key && focusIndex.type === "serviceName"} errorStyle={localFormState.touched.serviceName && errors?.serviceName?.message ? true : false} onChange={e => {
            props.onChange(e.target.value);
            setFocusIndex({
              index: connectionDetail?.key,
              type: "serviceName"
