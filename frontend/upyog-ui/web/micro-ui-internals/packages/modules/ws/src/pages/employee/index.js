...
const BILLSBreadCrumbs = ({ location }) => {
  ...
  let crumbs = [
    ...
    {
      path: "/mycity-ui/employee/ws/water/search-application",
    ...
    {
      path: "/mycity-ui/employee/ws/water/search-connection",
    ...
    {
      path: "/mycity-ui/employee/ws/water/wns-search",
    ...
    {
      path: "/mycity-ui/employee/ws/consumption-details",
    ...
    // {
    //   path: sessionStorage.getItem("redirectedfromEDIT") === "true"? (applicationNumbercheck?.includes("SW_AP")?  "/mycity-ui/employee/ws/sewerage/search-application" : "/mycity-ui/employee/ws/water/search-application") : "/mycity-ui/employee/ws/application-details",
    ...
    {
      path: sessionStorage.getItem("redirectedfromEDIT") === "true"? (applicationNumbercheck?.includes("SW_AP")?  "/mycity-ui/employee/ws/sewerage/search-application" : "/mycity-ui/employee/ws/water/search-application") : "/mycity-ui/employee/ws/modify-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/modify-details") ? true : false,
      isBack: sessionStorage.getItem("redirectedfromEDIT") !== "true" && fromScreen && true,
    },
    {
      path: "/mycity-ui/employee/ws/disconnection-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/disconnection-details") ? true : false,
      isBack: fromScreen && true,
    },
    {
      path: "/mycity-ui/employee/ws/connection-details",
    ...
    {
      path: "/mycity-ui/employee/ws/edit-application",
    ...
    {
      path: `/mycity-ui/employee/ws/new-disconnection/docsrequired`,
      content: t("WS_NEW_DISCONNECTION_DOCS_REQUIRED"),
      show: location.pathname.includes("/new-disconnection/docsrequired") ? true : false,
    },
    {
      path: `/mycity-ui/employee/ws/new-disconnection/application-form`,
    ...
    // {
    //   path: "/mycity-ui/employee/sewerage/bill-amendment/inbox",
    //   content: t("ES_COMMON_BILLS_SEWERAGE_INBOX_LABEL"),
    //   show: location.pathname.includes("/sewerage/bill-amendment/inbox") ? true : false,
    // },
    {
