            ...
            onSuccess: async (waterData, variables) => {
              ...
              waterUpdateMutation(waterConnectionUpdate, {
                ...
                onSuccess: async (waterUpdateData, variables) => {
                  setAppDetails({
                    ...appDetails,
                    waterConnection: waterUpdateData?.WaterConnection?.[0]
                  });
                    ...
                    onSuccess: async (sewerageData, variables) => {
                      ...
                      await sewerageUpdateMutation(sewerageConnectionUpdate, {
                        ...
                        onSuccess: async (sewerageUpdateData, variables) => {
                          setAppDetails({
                            ...appDetails,
                            sewerageConnection: sewerageUpdateData?.SewerageConnections?.[0]
                          });
            ...
            onSuccess: async (data, variables) => {
              ...
              waterUpdateMutation(waterConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  setAppDetails({
                    ...appDetails,
                    waterConnection: data?.WaterConnection?.[0]
                  });
                  clearSessionFormData();
            ...
            onSuccess: async (data, variables) => {
              ...
              await sewerageUpdateMutation(sewerageConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  setAppDetails({
                    ...appDetails,
                    sewerageConnection: data?.SewerageConnections?.[0]
                  });
                  clearSessionFormData();
