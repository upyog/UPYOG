...
import { SubmitBar, CheckBox } from "@nudmcdgnpm/digit-ui-react-components";
      ...
      <div className="ndc-summary-card">
        ...
        <div className="ndc-summary-section">
          ...
          {docs?.length > 0 ? (
            ...
            <div className="ndc-summary-document-label">{t("TL_NO_DOCUMENTS_MSG")}</div>
          )}
        </div>
        ...
        <CheckBox label={t("NDC_FINAL_DECLARATION_MESSAGE")} styles={{ height: "auto" }} />
