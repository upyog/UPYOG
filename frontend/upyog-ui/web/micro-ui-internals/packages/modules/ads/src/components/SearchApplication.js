...
const ADSSearchApplication = ({
  ...
  return <React.Fragment>
                ...
                <SearchField>
                    ...
                    <Controller control={control} name="faceArea" render={props => <Dropdown selected={props.value} select={props.onChange} onBlur={props.onBlur} option={face} optionKey="i18nKey" t={t} disable={false} />} />
                </SearchField>
                <SearchField>
                    <label>{t("PT_COMMON_TABLE_COL_STATUS_LABEL")}</label>
                    <Controller control={control} name="status" render={props => <Dropdown selected={props.value} select={props.onChange} onBlur={props.onBlur} option={statusOptions} optionKey="i18nKey" t={t} disable={false} />} />
                </SearchField>
                <SearchField>
          ...
          />
                ...
                <SearchField>
                    ...
                    <Controller render={props => <DatePicker date={props.value} disabled={false} onChange={props.onChange} max={new Date().toISOString().split('T')[0]} />} name="fromDate" control={control} />
                </SearchField>
                <SearchField>
