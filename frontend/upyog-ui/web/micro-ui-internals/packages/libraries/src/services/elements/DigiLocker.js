...
export const DigiLockerService = {
  ...
  pdfUrl: (data) =>
    Request({
      ...
      auth: true,
      userService: true,
      data: { pdfUrl: data?.TokenReq?.pdfUrl, redirectUrl: data?.TokenReq?.redirectUrl, fileStoreId: data?.TokenReq?.fileStoreId, module: data?.TokenReq?.module, tenantId: data?.TokenReq?.tenantId, consumerCode: data?.TokenReq?.consumerCode }
    }),
