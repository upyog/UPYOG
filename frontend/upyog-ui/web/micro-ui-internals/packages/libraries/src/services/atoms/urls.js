const Urls = {
  ...
  ws: {
   ...
   asset: {
    ...
    inventoryVendor:"/asset-services/v1/vendor/_create",
    createProcurement:"/asset-services/v1/assets/procurement/_create",
    inventoryCreation:"/asset-services/v1/assets/inventory/_create",
    assetRegistry: "/asset-services/v1/assets/_search",
    assetVendorList:"/asset-services/v1/vendor/_search",
    updateAssetVendor:"/asset-services/v1/vendor/_update",
    procurementList:"/asset-services/v1/assets/procurement/_search",
    updateProcurement:"/asset-services/v1/assets/procurement/_update",
  },
  ew: {
