const Urls = {
  ...
  ws: {
   ...
   asset: {
    create: "http://localhost:8098/asset-services/v1/assets/_create",
    search: "http://localhost:8098/asset-services/v1/assets/_search",
    update: "http://localhost:8098/asset-services/v1/assets/_update",
    assign: "http://localhost:8098/asset-services/v1/assets/assignment/_create",
    depriciationProcess:"http://localhost:8098/asset-services/v1/assets/depreciation/_process",  
    maintenance:"http://localhost:8098/asset-services/maintenance/v1/_create",  
    edit_maintenance:"http://localhost:8098/asset-services/maintenance/v1/_update", 
    assets_Reciept_Search: "http://localhost:8098/asset-services/v1/assets/_search",    
    assetDisposedCreate: "http://localhost:8098/asset-services/v1/disposal/_create",
    depriciationList:"http://localhost:8098/asset-services/v1/assets/depreciation/list",   
    maintenanceList:"http://localhost:8098/asset-services/maintenance/v1/_search", 
    return_asset: "http://localhost:8098/asset-services/v1/assets/assignment/_update",  
    disposalList:"http://localhost:8098/asset-services/v1/disposal/_search",
    assetAssignable:"http://localhost:8098/asset-services/v1/assets/assignment/_search",  
    inventoryVendor:"http://localhost:8098/asset-services/v1/vendor/_create",
    createProcurement:"http://localhost:8098/asset-services/v1/assets/procurement/_create",
    inventoryCreation:"http://localhost:8098/asset-services/v1/assets/inventory/_create",
    assetRegistry: "http://localhost:8098/asset-services/v1/assets/_search",
    assetVendorList:"http://localhost:8098/asset-services/v1/vendor/_search",
    updateAssetVendor:"http://localhost:8098/asset-services/v1/vendor/_update",
    procurementList:"http://localhost:8098/asset-services/v1/assets/procurement/_search",
    updateProcurement:"http://localhost:8098/asset-services/v1/assets/procurement/_update",
  },
  ew: {
