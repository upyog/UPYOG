...
function Jurisdiction({ t, data, jurisdiction, jurisdictions, setjurisdictions, gethierarchylistdata, handleRemoveUnit, hierarchylist, getroledata, roleoption, index }) {
  ...
  return (
    <div key={jurisdiction?.keys} style={{ marginBottom: "16px" }}>
      <div style={{ border: "1px solid #E3E3E3", padding: "16px", marginTop: "8px" }}>
        ...
        <LabelFieldPair>
          <CardLabel isMandatory={true} className="card-label-smaller">{`${t("Functional role")} * `}</CardLabel>
          <Dropdown
        ...
        <LabelFieldPair>
          ...
          <div className="field" style={{ display: "flex" }}>
            <TextInput className="" textInputStyle={{ width: "50%" }} value={""} onChange={() => {}} disable={true} />
        ...
        <LabelFieldPair>
          <CardLabel className="card-label-smaller">sdjsdklj</CardLabel>
          <div className="field">
            <RadioButtons
              selectedOption={""}
              onSelect={() => {}}
        ...
        <LabelFieldPair>
          <CardLabel className="card-label-smaller">sdjhskjjkjks</CardLabel>
          <div className="field">
            <RadioButtons
              selectedOption={""}
              onSelect={() => {}}
