        ...
        {currentlyActiveMobileModal ? (
          <PopUp>
            <CurrentMobileModalComponent
              {...propsForCurrentMobileModalComponent}
            />
          </PopUp>
        ) : null}
          ...
          <div>
            {propsForInboxMobileCards?.data?.length < 1 ? (
              <Card className='margin-unset text-align-center'>
                {propsForInboxTable?.noResultsMessage
                  ? t(propsForInboxTable?.noResultsMessage)
  ...
  if (isEnabledCommonModules) {
    return (
      <div className='inbox-container'>
        ...
        <div
          style={
            propsForInboxTable?.tableStyle
              ? { flex: 1, ...propsForInboxTable?.tableStyle }
              : { flex: 1 }
          }
        >
          <SearchForm
          ...
          >
            <SearchFormFields
              ...
              searchFieldComponents={
                <div
                  style={
                    window.location.href.includes('/citizen/obps')
                      ? { display: 'flex' }
                      : {}
                  }
                >
                  ...
                  <p
                    ...
                    style={{ paddingTop: '9px', color: ' #f47738' }}
                  >
