...
```bash
npm install --save @upyog/workbench-ui-react-components
```
...
```json
"@upyog/workbench-ui-react-components":"1.5.24",
```
...
import MyComponent from "@upyog/workbench-ui-react-components";
...
```jsx
    import { InboxSearchComposer } from "@upyog/workbench-ui-react-components";
...
```jsx
    import { FormComposerV2 as FormComposer } from "@upyog/workbench-ui-react-components";
