...
module.exports = {
  ...
  host: {
    ...
    mcollectBilling: process.env.EGOV_BILLING_HOST || 'http://localhost:8082/',
    wns: process.env.EGOV_WNS_HOST || 'http://localhost:8081',
    sw: process.env.EGOV_WNS_HOST || 'http://localhost:8083'
  },
  paths: {
