...
@Service
public class StoreRoom extends FeatureProcess {
    ...
    public static final BigDecimal MINIMUM_AREA_9_29 = BigDecimal.valueOf(9.29);
    public static final BigDecimal MINIMUM_AREA_3_00 = BigDecimal.valueOf(3.00);
                            ...
                            if (floor.getStoreRooms() != null  && floor.getStoreRooms().size()>0) {
                                ...
                                if (!storeRoomHeights.isEmpty()) {
                                    ...
                                    if (A.equalsIgnoreCase(mostRestrictiveOccupancy.getType().getCode())) {
                                     	...
                                     	Log.info("Minimum  Store Room Height required is set to : "+MINIMUM_HEIGHT_2_75);
                                    }
...
//                                        minimumHeight = MINIMUM_HEIGHT_3_6;
                            ...
                            if (!roomAreas.isEmpty()) {
                                ...
                                BigDecimal minRoomWidth = roomWidths.stream().reduce(BigDecimal::min).get();
                                    ...
                                    minimumHeight = MINIMUM_AREA_3_00;
