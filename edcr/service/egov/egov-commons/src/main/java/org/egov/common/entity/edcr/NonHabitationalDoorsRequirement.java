...
public class NonHabitationalDoorsRequirement extends MdmsFeatureRule {
	 ...
	 @JsonProperty("minDoorWidth")
		...
		public String toString() {
			return "NonHabitationalDoorsRequirement [minDoorWidth=" + minDoorWidth + ", minDoorHeight=" + minDoorHeight
					+ "]";
		}
