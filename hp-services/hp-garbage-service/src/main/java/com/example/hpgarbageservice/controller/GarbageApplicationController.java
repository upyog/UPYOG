...
@RestController
@RequestMapping("/garbage-application")
public class GarbageApplicationController {

    @Autowired
    private GarbageAccountService service;

//    @PostMapping("/_create")
//    public ResponseEntity<List<GarbageAccountRequest>> create(@RequestBody GarbageAccountRequest createGarbageRequest) {
