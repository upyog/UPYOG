 ...
 * statement executed by the DIGIT persister service.</li>
 * <li><strong>Call sites</strong> — every
 * {@link org.upyog.adapter.producer.AdapterProducer#push} invocation should
...
public final class KafkaTopics {
    ...
    /**
     * Topic consumed by the DIGIT persister to execute an
     ...
     */
    public static final String UPDATE_ADAPTER_MODULE_SUMMARY = "update-adapter-module-summary";
}
