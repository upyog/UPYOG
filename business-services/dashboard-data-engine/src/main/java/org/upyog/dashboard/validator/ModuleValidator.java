 ...
 * {@link org.upyog.dashboard.model.DashboardData} record for a specific module,
 ...
 * <ol>
 *   <li>Create a class in {@code org.upyog.dashboard.<module>.validation.impl}
 ...
 *       {@link org.upyog.dashboard.exception.ValidationException} for any missing
...
public interface ModuleValidator {
     ...
     * {@link org.upyog.dashboard.model.DashboardData} record.
     *
     * <p>Implementations should iterate over all metrics keys that are mandatory
     * for their module and throw a {@link org.upyog.dashboard.exception.ValidationException}
     ...
     * @throws org.upyog.dashboard.exception.ValidationException if any mandatory
