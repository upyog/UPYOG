...
/**
 * Compile-time constants for every Kafka topic name used by the
 * adapter-service.
 *
 * <p>
 * Topic names defined here must stay in sync with three other artefacts:
 * <ol>
 * <li><strong>application.properties</strong> — each constant corresponds to a
 * {@code kafka.topics.*} property key so that the value can also be injected
 * via {@code @Value} when needed.</li>
 * <li><strong>adapter-service-persister.yml</strong> — each topic has a
 * matching {@code fromTopic} entry that binds it to an INSERT or UPDATE SQL
 * statement executed by the persister service.</li>
 * <li><strong>Call sites</strong> — every
 * {@link org.upyog.dashboard.producer.DashboardProducer#push} invocation should
 * reference one of these constants instead of a raw string to prevent silent
 * mismatches.</li>
 * </ol>
 *
 ...
 *
 * <p>
 * This class is a non-instantiable utility class; the private constructor
...
public final class KafkaTopics {
     ...
     *
     * <p>
     * Payload structure expected by the persister:
     * <pre>{@code
     * {
     ...
     *
     * <p>
     * Corresponding {@code application.properties} key:
     * {@code kafka.topics.save.ingestion.detail}
     *
     * @see org.upyog.dashboard.entity.DailyIngestionData
     */
    public static final String SAVE_INGESTION_DETAIL = "save-dashboard-ingestion-detail";
     ...
     *
     * <p>
     * The UPDATE sets {@code response_data}, {@code ingestion_status},
     ...
     * into the {@code ingestion_module_summary} table.
     */
    public static final String UPDATE_ADAPTER_MODULE_SUMMARY = "update-dashboard-module-summary";
}
