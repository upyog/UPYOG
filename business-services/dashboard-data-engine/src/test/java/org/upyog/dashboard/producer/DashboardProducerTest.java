...
/**
 * Unit tests for {@link DashboardProducer}.
 */
@ExtendWith(MockitoExtension.class)
class DashboardProducerTest {
    ...
    void setUp() throws Exception {
        producer = new DashboardProducer();
        java.lang.reflect.Field field = DashboardProducer.class.getDeclaredField("kafkaTemplate");
