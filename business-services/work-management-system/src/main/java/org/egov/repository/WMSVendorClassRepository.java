...
import org.egov.repository.querybuilder.WMSVendorClassApplicationQueryBuilder;
import org.egov.repository.querybuilder.WMSVendorTypeApplicationQueryBuilder;
...
import org.egov.repository.rowmapper.WMSVendorClassApplicationRowMapper;
import org.egov.repository.rowmapper.WMSVendorTypeApplicationRowMapper;
...
@Slf4j
@Repository
public class WMSVendorClassRepository {
	
	@Autowired
    private WMSVendorClassApplicationQueryBuilder queryBuilder;

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Autowired
    private WMSVendorClassApplicationRowMapper rowMapper;

    public List<WMSVendorClassApplication>getApplications(WMSVendorClassApplicationSearchCriteria searchCriteria){
        List<Object> preparedStmtList = new ArrayList<>();
        String query = queryBuilder.getVendorClassApplicationSearchQuery(searchCriteria, preparedStmtList);
