...
public class ProjectQueryBuilder {
	...
	private static final String BASE_PRJ_QUERY = " SELECT prj.project_id as sProjectId, prj.project_number as sProjectNumber, prj.source_of_fund as sSchemeSourceOfFund, prj.scheme_no as sSchemeNo, prj.department as sDepartment, prj.project_name_en as sProjectNameEn, prj.project_name_reg as sProjectNameReg, prj.project_description as sProjectDescription, prj.project_timeline as sProjectTimeline,prj.project_start_date as sProjectStartDate,prj.project_end_date as sProjectEndDate,prj.scheme_name as sSchemeName,prj.approval_number as sApprovalNumber,prj.approval_date as sApprovalDate,prj.status as sStatus";
