...
public class WMSContractorApplicationQueryBuilder {
	...
	private static final String BASE_CONTR_QUERY = " SELECT contr.vendor_id as vVendorId, contr.vendor_type as vVendorType, contr.vendor_sub_type as vVendorSubType, contr.vendor_name as vVendorName, contr.vendor_status as vVendorStatus, contr.pfms_vendor_code as vPfmsVendorCode, contr.payto as vPayTo, contr.mobile_number as vMobileNumber, contr.email as vEmail, contr.uid_number as vUidNumber, contr.gst_number as vGstNumber, contr.pan_number as vPanNumber, contr.bank_branch as vBankBranch, contr.bank_ifsc_code as vBankIfscCode, contr.bank_account_number as vBankAccountNumber,contr.function as vFunction,contr.primary_account_head as vPrimaryAccountHead,contr.vendor_class as vVendorClass,contr.address as vAddress,contr.epfo_account_number as vEpfoAccountNumber ";
