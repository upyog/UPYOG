...
public class WMSWorkApplicationQueryBuilder {
	...
	private static final String BASE_BTR_QUERY = " SELECT work.work_id as wWorkId, work.project_id, as wProjectId, work.work_no as wWorkNo, work.work_name as wWorkName, work.project_name as wProjectName, work.department_name as wDepartmentName, work.work_type as wWorkType, work.work_category as wWorkCategory, work.work_subtype as wWorkSubtype, work.project_phase as wProjectPhase, work.deviation_percent as wDeviationPercent, work.start_location as wStartLocation, work.end_location as wEndLocation, work.financial_year as wFinancialYear, work.budget_head as wBudgetHead ";
