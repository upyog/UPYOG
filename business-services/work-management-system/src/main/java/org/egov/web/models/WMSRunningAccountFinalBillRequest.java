...
public class WMSRunningAccountFinalBillRequest {
	
	@JsonProperty("RequestInfo")
    private RequestInfo requestInfo = null;

    @JsonProperty("WMSRunningAccountFinalBillApplication")
    @Valid
    private List<WMSRunningAccountFinalBillApplication> wmsRunningAccountFinalBillApplications = null;


    public WMSRunningAccountFinalBillRequest addRunningAccountFinalBillApplicationsItem(WMSRunningAccountFinalBillApplication wmsRunningAccountFinalBillApplicationsItem) {
