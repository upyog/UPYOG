...
public class WMSWorkAwardApprovalRequest {
	
	@JsonProperty("RequestInfo")
    private RequestInfo requestInfo = null;

    @JsonProperty("WMSWorkAwardApprovalApplication")
    @Valid
    private List<WMSWorkAwardApprovalApplication> wmsWorkAwardApprovalApplications = null;


    public WMSWorkAwardApprovalRequest addWorkAwardApprovalApplicationsItem(WMSWorkAwardApprovalApplication wmsWorkAwardApprovalApplicationsItem) {
