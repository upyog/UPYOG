...
public class WMSDesignationRequest {
	
	@JsonProperty("RequestInfo")
    private RequestInfo requestInfo = null;

    @JsonProperty("WMSDesignationApplication")
    @Valid
    private List<WMSDesignationApplication> wmsDesignationApplications = null;


    public WMSDesignationRequest addDesignationApplicationsItem(WMSDesignationApplication wmsDesignationApplicationsItem) {
