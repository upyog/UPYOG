...
@NoArgsConstructor
@Builder
public class WMSWorkApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSWorkApplications")
    @Valid
    private List<WMSWorkApplication> wmsWorkApplications = null;


    public WMSWorkApplicationResponse addWMSWorkApplicationsItem(WMSWorkApplication wmsWorkApplicationsItem) {
        if (this.wmsWorkApplications == null) {
            this.wmsWorkApplications = new ArrayList<>();
        }
        this.wmsWorkApplications.add(wmsWorkApplicationsItem);
        return this;
    }
