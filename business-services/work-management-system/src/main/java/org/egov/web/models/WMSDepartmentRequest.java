...
public class WMSDepartmentRequest {
	
	@JsonProperty("RequestInfo")
    private RequestInfo requestInfo = null;

    @JsonProperty("WMSDepartmentApplication")
    @Valid
    private List<WMSDepartmentApplication> wmsDepartmentApplications = null;


    public WMSDepartmentRequest addDepartmentApplicationsItem(WMSDepartmentApplication wmsDepartmentApplicationsItem) {
