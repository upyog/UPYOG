...
@NoArgsConstructor
@Builder
public class WMSMeasurementBookApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSMeasurementBookApplications")
    @Valid
    private List<WMSMeasurementBookApplication> wmsMeasurementBookApplications = null;


    public WMSMeasurementBookApplicationResponse addWMSMeasurementBookApplicationsItem(WMSMeasurementBookApplication wmsMeasurementBookApplicationsItem) {
