...
public class WMSVendorTypeApiController{
    ...
    public ResponseEntity<WMSVendorTypeApplicationResponse> v1RegistrationSearchContractorSubType(@RequestBody RequestInfoWrapper requestInfoWrapper, @Valid @ModelAttribute WMSVendorTypeApplicationSearchCriteria wmsVendorTypeApplicationSearchCriteria) {
