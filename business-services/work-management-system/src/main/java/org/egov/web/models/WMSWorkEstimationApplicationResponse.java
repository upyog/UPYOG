...
@NoArgsConstructor
@Builder
public class WMSWorkEstimationApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSWorkEstimationApplications")
    @Valid
    private List<WMSWorkEstimationApplication> wmsWorkEstimationApplications = null;


    public WMSWorkEstimationApplicationResponse addWMSWorkEstimationApplicationsItem(WMSWorkEstimationApplication wmsWorkEstimationApplicationsItem) {
