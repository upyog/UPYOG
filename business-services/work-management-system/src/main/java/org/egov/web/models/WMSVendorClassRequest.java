...
public class WMSVendorClassRequest {
	
	@JsonProperty("RequestInfo")
    private RequestInfo requestInfo = null;

    @JsonProperty("WMSVendorClassApplication")
    @Valid
    private List<WMSVendorClassApplication> wmsVendorClassApplications = null;


    public WMSVendorClassRequest addVendorTypeApplicationsItem(WMSVendorClassApplication wmsVendorClassApplicationsItem) {
