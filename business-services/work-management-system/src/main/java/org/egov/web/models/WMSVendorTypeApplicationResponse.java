...
@NoArgsConstructor
@Builder
public class WMSVendorTypeApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSVendorTypeApplications")
    @Valid
    private List<WMSVendorTypeApplication> wmsVendorTypeApplications = null;


    public WMSVendorTypeApplicationResponse addWMSVendorTypeApplicationsItem(WMSVendorTypeApplication wmsVendorTypeApplicationsItem) {
