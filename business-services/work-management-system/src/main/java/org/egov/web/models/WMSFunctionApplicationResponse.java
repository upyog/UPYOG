...
@NoArgsConstructor
@Builder
public class WMSFunctionApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSFunctionApplications")
    @Valid
    private List<WMSFunctionApplication> wmsFunctionApplications = null;


    public WMSFunctionApplicationResponse addWMSFunctionApplicationsItem(WMSFunctionApplication wmsFunctionApplicationsItem) {
        if (this.wmsFunctionApplications == null) {
            this.wmsFunctionApplications = new ArrayList<>();
        }
        this.wmsFunctionApplications.add(wmsFunctionApplicationsItem);
        return this;
    }
