...
@NoArgsConstructor
@Builder
public class WMSWorkOrderApplicationResponse {
	
	@JsonProperty("ResponseInfo")
    private ResponseInfo responseInfo = null;

    @JsonProperty("WMSWorkOrderApplications")
    @Valid
    private List<WMSWorkOrderApplication> wmsWorkOrderApplications = null;


    public WMSWorkOrderApplicationResponse addWMSWorkOrderApplicationsItem(WMSWorkOrderApplication wmsWorkOrderApplicationsItem) {
