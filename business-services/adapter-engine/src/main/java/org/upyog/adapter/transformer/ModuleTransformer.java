package org.upyog.adapter.transformer;
 ...
 *
 * <p>Each DIGIT module has its own data schema and metric derivation rules.
 ...
 * <ol>
 *   <li>Add the module constant to {@link org.upyog.adapter.common.constants.Module}.</li>
 ...
 * @see org.upyog.adapter.pt.transformer.PTTransformer
...
public interface ModuleTransformer<T> {
     ...
     * in {@link org.upyog.adapter.registry.TransformerRegistry}.  Each
     ...
     *       {@code rawData}.</li>
     *   <li>Building one or more {@link org.upyog.adapter.model.DashboardData}
     ...
     * downstream {@link org.upyog.adapter.validator.CommonValidator}.
     *
