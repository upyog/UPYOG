...
/**
 * Default Spring-managed implementation of {@link AdapterClient}.
 *
 ...
 * active modules have a corresponding {@link org.upyog.adapter.validator.ModuleValidator}.
 *
 * <h3>Dependencies</h3>
...
public class AdapterClientImpl implements AdapterClient {
    ...
    /**
     * Registry that maps each {@link org.upyog.adapter.common.constants.Module}
     ...
     * @throws org.upyog.adapter.exception.ValidationException if
     ...
     */
    @Override
    public IngestionResult execute(AdapterRequest request) {
