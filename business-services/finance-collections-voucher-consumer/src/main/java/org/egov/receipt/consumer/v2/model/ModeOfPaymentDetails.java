...
public class ModeOfPaymentDetails {
	...
	public enum TxnStatusEnum {
		PAID("PAID"), PAYMENT_FAILED("PAYMENT_FAILED"), PAYMENT_PENDING("PAYMENT_PENDING");
	...
	public enum TxnPeriodEnum {
		QUARTER_1("QUARTER_1"), QUARTER_2("QUARTER_2"), QUARTER_3("QUARTER_3"), QUARTER_4("QUARTER_4"),

		HALF_YEAR_1("HALF_YEAR_1"), HALF_YEAR_2("HALF_YEAR_2"), YEARLY("YEARLY");
