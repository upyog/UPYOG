 ...
 * {@link org.upyog.adapter.common.constants.KafkaTopics}.  The corresponding
 * INSERT / UPDATE SQL is declared in {@code adapter-service-persister.yml} and
 * executed by the DIGIT persister service when it consumes the topic.
 *
 * @see org.upyog.adapter.common.constants.KafkaTopics
...
public class AdapterProducer {
     ...
     *              {@link org.upyog.adapter.common.constants.KafkaTopics}
    ...
    public void push(String topic, Object value) {
        log.info("AdapterProducer | pushing to topic: {}", topic);
