...
public class DashboardData {
    ...
    /**
     * Short code identifying the DIGIT module (e.g. {@code PT}, {@code TL}, {@code FSM}).
     *
     * <p>Must match one of the values defined in
     * {@link org.upyog.adapter.common.constants.Module} and must be accepted
     ...
     * code in the DIGIT location hierarchy.
     */
    private String ward;
     ...
     *
     * <p>Validated as mandatory by {@link org.upyog.adapter.validator.CommonValidator}.
     * This value is also stored as both {@code tenantId} and {@code ulbName} in
     * the {@link org.upyog.adapter.entity.DailyIngestionData} audit record.
     */
    private String ulb;
     ...
     * {@link org.upyog.adapter.validator.CommonValidator} and further validated
     * for required keys by the module-specific
     * {@link org.upyog.adapter.validator.ModuleValidator}.
     */
