 ...
 *       {@link org.upyog.adapter.service.OAuthTokenService#getUserInfo()} and
...
public class UserInfo {
    ...
    /**
     * UUID of the user — the preferred unique identifier across all DIGIT services.
     *
     * <p>Used when logging user identity and when storing
     * {@link org.upyog.adapter.entity.DailyIngestionData#getUserId()} if the user
