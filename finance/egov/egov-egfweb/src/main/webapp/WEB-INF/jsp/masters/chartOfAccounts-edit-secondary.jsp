...
<script type="text/javascript">
	function validateAndSubmit() {
		...
		if (!validateData())
			return false;
		document.chartOfAccountsForm.action = '${pageContext.request.contextPath}/masters/chartOfAccounts-update-secondary.action';
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="22%" class="bluebox"><s:if
						...
						</s:elseif><s:elseif test="%{model.classification == 5}">
							<s:text name="chartOfAccount.secondaryCode" />
						</s:elseif> <s:else>
						</s:else></td>
				</tr>
				<tr>
