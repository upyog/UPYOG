...
<form:form role="form" action="search" modelAttribute="bankStatementUploadFile" id="bankstatementsearchform" cssClass="form-horizontal form-group rows-bordered" enctype="multipart/form-data">
