		...
		buttons: [
			{
								    ...
								    action: function(e, dt, node, config) {
										...
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Description</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Active</th>';
										tableHTML += '<th style="border:1px solid #ddd; padding:6px;">Fully Qualified Name</th>';
								        ...
								        var fullHTML = '<!DOCTYPE html><html><head>' +
								            '<title>Subledger Category Master</title>' +
								            '<style>' +
