...
@Component
public class AppealRowMapper implements ResultSetExtractor<List<Property>> {
	...
	public List<Appeal> extractData(ResultSet rs) throws SQLException, DataAccessException {
		...
		while (rs.next()) {
			...
			if (null == currentProperty) {
				...
				setPropertyInfo(currentProperty, rs, tenanId, propertyUuId);

				addChildrenToAppeal(rs, currentProperty);
	...
	private void addChildrenToAppeal(ResultSet rs, Appeal currentProperty)
			throws SQLException {
	...
	private void addDocToAppeal(ResultSet rs, Appeal property) throws SQLException {
		...
		property.addDocumentsItemAppeal(doc);
	}
	 ...
	 * @throws SQLException
	* */
	private void setPropertyInfo(Appeal currentProperty, ResultSet rs, String tenantId, String propertyUuId)
			throws SQLException {
