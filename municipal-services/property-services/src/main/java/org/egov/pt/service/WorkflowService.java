...
public class WorkflowService {
	...
	public BusinessServiceResponse businessServiceSearch(PropertySearchRequest request, String applicationTenantId,
			String businessId) {
		StringBuilder uri = new StringBuilder(configs.getWfHost());
		uri.append(configs.getWfBusinessServiceSearchPath());
		uri.append(uri.append("?tenantId=").append(applicationTenantId));
		uri.append("&businessServices=").append(businessId);
