...
import org.egov.waterquality.web.models.Idgen.IdGenerationRequest;
import org.egov.waterquality.web.models.Idgen.IdGenerationResponse;
import org.egov.waterquality.web.models.Idgen.IdRequest;
...
public class IdGenRepository {
    ...
    public IdGenerationResponse getId(RequestInfo requestInfo, String tenantId, String name, String format, int count) {
        ...
        try {
        	...
        	log.error("Unable to generate Application ID", e);
