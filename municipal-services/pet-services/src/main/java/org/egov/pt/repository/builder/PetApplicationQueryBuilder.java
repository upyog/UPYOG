...
public class PetApplicationQueryBuilder {
    ...
    private static final String BASE_PTR_QUERY = " SELECT ptr.id as pid, ptr.tenantid as ptenantid, ptr.applicationnumber as papplicationnumber, ptr.applicantname as papplicantname, ptr.fathername as pfathername, ptr.createdby as pcreatedby, ptr.lastmodifiedby as plastmodifiedby, ptr.createdtime as pcreatedtime, ptr.lastmodifiedtime as plastmodifiedtime, ";

    private static final String PET_SELECT_QUERY = " pet.id as ptid, pet.petName as ptpetname, pet.petType as ptpettype, pet.breedType as ptbreedtype, pet.petAge as ptpetage, pet.petGender as ptpetgender, pet.clinicName as ptclinicname, pet.doctorName as ptdoctorname, pet.lastVaccineDate as ptlastvaccinedate, pet.petDetailsId as ptpetdetails, ";
    ...
    private static final String FROM_TABLES = " FROM eg_ptr_registration ptr LEFT JOIN eg_ptr_address add ON ptr.id = add.registrationid LEFT JOIN eg_ptr_petdetails pet on ptr.id = pet.petDetailsId ";
