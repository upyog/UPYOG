		...
		while (rs.next()) {
			...
			if (null == currentProperty) {
				...
				currentProperty = Property.builder()
						.source(org.egov.ptr.models.enums.Source.fromValue(rs.getString("source")))
