...
import org.egov.ptr.models.UnitUsage;
import org.egov.ptr.models.enums.Status;
import org.egov.ptr.repository.AssessmentRepository;
...
import org.egov.ptr.web.contracts.AssessmentRequest;
...
public class AssessmentValidator {
	...
	@Autowired
	private PetRegistrationService propertyService;
