...
public class StreetVendingConstants {
	...
	public static final String SV_APPLICATION_NUMBER_PARAM = "applicationNumbers";
	public static final String MOBILE_NUMBER_PARAM = "mobileNumber";
	public static final String USERID_PARAM = "userid";
	public static final String SV_SERVICES = "sv-services";
	...
	public static final String VENDING_TYPE_PARAM = "vendingType";
	public static final String VENDING_ZONE_PARAM = "vendingZone";
