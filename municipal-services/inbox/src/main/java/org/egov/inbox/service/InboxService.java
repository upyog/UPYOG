...
public class InboxService {
	...
	private JSONArray fetchModuleObjects(HashMap moduleSearchCriteria, List<String> businessServiceName, String tenantId,
		...
		if(businessServiceName.contains("ASMT"))
		{
			url.append("&assessmentNumbers=").append(StringUtils
					.arrayToDelimitedString(((Collection<?>) moduleSearchCriteria.get("acknowledgementIds")).toArray(), ","));
		}
		else
		{
