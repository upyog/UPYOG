...
public class ErrorConstants {
	...
	public static final String INVALID_ENTERPRISETYPE_CODE = "INVALID_ENTERPRISE_TYPE";
	public static final String INVALID_ENTERPRISETYPE_MSG = "The following Enterprise Type is invalid.";

	public static final String INVALID_APPLICATIONTYPE_CODE = "INVALID_APPLICATION_TYPE";
	public static final String INVALID_APPLICATIONTYPE_MSG = "The following Application Type is invalid.";
