 ...
 * This class encapsulates the details of a service request, including:
 * - Citizen information associated with the request.
 * - Tenant and service-specific details such as tenant ID and service code.
 * - Location details like address, latitude, and longitude.
 * - Contact information such as email and phone number.
 * - Status and source of the service request.
 * - Additional metadata like attributes, audit details, and feedback.
 *
 * This class is part of the PGR V1 module and is used to manage
 * service request-related information within the system.
 */
@AllArgsConstructor
@NoArgsConstructor
@Builder
