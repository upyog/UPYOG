...
import static org.upyog.pgrai.util.PGRConstants.PGR_BUSINESSSERVICE;
import static org.upyog.pgrai.util.PGRConstants.PGR_MODULENAME;

/**
 * Service class for migrating data from PGR v1 to PGR v2.
 * Handles transformation of service and workflow data to the new format.
 */
...
public class MigrationService {
    ...
    /**
     * Transforms services and workflows from PGR v1 to PGR v2 format.
     *
     * @param servicesV1      The list of services from PGR v1.
     * @param actionHistories The list of action histories from PGR v1.
     * @param idToUuidMap     The mapping of old IDs to new UUIDs.
     * @return A map containing transformed services and workflows.
     */
    private Map<String, Object> transform(List<Service> servicesV1, List<ActionHistory> actionHistories, Map<Long, String> idToUuidMap) {
        ...
        for (Service serviceV1 : servicesV1) {
            ...
            org.upyog.pgrai.web.models.Service service = transformService(serviceV1, idToUuidMap);
    ...
    /**
     * Transforms a PGR v1 service to a PGR v2 service.
     *
     * @param serviceV1   The service from PGR v1.
     * @param idToUuidMap The mapping of old IDs to new UUIDs.
     * @return The transformed service in PGR v2 format.
     */
    private org.upyog.pgrai.web.models.Service transformService(Service serviceV1, Map<Long, String> idToUuidMap) {
     ...
     * @return
     */
    private org.upyog.pgrai.web.models.Address transformAddress(Address addressV1) {
    ...
    /**
     * Transforms a PGR v1 action to a PGR v2 workflow process instance.
     *
     * @param actionInfo        The action from PGR v1.
     * @param idToUuidMap       The mapping of old IDs to new UUIDs.
     * @param actionUuidToSlaMap The mapping of action UUIDs to SLA values.
     * @return The transformed workflow process instance in PGR v2 format.
     */
    ...
    /**
     * Calculates the SLA values for actions in a workflow.
     *
     * @param actionInfos The list of actions in the workflow.
     * @param serviceCode The service code for the workflow.
     * @return A map of action UUIDs to SLA values.
     */
