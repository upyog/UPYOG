...
/**
 * Enum representing the status of a service request in the system.
 * This enumeration defines the possible statuses:
 * - ACTIVE: Represents an active service request.
 * - INACTIVE: Represents an inactive service request.
 * - CANCELLED: Represents a cancelled service request.
 *
 * This enum is part of the PGR V1 module and is used to manage
 * status-related information for service requests.
 */
public enum Status {
	...
	/**
	 * Constructor to initialize the status with a specific value.
	 *
	...
	/**
	 * Converts a given string value to the corresponding Status enum constant.
	 *
