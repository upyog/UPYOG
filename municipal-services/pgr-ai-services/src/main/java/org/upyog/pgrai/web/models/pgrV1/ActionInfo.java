...
/**
 * Represents the details of an action performed on a service request in the system.
 * This class encapsulates various attributes related to an action, such as:
 * - The unique identifier of the action.
 * - The tenant information.
 * - The user who performed the action.
 * - The timestamp of the action.
 * - The business key associated with the action.
 * - The type of action performed (e.g., Reject, Approve, Reassign, Forward).
 * - The status and assignee details.
 * - Any associated media and comments.
 *
 * Key features:
 * - Provides methods to set and retrieve action details.
 * - Ensures validation of certain fields like tenant ID and comments.
 *
