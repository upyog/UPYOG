CREATE TABLE IF NOT EXISTS public.eg_birth_details
(
    ...
    CONSTRAINT eg_birth_details_registrationno_ukey1 UNIQUE (registrationno, tenantid)
    );
-- Index: idx_eg_birth_details_tenantid

-- DROP INDEX IF EXISTS public.idx_eg_birth_details_tenantid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_details_tenantid
    ON public.eg_birth_details USING btree
    (tenantid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

CREATE TABLE IF NOT EXISTS public.eg_birth_father_information
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    lastmodifiedtime bigint,
    CONSTRAINT eg_birth_father_information_pkey PRIMARY KEY (id),
    CONSTRAINT eg_birth_father_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.eg_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );
-- Index: idx_eg_birth_father_information_birthdtlid

-- DROP INDEX IF EXISTS public.idx_eg_birth_father_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_father_information_birthdtlid
    ON public.eg_birth_father_information USING btree
...
CREATE TABLE IF NOT EXISTS public.eg_birth_mother_information
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    firstname_en character varying(200) COLLATE pg_catalog."default",
    firstname_ml character varying(200) COLLATE pg_catalog."default",
    ...
    CONSTRAINT eg_birth_mother_information_pkey PRIMARY KEY (id),
    CONSTRAINT eg_birth_mother_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.eg_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );
-- Index: idx_eg_birth_mother_information_birthdtlid
-- DROP INDEX IF EXISTS public.idx_eg_birth_mother_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_mother_information_birthdtlid
    ON public.eg_birth_mother_information USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

CREATE TABLE IF NOT EXISTS public.eg_birth_permanent_address
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT eg_birth_permanent_address_pkey PRIMARY KEY (id),
    CONSTRAINT eg_birth_permanent_address_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.eg_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );
-- Index: idx_eg_birth_permanent_address_info_birthdtlid
-- DROP INDEX IF EXISTS public.idx_eg_birth_permanent_address_info_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_permanent_address_info_birthdtlid
    ON public.eg_birth_permanent_address USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;
...
-- Index: idx_eg_birth_place_birthdtlid

-- DROP INDEX IF EXISTS public.idx_eg_birth_place_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_place_birthdtlid
    ON public.eg_birth_place USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;
CREATE TABLE IF NOT EXISTS public.eg_birth_present_address
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    resdnce_addr_type character varying(64) COLLATE pg_catalog."default",
    buildingno character varying(200) COLLATE pg_catalog."default",
    ...
    postoffice_en character varying(1000) COLLATE pg_catalog."default",
    postoffice_ml character varying(1000) COLLATE pg_catalog."default",
    CONSTRAINT eg_birth_present_address_pkey PRIMARY KEY (id),
    CONSTRAINT eg_birth_present_address_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.eg_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );
-- Index: idx_eg_birth_present_address_birthdtlid
-- DROP INDEX IF EXISTS public.idx_eg_birth_present_address_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_present_address_birthdtlid
    ON public.eg_birth_present_address USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

CREATE TABLE IF NOT EXISTS public.eg_birth_statitical_information (
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT eg_birth_statitical_information_pkey PRIMARY KEY (id),
    CONSTRAINT eg_birth_statitical_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.eg_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );
-- Index: idx_eg_birth_statitical_information_birthdtlid
-- DROP INDEX IF EXISTS public.idx_eg_birth_statitical_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_eg_birth_statitical_information_birthdtlid
    ON public.eg_birth_statitical_information USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;
...
(
    ...
    birth_talukid character varying(64) COLLATE pg_catalog."default",
    father_name_en character varying(200) COLLATE pg_catalog."default",
    perm_address character varying(600) COLLATE pg_catalog."default",
...
(
    ...
    declaration_id character varying(64) COLLATE pg_catalog."default",
    is_esigned boolean,
    care_of_applicant character varying(45) COLLATE pg_catalog."default",
...
CREATE TABLE IF NOT EXISTS public.eg_birth_abandoned_care_taker
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    birthdtlid character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- Index: idx_eg_birth_certificate_request_registrationno

-- DROP INDEX IF EXISTS public.idx_eg_birth_certificate_request_registrationno;
...
CREATE INDEX IF NOT EXISTS idx_eg_birth_certificate_request_registrationno
    ...
    (registrationno COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;
-- Index: idx_eg_birth_certificate_request_tenantid

-- DROP INDEX IF EXISTS public.idx_eg_birth_certificate_request_tenantid;
...
(
    ...
    order_of_birth integer NOT NULL,
    dob bigint,
    is_alive boolean,
    createdby character varying(45) COLLATE pg_catalog."default",
    createdtime bigint,
...
(
    ...
    CONSTRAINT eg_birth_correction_child_fkey FOREIGN KEY (correction_id)
...
(
    ...
    CONSTRAINT eg_birth_correction_document_fkey FOREIGN KEY (correction_id)
    REFERENCES public.eg_birth_correction (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    );
