-- Table: public.eg_birth_details

-- DROP TABLE IF EXISTS public.eg_birth_details;
CREATE TABLE public.eg_birth_details
(
...
-- Table: public.eg_birth_father_information

-- DROP TABLE IF EXISTS public.eg_birth_father_information;
...
-- Table: public.eg_birth_mother_information

-- DROP TABLE IF EXISTS public.eg_birth_mother_information;
...
-- Table: public.eg_birth_permanent_address

-- DROP TABLE IF EXISTS public.eg_birth_permanent_address;
...
-- Table: public.eg_birth_place

-- DROP TABLE IF EXISTS public.eg_birth_place;
...
-- Table: public.eg_birth_present_address

-- DROP TABLE IF EXISTS public.eg_birth_present_address;
...
-- Table: public.eg_birth_statitical_information

-- DROP TABLE IF EXISTS public.eg_birth_statitical_information;
