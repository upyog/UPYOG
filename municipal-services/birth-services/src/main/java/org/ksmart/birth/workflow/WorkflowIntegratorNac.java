...
@Service
@Slf4j
public class WorkflowIntegratorNac {

	 private   final BirthConfiguration bndConfig;
	 private   final RestTemplate restTemplate;
	 
	 @Autowired
	    public WorkflowIntegratorNac(RestTemplate restTemplate, BirthConfiguration bndConfig) {
	 ...
	 /**
	     ...
	     */
	    public  void callWorkFlow(NacDetailRequest request) {

	        NacApplication currentFile = request.getNacDetails().get(0);
