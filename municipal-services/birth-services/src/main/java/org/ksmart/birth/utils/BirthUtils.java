...
import static org.ksmart.birth.utils.enums.ErrorCodes.INVALID_SEARCH;

@Component
@NoArgsConstructor(access = AccessLevel.PRIVATE)
@Slf4j
public class BirthUtils implements ApplicationContextAware {

    private static ApplicationContext applicationContext;

    @Override
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException { // NOPMD
        BirthUtils.applicationContext = applicationContext;
    }
