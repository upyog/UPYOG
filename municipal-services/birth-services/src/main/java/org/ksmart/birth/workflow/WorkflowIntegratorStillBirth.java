...
@Service
@Slf4j
public class WorkflowIntegratorStillBirth {
    ...
    @Autowired
    public WorkflowIntegratorStillBirth(RestTemplate restTemplate, BirthConfiguration bndConfig) {
     ...
     */
    public  void callWorkFlow(StillBirthDetailRequest request) {

        StillBirthApplication currentFile = request.getBirthDetails().get(0);
