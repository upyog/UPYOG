...
@Component
@Slf4j
public class AdoptionMdmsAddressValidation   {
	public void validateParentDetails(AdoptionDetailRequest request, Object mdmsData, Map<String, String> errorMap) {
...
//Present Inside kerala
                    ...
                    System.out.println("country  "+countryCodesPresent);
                    System.out.println("sate  "+stateCodesPresent);
