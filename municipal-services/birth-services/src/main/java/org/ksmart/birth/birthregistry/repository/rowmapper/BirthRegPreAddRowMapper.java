...
public class BirthRegPreAddRowMapper {
    public RegisterBirthPresentAddress getRegBirthPresentAddress(ResultSet rs) throws SQLException {
        return RegisterBirthPresentAddress.builder()
                ...
                .mainPlaceEn(rs.getString("pres_locality_en"))
                .streetLocalityAreaEn(rs.getString("pres_street_name_en"))
                .mainPlaceMl(rs.getString("pres_locality_ml"))
                .streetLocalityAreaMl(rs.getString("pres_street_name_ml"))
