...
import static org.ksmart.birth.utils.BirthConstants.CR_RESIDENCE_PLACE_TYPE_OUTSIDE;
...
public class BirthRegPreAddRowMapper {
    public RegisterBirthPresentAddress getRegBirthPresentAddress(ResultSet rs) throws SQLException {
        return RegisterBirthPresentAddress.builder()
                ...
                .resAssoNoMl(rs.getString("pres_countryid"))
                .talukName(rs.getString("pres_taluk_name"))
                .villageName(rs.getString("pres_village_name"))
                .wardCode(rs.getString("pres_ward_code"))
                .doorNo(rs.getString("pres_doorno"))
                .subNo(rs.getString("pres_subno"))
                .otZipcode(rs.getString("pres_ot_zipcode"))
                .mainPlaceEn(rs.getString("pres_main_place_en"))
                .streetLocalityAreaEn(rs.getString("pres_street_locality_area_en"))
                .mainPlaceMl(rs.getString("pres_main_place_ml"))
                .streetLocalityAreaMl(rs.getString("pres_street_locality_area_ml"))
                .presentAddress(getAddressEnByResidenceType(rs))
                .presentAddressMl(getAddressMlByResidenceType(rs))
                .build();
    }
