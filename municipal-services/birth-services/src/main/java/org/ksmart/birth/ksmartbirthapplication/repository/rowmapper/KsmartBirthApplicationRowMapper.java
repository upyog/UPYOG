...
//                    .institution(rs.getString("pla_institution"))
                    .institutionId(rs.getString("pla_institution_type_id"))
                    .institutionIdMl(rs.getString("pla_institution_id"))
                    //.institutionNameCode(rs.getString("pla_institutionnamecode"))
