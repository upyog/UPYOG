...
public class BirthApplicationQueryBuilder extends BaseBirthQuery {
    private static final String QUERY = new StringBuilder().append("SELECt ebd.id as ba_id,ebd.dateofreport as ba_dateofreport,ebd.dateofbirth as ba_dateofbirth,ebd.timeofbirth as ba_timeofbirth,ebd.am_pm as ba_am_pm,ebd.firstname_en as ba_firstname_en,")
            ...
            .append("eperad.res_asso_no as per_res_asso_no,eperad.housename_en as per_housename_en,eperad.housename_ml as per_housename_ml,eperad.ot_address1_en as per_ot_address1_en,")
            ...
            .append("eperad.taluk_name as per_taluk_name, eperad.village_name as per_village_name, eperad.ward_code as per_ward_code, eperad.doorno as per_doorno, eperad.subno as per_subno , eperad.ot_zipcode as per_ot_zipcode, eperad.main_place_en as per_main_place_en,")
            .append("eperad.street_locality_area_en as per_street_locality_area_en, eperad.main_place_ml as per_main_place_ml, eperad.street_locality_area_ml as per_street_locality_area_ml,")
            ...
            .append("epreadd.taluk_name as pres_taluk_name, epreadd.village_name as pres_village_name, epreadd.ward_code as pres_ward_code, epreadd.doorno as pres_doorno, epreadd.subno as pres_subno , epreadd.ot_zipcode as pres_ot_zipcode, epreadd.main_place_en as pres_main_place_en,")
            .append("epreadd.street_locality_area_en as pres_street_locality_area_en, epreadd.main_place_ml as pres_main_place_ml, epreadd.street_locality_area_ml as pres_street_locality_area_ml,")
