...
public class IDGenerator {
    ...
    /**
     * Sets the ApplicationNumber for given Adoption Request
     *
     * @param request KsmartBirthDetailsRequest which is to be created
     */
    public String setIDGeneratorAdoption(AdoptionDetailRequest request, String moduleCode, String idType) {
        int Year = Calendar.getInstance().get(Calendar.YEAR);
        String tenantId = request.getAdoptionDetails().get(0).getTenantId();
        String nextID = getNewID(tenantId, Year, moduleCode, idType);
