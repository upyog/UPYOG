...
public class BirthRegPerAddRowMapper {
    public RegisterBirthPermanentAddress getRegBirthPermanentAddress(ResultSet rs) throws SQLException {
        return RegisterBirthPermanentAddress.builder()
                ...
                .mainPlaceEn(rs.getString("per_locality_en"))
                .streetLocalityAreaEn(rs.getString("per_street_name_en"))
                .mainPlaceMl(rs.getString("per_locality_ml"))
                .streetLocalityAreaMl(rs.getString("per_street_name_ml"))
