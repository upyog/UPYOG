package org.ksmart.birth.bornoutside.repository.querybuilder;
...
@Component
public class BornOutsideQueryBuilder extends BaseBornOutsideQuery {
    @Autowired
...
//            .append(" LEFT JOIN eg_birth_initiator ini ON ini.birthdtlid = ebd.id ").toString();
    ...
    public String getNewBirthApplicationSearchQuery(@NotNull SearchCriteria criteria, BornOutsideDetailRequest request,
    ...
    public StringBuilder prepareSearchCriteriaFromRequest(StringBuilder query,BornOutsideDetailRequest request, @NotNull List<Object> preparedStmtValues) {
    ...
    public StringBuilder prepareOrderBy(@NotNull SearchCriteria criteria, StringBuilder query, @NotNull List<Object> preparedStmtValues) {
        ...
        if (StringUtils.isEmpty(criteria.getSortBy()))
            ...
            addOrderByColumns("ebp.applicationtype",criteria.getSortOrder(), orderBy);
