...
public class RegisterQueryBuilder extends BaseRegBuilder {
    private static final String QUERY=new StringBuilder().append("SELECT krbd.id,	krbd.dateofreport,	krbd.dateofbirth,	krbd.timeofbirth,	krbd.am_pm,	krbd.firstname_en,	krbd.firstname_ml,	krbd.middlename_en,")
            ...
            .append("kbp.createdtime, kbp.createdby, kbp.lastmodifiedtime, kbp.lastmodifiedby,ho_doorno, ho_subno, vehicle_haltplace, vehicle_hospitalid, informant_addressline2,")
            .append("ho_res_asso_no_ml, ho_main_place_en, ho_street_locality_area_en, ho_main_place_ml, ho_street_locality_area_ml,")
            ...
            .append("kperad.taluk_name as per_taluk_name, kperad.village_name as per_village_name, kperad.ward_code as per_ward_code, kperad.doorno as per_doorno, kperad.subno as per_subno , kperad.ot_zipcode as per_ot_zipcode, kperad.main_place_en as per_main_place_en,")
            .append("kperad.street_locality_area_en as per_street_locality_area_en, kperad.main_place_ml as per_main_place_ml, kperad.street_locality_area_ml as per_street_locality_area_ml,")
            .append("kpreadd.id as pres_id,kpreadd.resdnce_addr_type as pres_resdnce_addr_type,kpreadd.buildingno as pres_buildingno,kpreadd.houseno as pres_houseno,kpreadd.res_asso_no as pres_res_asso_no,kpreadd.housename_en as pres_housename_en,")
            ...
            .append("kpreadd.taluk_name as pres_taluk_name, kpreadd.village_name as pres_village_name, kpreadd.ward_code as pres_ward_code, kpreadd.doorno as pres_doorno, kpreadd.subno as pres_subno , kpreadd.ot_zipcode as pres_ot_zipcode, kpreadd.main_place_en as pres_main_place_en,")
            .append("kpreadd.street_locality_area_en as pres_street_locality_area_en, kpreadd.main_place_ml as pres_main_place_ml, kpreadd.street_locality_area_ml as pres_street_locality_area_ml,")
