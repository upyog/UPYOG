...
import org.ksmart.birth.birthnac.validator.NacMdmsAddressValidation;
...
public class NacMdmsValidator {
	 private final NacMdmsAddressValidation validAddress;
	    private final MdmsUtil mdmsUtil;
	    @Autowired
	    NacMdmsValidator(NacMdmsAddressValidation validAddress,  MdmsUtil mdmsUtil) {

	        this.validAddress = validAddress;
	        this.mdmsUtil = mdmsUtil;
	    }
	    public void validateMdmsData(NacDetailRequest request, Object mdmsData) {
	    ...
	    private String  validateBasicDetails(NacDetailRequest request, Object mdmsData, Map<String, String> errorMap) {
	        List<String> tenantCodes = getTenantCodes(mdmsData);
	        String tenant = "";
	        for (NacApplication birth : request.getNacDetails()) {
	    ...
	    private void validateBirthPlace(NacDetailRequest request, Object mdmsData, Object mdmsDataLoc, Map<String, String> errorMap) {
...
//	                        }
	    ...
	    private void validateParentDetails(NacDetailRequest request, Object mdmsData, Map<String, String> errorMap) {
