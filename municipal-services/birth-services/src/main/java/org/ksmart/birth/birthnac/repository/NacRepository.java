...
public class NacRepository {
    ...
    private final NacQueryBuilder adoptionQueryBuilder;
    private final NacApplicationRowMapper adoptionApplicationRowMapper;
    ...
    NacRepository(JdbcTemplate jdbcTemplate, NacEnrichment adoptionEnrichment, BirthConfiguration birthDeathConfiguration,
                  BndProducer producer, NacQueryBuilder adoptionQueryBuilder, NacApplicationRowMapper adoptionApplicationRowMapper,
