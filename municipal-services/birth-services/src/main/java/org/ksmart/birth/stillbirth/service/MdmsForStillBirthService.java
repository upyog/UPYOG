...
@Slf4j
@Service
public class MdmsForStillBirthService {
    ...
    public void setLocationDetails(StillBirthApplication birth, Object mdmsDataLoc, Object mdmsData) {
    ...
    public void setInstitutionDetailsEn(StillBirthApplication birth, Object  mdmsData) {
    ...
    public void setInstitutionDetailsMl(StillBirthApplication birth, Object  mdmsData) {
        if (birth.getPlaceofBirthId().contains(BIRTH_PLACE_INSTITUTION)) {
    ...
    public void setVehicleTypeEn(StillBirthApplication birth, Object  mdmsData) {
    ...
    public void setVehicleTypeMl(StillBirthApplication birth, Object  mdmsData) {
        if (birth.getPlaceofBirthId().contains(BIRTH_PLACE_VEHICLE)) {
    ...
    public void setTenantDetails(StillBirthApplication birth, Object  mdmsData) {
