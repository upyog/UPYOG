...
@Service
@Slf4j
public class WorkflowIntegratorBornOutside {
    ...
    @Autowired
    public WorkflowIntegratorBornOutside(RestTemplate restTemplate, BirthConfiguration bndConfig) {
     ...
     */
    public  void callWorkFlow(BornOutsideDetailRequest request) {

        BornOutsideApplication currentFile = request.getNewBirthDetails().get(0);
