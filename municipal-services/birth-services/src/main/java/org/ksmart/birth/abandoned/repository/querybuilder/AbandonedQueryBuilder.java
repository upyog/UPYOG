...
public class AbandonedQueryBuilder extends BaseAbandonedQuery {
   ...
   private static final String QUERYCONDITION = new StringBuilder().append(" FROM public.eg_birth_details ebd LEFT JOIN eg_birth_place ebp ON ebp.birthdtlid = ebd.id LEFT JOIN eg_birth_father_information ebfi ON ebfi.birthdtlid = ebd.id AND ebfi.bio_adopt='BIOLOGICAL'")
    ...
    public String getNewBirthApplicationSearchQuery(@NotNull SearchCriteria criteria, AbandonedRequest request,
    ...
    public StringBuilder prepareSearchCriteriaFromRequest(StringBuilder query,AbandonedRequest request, @NotNull List<Object> preparedStmtValues) {
