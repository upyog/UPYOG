...
@Component
public class BirthApplicationRowMapperForPay implements ResultSetExtractor<List<NewBirthApplication>>, BaseRowMapper, BirthParentDetailRowMapper, InformatDetailsRowMapper, BirthParentAddressRowMapper, InitiatorDetailsRowMapper {
