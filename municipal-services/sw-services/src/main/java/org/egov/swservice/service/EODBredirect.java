...
public class EODBredirect {
    ...
    private boolean updateStatusWithToken(String token, SewerageConnectionRequest connection) {
        ...
        statusIdMap.put("PENDING_FOR_DOCUMENT_VERIFICATION", 6);  // Objection Raised
        statusIdMap.put("PENDING_FOR_FIELD_INSPECTION", 7);  // Objection Resolved
        statusIdMap.put("PENDING_FOR_APPROVAL", 8);  // Form Filled and Fee Pending
        statusIdMap.put("PENDING_FOR_CITIZEN_ACTION", 9);  // Pending for on-site inspection
        ...
        statusDescMap.put("PENDING_FOR_PAYMENT", "Fees Paid (Estimation amount paid)");
        statusDescMap.put("PENDING_FOR_DOCUMENT_VERIFICATION", "Objection Raised");
        statusDescMap.put("PENDING_FOR_FIELD_INSPECTION", "Objection Resolved");
        statusDescMap.put("PENDING_FOR_APPROVAL", "Form Filled and Fee Pending");
        statusDescMap.put("PENDING_FOR_CITIZEN_ACTION", "Pending for on-site inspection");
