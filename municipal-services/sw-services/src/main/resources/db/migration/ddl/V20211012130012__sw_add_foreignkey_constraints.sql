ALTER TABLE eg_sw_applicationdocument DROP CONSTRAINT IF EXISTS fk_eg_sw_applicationdocument_eg_sw_connection_id;
ALTER TABLE eg_sw_plumberinfo DROP CONSTRAINT IF EXISTS fk_eg_sw_plumberinfo_eg_sw_connection_id;
