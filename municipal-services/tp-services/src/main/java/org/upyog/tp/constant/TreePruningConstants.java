...
public class TreePruningConstants {
    ...
    public static final String APPLICATION_UPDATED = "Your Tree Pruning booking update successfully";
    ...
    public static final String MDMS_TREE_PRUNING_CALCULATION_TYPE = "TreePruningCalculationType";
    ...
    public static final String NOTIFICATION_APPLY = "tp.en.counter.submit";

    public static final String NOTIFICATION_VEFIFY = "tp.en.counter.verify";

    public static final String NOTIFICATION_EXECUTE = "tp.en.counter.execute";

    public static final String NOTIFICATION_REJECT = "tp.en.counter.reject";

    public static final String NOTIFICATION_APPROVED = "tp.en.counter.approved";

    public static final String NOTIFICATION_TREEPRUNINGBOOKED = "tp.en.counter.treepruningbooked";
