CREATE TABLE eg_swach_service_v2(
...
CONSTRAINT uk_eg_swach_service_v2 UNIQUE (id),
CONSTRAINT pk_eg_swach_serviceReq_v2 PRIMARY KEY (tenantId,serviceRequestId)
);

CREATE TABLE eg_swach_address_v2 (
...
CONSTRAINT pk_eg_swach_address_v2 PRIMARY KEY (id),
CONSTRAINT fk_eg_swach_address_v2 FOREIGN KEY (parentid) REFERENCES eg_swach_service_v2 (id)
);
