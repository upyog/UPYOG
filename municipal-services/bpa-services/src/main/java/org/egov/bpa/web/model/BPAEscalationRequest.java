...
public class BPAEscalationRequest {
        ...
        @Valid
        @NotNull
        private List<BPAEscalationInstance> BPAEscalationInstances;


        public BPAEscalationRequest addProcessInstanceItem(BPAEscalationInstance bPAEscalationInstance) {
            if (this.BPAEscalationInstances == null) {
            this.BPAEscalationInstances = new ArrayList<>();
            }
        this.BPAEscalationInstances.add(bPAEscalationInstance);
        return this;
        }
