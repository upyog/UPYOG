...
import static org.ksmart.death.utils.BirthDeathConstants.BIRTH_CERT;
import static org.ksmart.death.utils.BirthDeathConstants.DEATH_CERT;
...
import org.ksmart.death.birth.certmodel.BirthCertificate.StatusEnum;
	...
	public DeathCertificate updateDeathPDFGEN(RequestInfo requestInfo, DeathCertificate deathCertificate) {
		try {
			if(deathCertificate.getApplicationStatus().equals(DeathCertificate.StatusEnum.PAID)) {
				org.ksmart.death.death.model.SearchCriteria criteria=new org.ksmart.death.death.model.SearchCriteria();
