...
import org.egov.asset.calculator.repository.DemandRepository;
...
import org.egov.asset.calculator.web.models.demand.Demand;
import org.egov.asset.calculator.web.models.demand.DemandDetail;
import org.egov.asset.calculator.web.models.demand.DemandResponse;
	...
	private List<Demand> createDemand(RequestInfo requestInfo, List<Calculation> calculations) {
		...
		for (Calculation calculation : calculations) {
			...
			if (calculation.getFsm() != null) {
				...
				fsm = assetService.getAssetApplication(requestInfo, calculation.getTenantId(),
