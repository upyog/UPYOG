...
/**
 * Uploads garbage application documents and certificates to Alfresco (DMS) via REST.
 * Accepts DmsRequest with file content and metadata from GarbageAccountService certificate flows.
 */
@Service
@Slf4j
...
//    private ServiceRequestRepository serviceRequestRepository;
	...
	public String uploadAttachment(DmsRequest dmsRequest, RequestInfo requestInfo) throws IOException {
		...
		String documentReferenceId = upload(dmsRequest, requestInfo);
...
//		DMSResponse response = mapper.convertValue(result,DMSResponse.class);
	...
	public String upload(DmsRequest dmsRequest, RequestInfo requestInfo) {
		...
		try {
			...
			List<LinkedHashMap<String, Object>> storageDocumentDetails = (List<LinkedHashMap<String, Object>>) storageResponse.get("files");
