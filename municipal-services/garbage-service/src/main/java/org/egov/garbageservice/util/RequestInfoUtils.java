...
/**
 * Supplies a cached system-user RequestInfo for background jobs and internal service calls.
 * Resolves an employee user by SYSTEM role via UserService when no citizen context is present.
 */
@Component
