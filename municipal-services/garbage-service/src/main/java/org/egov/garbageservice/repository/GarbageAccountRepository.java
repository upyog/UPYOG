...
public class GarbageAccountRepository {
	...
	private static final String SELECT_QUERY_ACCOUNT = "SELECT acc.*, doc.uuid as doc_uuid, doc.doc_ref_id as doc_doc_ref_id, doc.doc_name as doc_doc_name, doc.doc_type as doc_doc_type, doc.doc_category as doc_doc_category, doc.tbl_ref_uuid as doc_tbl_ref_uuid "
			...
			+ ", sub_acc.last_modified_date as sub_acc_last_modified_date, sub_acc.additional_detail as sub_acc_additional_detail, sub_acc.tenant_id as sub_acc_tenant_id, sub_acc.is_parent_account as sub_acc_is_parent_account"
    ...
    private static final String INSERT_ACCOUNT = "INSERT INTO eg_grbg_account (id, uuid, garbage_id, property_id, type, name"
    		+ ", mobile_number, gender, email_id, is_owner, user_uuid, declaration_uuid, status, additional_detail, created_by, created_date, last_modified_by, last_modified_date, tenant_id, is_parent_account) "
    		...
    		+ ":lastModifiedBy, :lastModifiedDate, :tenantId, :isParentAccount)";
...
//        accountInputs.put("parentId", account.getParentId());
        ...
        accountInputs.put("isParentAccount", account.getIsParentAccount());
