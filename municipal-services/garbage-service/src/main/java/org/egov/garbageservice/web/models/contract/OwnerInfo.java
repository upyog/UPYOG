...
/**
 * Property owner profile used on garbage accounts, extending the base User contract.
 * Adds ownership share, owner type, guardian relationship, status, and supporting documents.
 * Supports copying from User service data, deep copy for mutations, and document attachment helpers.
 */
@Getter
@Setter
@AllArgsConstructor
...
public class OwnerInfo extends User {
    ...
    /**
     * Executes the addDocumentsItem operation.
     */
    ...
    /**
     * Executes the copyDocuments operation.
     */
    ...
    /**
     * Executes the mutationEquals operation.
     */
