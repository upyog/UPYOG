...
/**
 * Calls the URL shortening service to produce compact payment or citizen portal links for SMS.
 * Wraps RestTemplate POST with the long URL and returns the shortened link for notifications.
 */
@Service
@Slf4j
