...
@NoArgsConstructor
/**
 * Request to create or update shared garbage master data (collection units, charges, etc.).
 * Used by GarbageCommonController /_create with RequestInfo and Grbg* entity lists.
 */
@Builder
