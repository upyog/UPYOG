 ...
 * Wraps eGov CustomKafkaTemplate and exposes a simple push(topic, value) used after
 * account save/update and during scheduler flows (e.g. bill generation, sanitize logging).
 */
@Service
@Slf4j
