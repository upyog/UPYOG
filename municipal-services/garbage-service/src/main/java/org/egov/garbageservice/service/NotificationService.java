...
/**
 * Sends SMS and related notifications when bills are generated or payment reminders are needed.
 * Builds templated messages, calls the SMS gateway, and can trigger email flows for citizens.
 */
@Service
@Slf4j
