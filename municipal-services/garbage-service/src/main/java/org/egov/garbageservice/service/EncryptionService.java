...
/**
 * Client for the platform encryption service to encrypt or decrypt sensitive string values.
 * Used when PII or payment-related fields must not be stored or logged in plain text.
 */
@Service
@Slf4j
