...
/**
 * Batch job service that queues pending garbage bills for SMS delivery tracking.
 * Invoked from GarbageSmsController /process-pending to populate eg_notification_sms_tracker.
 */
@Service
@Slf4j
