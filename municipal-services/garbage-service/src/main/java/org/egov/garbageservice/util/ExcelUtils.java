...
/**
 * Apache POI utilities to parse bulk garbage registration Excel uploads into GarbageAccount models.
 * Maps sheet rows to addresses, collection units, child accounts, and additionalDetails for Excel import.
 */
@Component
@Slf4j
