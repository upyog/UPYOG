...
import static org.egov.notice.util.TLConstants.*;
...
public class TLInboxFilterService {
    ...
    public List<String> fetchApplicationNumbersFromSearcher(InboxSearchCriteria criteria, HashMap<String, String> StatusIdNameMap, org.egov.notice.web.model.RequestInfo requestInfo){
    ...
    private HashMap setUserWhenMobileNoIsEmptyForStakeholderRegOfCitizen(InboxSearchCriteria criteria, org.egov.notice.web.model.RequestInfo requestInfo,
    ...
    public Integer fetchApplicationCountFromSearcher(InboxSearchCriteria criteria, HashMap<String, String> StatusIdNameMap, org.egov.notice.web.model.RequestInfo requestInfo){
