...
import static org.egov.notice.util.BSConstants.*;
import static org.egov.notice.util.BpaConstants.BPA;
import static org.egov.notice.util.BpaConstants.BPAREG;
import static org.egov.notice.util.BpaConstants.BPA_APPLICATION_NUMBER_PARAM;
import static org.egov.notice.util.BpaConstants.LOCALITY_PARAM;
import static org.egov.notice.util.BpaConstants.MOBILE_NUMBER_PARAM;
import static org.egov.notice.util.BpaConstants.OFFSET_PARAM;
import static org.egov.notice.util.BpaConstants.STATUS_ID;
import static org.egov.notice.util.BpaConstants.STATUS_PARAM;
import static org.egov.notice.util.DSSConstants.*;
import static org.egov.notice.util.FSMConstants.APPLICATIONSTATUS;
import static org.egov.notice.util.FSMConstants.CITIZEN_FEEDBACK_PENDING_STATE;
import static org.egov.notice.util.FSMConstants.COMPLETED_STATE;
import static org.egov.notice.util.FSMConstants.COUNT;
import static org.egov.notice.util.FSMConstants.DISPOSED_STATE;
import static org.egov.notice.util.FSMConstants.DSO_INPROGRESS_STATE;
import static org.egov.notice.util.FSMConstants.FSM_VEHICLE_TRIP_MODULE;
import static org.egov.notice.util.FSMConstants.STATUSID;
import static org.egov.notice.util.FSMConstants.VEHICLE_LOG;
import static org.egov.notice.util.FSMConstants.WAITING_FOR_DISPOSAL_STATE;
import static org.egov.notice.util.NocConstants.NOC;
import static org.egov.notice.util.NocConstants.NOC_APPLICATION_NUMBER_PARAM;
import static org.egov.notice.util.PTConstants.ACKNOWLEDGEMENT_IDS_PARAM;
import static org.egov.notice.util.PTConstants.PT;
import static org.egov.notice.util.SWConstants.SW;
import static org.egov.notice.util.TLConstants.APPLICATION_NUMBER_PARAM;
import static org.egov.notice.util.TLConstants.BUSINESS_SERVICE_PARAM;
import static org.egov.notice.util.TLConstants.REQUESTINFO_PARAM;
import static org.egov.notice.util.TLConstants.SEARCH_CRITERIA_PARAM;
import static org.egov.notice.util.TLConstants.TENANT_ID_PARAM;
import static org.egov.notice.util.TLConstants.TL;
import static org.egov.notice.util.WSConstants.WS;
...
import org.egov.notice.model.vehicle.VehicleSearchCriteria;
import org.egov.notice.model.vehicle.VehicleTripDetail;
import org.egov.notice.model.vehicle.VehicleTripDetailResponse;
import org.egov.notice.model.vehicle.VehicleTripSearchCriteria;
import org.egov.notice.repository.ElasticSearchRepository;
import org.egov.notice.repository.ServiceRequestRepository;
import org.egov.notice.util.BpaConstants;
import org.egov.notice.util.ErrorConstants;
import org.egov.notice.util.FSMConstants;
import org.egov.notice.util.TLConstants;
import org.egov.notice.web.model.Inbox;
import org.egov.notice.web.model.InboxResponse;
import org.egov.notice.web.model.InboxSearchCriteria;
import org.egov.notice.web.model.RequestInfoWrapper;
import org.egov.notice.web.model.VehicleCustomResponse;
import org.egov.notice.web.model.workflow.BusinessService;
import org.egov.notice.web.model.workflow.ProcessInstance;
import org.egov.notice.web.model.workflow.ProcessInstanceResponse;
import org.egov.notice.web.model.workflow.ProcessInstanceSearchCriteria;
import org.egov.notice.web.model.workflow.State;
...
public class InboxService {
    ...
    private NoticeConfiguration config;
    ...
    @Autowired
    public InboxService(NoticeConfiguration config, ServiceRequestRepository serviceRequestRepository,
    ...
    public InboxResponse fetchInboxData(InboxSearchCriteria criteria, org.egov.notice.web.model.RequestInfo requestInfo) {
        ...
        List<String> roles = requestInfo.getUserInfo().getRoles().stream().map(org.egov.notice.web.model.Role::getCode).collect(Collectors.toList());
...
//						}
    ...
    public List<String> fetchVehicleStateMap(List<String> inputStatuses, org.egov.notice.web.model.RequestInfo requestInfo, String tenantId,Integer limit,Integer offSet) {
	 ...
	 */
	private List<VehicleTripDetail> fetchVehicleStatusForApplication(List<String> requiredApplications,org.egov.notice.web.model.RequestInfo requestInfo, String tenantId) {
		VehicleTripSearchCriteria vehicleTripSearchCriteria = new VehicleTripSearchCriteria();
	...
	public List<VehicleTripDetail> fetchVehicleTripDetailsByReferenceNo(VehicleTripSearchCriteria vehicleTripSearchCriteria, org.egov.notice.web.model.RequestInfo requestInfo) {
    ...
    private List<Map<String, Object>> fetchVehicleTripResponse(InboxSearchCriteria criteria, org.egov.notice.web.model.RequestInfo requestInfo,List<String> applicationStatus) {
    ...
    public VehicleCustomResponse fetchApplicationCount(VehicleSearchCriteria criteria, org.egov.notice.web.model.RequestInfo requestInfo) {
		StringBuilder url = new StringBuilder(config.getVehicleHost());
    ...
    private JSONArray fetchModuleObjects(HashMap moduleSearchCriteria, List<String> businessServiceName, String tenantId,
            org.egov.notice.web.model.RequestInfo requestInfo, Map<String, String> srvMap) {
	...
	private JSONArray fetchModuleSearchObjects(HashMap moduleSearchCriteria, List<String> businessServiceName,
			String tenantId, org.egov.notice.web.model.RequestInfo requestInfo, Map<String, String> srvMap) {
