...
import org.egov.notice.web.model.workflow.*;
...
public class WorkflowService {
	...
	@Autowired
	public WorkflowService(NoticeConfiguration config, ServiceRequestRepository serviceRequestRepository,
			ObjectMapper mapper) {
		this.config = config;
	...
	public Integer getProcessCount(String tenantId, org.egov.notice.web.model.RequestInfo requestInfo, ProcessInstanceSearchCriteria criteria) {
	...
	public Integer getNearingSlaProcessCount(String tenantId, org.egov.notice.web.model.RequestInfo requestInfo, ProcessInstanceSearchCriteria criteria) {
		List<String> listOfBusinessServices = new ArrayList<>(criteria.getBusinessService());
		Integer processCount = 0;
		for(String businessSrv : listOfBusinessServices) {
			criteria.setBusinessService(Collections.singletonList(businessSrv));
        ...
        public List<HashMap<String, Object>> getProcessStatusCount(org.egov.notice.web.model.RequestInfo requestInfo,
	...
	public ProcessInstanceResponse getProcessInstance(ProcessInstanceSearchCriteria criteria, org.egov.notice.web.model.RequestInfo requestInfo) {
		StringBuilder url = new StringBuilder(config.getWorkflowHost());
	 ...
	 */
	public BusinessService getBusinessService(String tenantId, org.egov.notice.web.model.RequestInfo requestInfo, String businessServceName) {
    ...
    public HashMap<String,String> getActionableStatusesForRole(org.egov.notice.web.model.RequestInfo requestInfo, List<BusinessService> businessServices,ProcessInstanceSearchCriteria criteria){
     ...
     */
    public Map<String,List<String>> getTenantIdToUserRolesMap(org.egov.notice.web.model.RequestInfo requestInfo){
