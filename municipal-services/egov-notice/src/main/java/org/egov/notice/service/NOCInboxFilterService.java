...
import static org.egov.notice.util.NocConstants.ASSIGNEE_PARAM;
import static org.egov.notice.util.NocConstants.BUSINESS_SERVICE_PARAM;
import static org.egov.notice.util.NocConstants.CITIZEN;
import static org.egov.notice.util.NocConstants.DESC_PARAM;
import static org.egov.notice.util.NocConstants.LIMIT_PARAM;
import static org.egov.notice.util.NocConstants.LOCALITY_PARAM;
import static org.egov.notice.util.NocConstants.MOBILE_NUMBER_PARAM;
import static org.egov.notice.util.NocConstants.NOC_APPLICATION_NUMBER_PARAM;
import static org.egov.notice.util.NocConstants.NOC_SOURCE_APPLICATION_NUMBER_PARAM;
import static org.egov.notice.util.NocConstants.NOC_SOURCE_REF_ID_PARAM;
import static org.egov.notice.util.NocConstants.NO_OF_RECORDS_PARAM;
import static org.egov.notice.util.NocConstants.OFFSET_PARAM;
import static org.egov.notice.util.NocConstants.REQUESTINFO_PARAM;
import static org.egov.notice.util.NocConstants.SEARCH_CRITERIA_PARAM;
import static org.egov.notice.util.NocConstants.SORT_ORDER_PARAM;
import static org.egov.notice.util.NocConstants.STATUS_PARAM;
import static org.egov.notice.util.NocConstants.TENANT_ID_PARAM;
import static org.egov.notice.util.NocConstants.USERID_PARAM;
...
public class NOCInboxFilterService {
    ...
    public List<String> fetchApplicationNumbersFromSearcher(InboxSearchCriteria criteria,
            HashMap<String, String> StatusIdNameMap, org.egov.notice.web.model.RequestInfo requestInfo) {
    ...
    private Map<String, Object> getSearchCriteria(InboxSearchCriteria criteria, HashMap<String, String> StatusIdNameMap,
            org.egov.notice.web.model.RequestInfo requestInfo, HashMap<String, Object> moduleSearchCriteria,
    ...
    private List<String> fetchUserUUID(String mobileNumber, org.egov.notice.web.model.RequestInfo requestInfo, String tenantId) {
        StringBuilder uri = new StringBuilder();
