...
public class VendorAdditionalDetailsResponse {
    ...
    public VendorAdditionalDetailsResponse addAssetsItem(VendorAdditionalDetails assetsItem) {
        if (this.vendorAdditionalDetails == null) {
            this.vendorAdditionalDetails = new ArrayList<>();
        }
        this.vendorAdditionalDetails.add(assetsItem);
        return this;
    }

    public VendorAdditionalDetailsResponse Asset(List<VendorAdditionalDetails> assets) {
        this.vendorAdditionalDetails = assets;
        return this;
    }
