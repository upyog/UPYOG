...
//        mockMvc.perform(post("/community-hall-booking/v1/registration/_create").contentType(MediaType.APPLICATION_JSON))
...
//        mockMvc.perform(post("/community-hall-booking/v1/registration/_update").contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk());
//    }
//
////    @Test
...
//        mockMvc.perform(post("/community-hall-booking/v1/_search").contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk());
//    }
//
////    @Test
