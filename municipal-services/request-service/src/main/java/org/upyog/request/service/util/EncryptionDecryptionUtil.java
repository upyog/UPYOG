//package org.upyog.request.service.util;
//
...
//
//            if (key.equalsIgnoreCase(RequestServiceConstants.RS_APPLICANT_DETAIL_ENCRYPTION_KEY))
...
//
//        if (!abacEnabled) {
//			if (key.equals(RequestServiceConstants.RS_APPLICANT_DETAIL_ENCRYPTION_KEY)/* || key == null */) {
//                keyPurposeMap.put("key", RequestServiceConstants.RS_APPLICANT_DETAIL_PLAIN_DECRYPTION_KEY);
//                keyPurposeMap.put("purpose", RequestServiceConstants.RS_APPLICANT_DETAIL_PLAIN_DECRYPTION_PURPOSE);
//            } 
//        } else {
//            if (key.equals(RequestServiceConstants.RS_APPLICANT_DETAIL_ENCRYPTION_KEY) || key == null) {
//                keyPurposeMap.put("key", RequestServiceConstants.RS_APPLICANT_DETAIL_ENCRYPTION_KEY);
