...
public class ApplicantServiceController {
    ...
    public ResponseEntity<ApplicantServiceResponse> update(@Valid @RequestBody ApplicantServiceRequest request) {

        List<ApplicantService> services = serviceService.update(request);
