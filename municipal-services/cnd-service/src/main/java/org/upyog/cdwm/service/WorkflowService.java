...
public class WorkflowService {
	...
	public State updateWorkflowStatus(PaymentRequest paymentRequest, CNDApplicationRequest cndApplicationRequest) {
	    ...
	    if (paymentRequest != null) {
	        ...
	        processInstance = getProcessInstanceForCnD(null, cndApplicationRequest.getCndApplication(), cndApplicationRequest.getRequestInfo());
	...
	private ProcessInstance getProcessInstanceForCnD(PaymentRequest paymentRequest, CNDApplicationDetail application, RequestInfo requestInfo) {
	 ...
	 *
	 * takes the cnd request as parameter constructs the work-flow request
	 *
	 * and sets the resultant status from wf-response back to cnd object
	 *
	 */
