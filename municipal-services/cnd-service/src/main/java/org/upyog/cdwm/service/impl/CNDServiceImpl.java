...
import org.upyog.cdwm.repository.CNDApplicationRepository;
...
public class CNDServiceImpl implements CNDService {
    ...
    @Autowired
    private CNDApplicationRepository cndApplicationRepository;
    ...
    public CNDApplicationDetail createConstructionAndDemolitionRequest(CNDApplicationRequest cndApplicationRequest) {
        ...
        cndApplicationRepository.saveCNDApplication(cndApplicationRequest);
