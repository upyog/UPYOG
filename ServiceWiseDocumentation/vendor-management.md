...
> Generated from repository path `municipal-services/vendor-management`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `vendor-management` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8066**
- Servlet/context path: **/vendor-management**
...
| driver | 1 source file(s) | Package area detected from source tree. |
| dto | 1 source file(s) | Package area detected from source tree. |
...
| specifications | 1 source file(s) | Package area detected from source tree. |
...
| vendor | 2 source file(s) | Package area detected from source tree. |

## Folder Structure

- `municipal-services/vendor-management`: service root.
...
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/VendorManagementApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| GET | /api/v1 | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /api/v1/_create | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /api/v1/_update | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| DELETE | /api/v1/{id} | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /api/v1/_search | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /api/v1/vendorPlusAdditional/_search | VendorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as vendor_management
...
- **Entity/table-mapped classes:** 4

### Migration locations

- `municipal-services/vendor-management/src/main/resources/db/migration`
- `municipal-services/vendor-management/src/main/resources/db/migration/main`
- `municipal-services/vendor-management/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/vendor-management/src/main/java/org/egov/vendor/repository/AddressRepository.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/repository/IdGenRepository.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/repository/ServiceRequestRepository.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/repository/VendorAdditionalDetailsRepository.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/repository/VendorRepository.java`

### Entity mapping locations

- `municipal-services/vendor-management/src/main/java/org/egov/vendor/web/models/Document.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/web/models/VendorAdditionalDetails.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/web/models/vendorcontract/location/Address.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/web/models/vendorcontract/vendor/Vendor.java`
...
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/kafka/Producer.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/service/VendorService.java`

### Consumers

- `municipal-services/vendor-management/src/main/java/org/egov/vendor/VendorManagementApplication.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/config/KafkaConfiguration.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/config/VendorConfiguration.java`
- `municipal-services/vendor-management/src/main/java/org/egov/vendor/kafka/Consumer.java`
...
- `municipal-services/vendor-management/src/main/resources/application.properties`
...
- `municipal-services/vendor-management/src/main/resources/db/Dockerfile`
