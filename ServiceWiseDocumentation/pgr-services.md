...
> Generated from repository path `municipal-services/pgr-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Public Grievance Redressal v2 service.

## Responsibilities

- Own the `pgr-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/pgr-services**
...
- `municipal-services/pgr-services`: service root.
...
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/PGRApp.java`
...
| POST | /v2/request/_create | RequestsApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v2/request/_search | RequestsApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v2/request/_plainsearch | RequestsApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v2/request/_update | RequestsApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v2/request/_count | RequestsApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_pgr_address_v2, eg_pgr_service_v2
- **Migration files:** 5
...
- `municipal-services/pgr-services/src/main/resources/db/migration`
- `municipal-services/pgr-services/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/pgr-services/src/main/java/org/egov/pgr/repository/IdGenRepository.java`
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/repository/PGRRepository.java`
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/repository/ServiceRequestRepository.java`
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/repository/rowmapper/PGRQueryBuilder.java`
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/repository/rowmapper/PGRRowMapper.java`
...
| municipal-services/pgr-services/src/main/resources/pgr-services-persister.yml topic | save-pgr-request |
| municipal-services/pgr-services/src/main/resources/pgr-services-persister.yml topic | update-pgr-request |
| municipal-services/pgr-services/src/main/resources/pgr-services-persister.yml topic | save-pgr-request |
| municipal-services/pgr-services/src/main/resources/pgr-services-persister.yml topic | update-pgr-request |
| municipal-services/pgr-services/src/main/resources/pgr-v2-persist-batch.yml topic | save-pgr-request-batch |
| municipal-services/pgr-services/src/main/resources/pgr-v2-persist-batch.yml topic | save-wf-transitions-batch |

### Producers

- `municipal-services/pgr-services/src/main/java/org/egov/pgr/producer/Producer.java`

### Consumers

- `municipal-services/pgr-services/src/main/java/org/egov/pgr/consumer/MigrationConsumer.java`
- `municipal-services/pgr-services/src/main/java/org/egov/pgr/consumer/NotificationConsumer.java`
...
- `municipal-services/pgr-services/src/main/resources/application.properties`
- `municipal-services/pgr-services/src/main/resources/pgr-services-persister.yml`
...
- `municipal-services/pgr-services/src/main/resources/db/Dockerfile`
