...
> Generated from repository path `core-services/service-request`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Generic service request and service definition framework.

## Responsibilities

- Own the `service-request` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/service-request**
...
| digit | 1 source file(s) | Package area detected from source tree. |
| error | 1 source file(s) | Package area detected from source tree. |
...
- `core-services/service-request`: service root.
...
- `core-services/service-request/src/main/java/digit/ServiceRequestApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /service/v1/_create | ServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /service/v1/_search | ServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /service/v1/_update | ServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /service/definition/v1/_create | ServiceDefinitionController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /service/definition/v1/_search | ServiceDefinitionController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /service/definition/v1/_update | ServiceDefinitionController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as service_request
...
- **Tables detected from migrations:** eg_service, eg_service_attribute_definition, eg_service_attribute_value, eg_service_definition
- **Migration files:** 2
...
- `core-services/service-request/src/main/resources/db/migration`
- `core-services/service-request/src/main/resources/db/migration/main`

### Repository locations

- `core-services/service-request/src/main/java/digit/repository/ServiceDefinitionRequestRepository.java`
- `core-services/service-request/src/main/java/digit/repository/ServiceRequestRepository.java`
...
| core-services/service-request/src/main/resources/service-request-persister.yml topic | save-service-definition |
| core-services/service-request/src/main/resources/service-request-persister.yml topic | save-service |
| core-services/service-request/src/main/resources/service-request-persister.yml topic | update-service-definition |
| core-services/service-request/src/main/resources/service-request-persister.yml topic | save-service-definition |
| core-services/service-request/src/main/resources/service-request-persister.yml topic | save-service |
| core-services/service-request/src/main/resources/service-request-persister.yml topic | update-service-definition |
...
- `core-services/service-request/src/main/java/digit/kafka/Producer.java`

### Consumers

- `core-services/service-request/src/main/java/digit/kafka/Consumer.java`
...
- `core-services/service-request/src/main/resources/application.properties`
- `core-services/service-request/src/main/resources/service-request-persister.yml`
