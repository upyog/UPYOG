...
> Generated from repository path `frontend/workbench-ui`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `workbench-ui` business or platform capability within the UPYOG ecosystem.
...
- `frontend/workbench-ui`: service root.
