...
> Generated from repository path `edcr/service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `edcr-service` business or platform capability within the UPYOG ecosystem.
...
- Stack: **Legacy Java EE/WildFly or frontend client**
- Java version: **8 for legacy Java**
- Spring Boot version: **classic Spring/WildFly**
