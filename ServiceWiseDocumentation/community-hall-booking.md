...
> Generated from repository path `municipal-services/community-hall-booking`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Community hall booking workflow service.

## Responsibilities

- Own the `community-hall-booking` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/chb-services**
- Detected controllers/API mappings: **8**
- Detected migrations: **5**
...
| --- | --- | --- |
| billing | 7 source file(s) | Package area detected from source tree. |
| chb | 1 source file(s) | Package area detected from source tree. |
| clients | 2 source file(s) | Package area detected from source tree. |
...
| enums | 1 source file(s) | Package area detected from source tree. |
...
| impl | 2 source file(s) | Package area detected from source tree. |
...
- `municipal-services/community-hall-booking`: service root.
...
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/CommunityHallBookingApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| ANY | /booking | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_create | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_init | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_update | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_search | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_slot-search | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_estimate | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| ANY | /trigger-workflow-update | CommunityHallBookingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as community_hall_booking
...
- **Tables detected from migrations:** eg_chb_address_detail, eg_chb_applicant_detail, eg_chb_booking_detail, eg_chb_booking_detail_audit, eg_chb_booking_detail_init, eg_chb_document_detail, eg_chb_payment_timer, public.eg_chb_slot_detail, public.eg_chb_slot_detail_audit, shedlock
- **Migration files:** 5
...
- `municipal-services/community-hall-booking/src/main/resources/db/migration`
- `municipal-services/community-hall-booking/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/CommunityHallBookingApplication.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/CommunityHallBookingRepository.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/DemandRepository.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/IdGenRepository.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/RedisRepository.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/ServiceRequestRepository.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/repository/impl/CommunityHallBookingRepositoryImpl.java`
...
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | save-community-hall-booking-init |
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | save-community-hall-booking |
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | update-community-hall-booking |
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | save-community-hall-booking-init |
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | save-community-hall-booking |
| municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml topic | update-community-hall-booking |
...
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/kafka/producer/Producer.java`

### Consumers

- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/kafka/consumer/NotificationConsumer.java`
- `municipal-services/community-hall-booking/src/main/java/org/upyog/chb/kafka/consumer/PaymentUpdateConsumer.java`
...
| upyog.mdms.v2.host | http://mdms-v2.egov:8080/ |
...
- `municipal-services/community-hall-booking/src/main/resources/application.properties`
- `municipal-services/community-hall-booking/src/main/resources/community-hall-booking-service-persister.yml`
...
- `municipal-services/community-hall-booking/src/main/resources/db/Dockerfile`
