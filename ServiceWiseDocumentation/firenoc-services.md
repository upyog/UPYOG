...
> Generated from repository path `municipal-services/firenoc-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `firenoc-services` business or platform capability within the UPYOG ecosystem.
...
- No Java package tree detected.

## Folder Structure

- `municipal-services/firenoc-services`: service root.
...
- `municipal-services/firenoc-services/src/index.js`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as firenoc_services
...
- **Tables detected from migrations:** eg_fn_address, eg_fn_buidlings, eg_fn_buildingdocuments, eg_fn_buildinguoms, eg_fn_firenoc, eg_fn_firenocdetail, eg_fn_institution, eg_fn_owner
- **Migration files:** 9
...
- No explicit external host/URL properties detected.
...
- No explicit properties detected.
...
- `municipal-services/firenoc-services/migration/Dockerfile`
