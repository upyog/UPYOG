...
> Generated from repository path `core-services/egov-filestore`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

File upload, lookup, and object storage abstraction service.

## Responsibilities

- Own the `egov-filestore` business or platform capability within the UPYOG ecosystem.
...
| entity | 2 source file(s) | Database/table mapped domain state. |
| filestore | 1 source file(s) | Package area detected from source tree. |
| impl | 2 source file(s) | Package area detected from source tree. |
| minio | 3 source file(s) | Package area detected from source tree. |
...
- `core-services/egov-filestore`: service root.
...
- `core-services/egov-filestore/src/main/java/org/egov/filestore/FileStoreApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| GET | /v1/files/id | StorageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| GET | /v1/files/metadata | StorageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| GET | /v1/files/tag | StorageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/files | StorageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| GET | /v1/files/url | StorageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_filestore
...
- **Tables detected from migrations:** eg_filestoremap
- **Migration files:** 4
...
- `core-services/egov-filestore/src/main/resources/db/migration`
- `core-services/egov-filestore/src/main/resources/db/migration/ddl`
- `core-services/egov-filestore/src/main/resources/db/migration/qa`
- `core-services/egov-filestore/src/main/resources/db/migration/seed`

### Repository locations

- `core-services/egov-filestore/src/main/java/org/egov/filestore/persistence/repository/ArtifactRepository.java`
- `core-services/egov-filestore/src/main/java/org/egov/filestore/persistence/repository/FileStoreJpaRepository.java`
- `core-services/egov-filestore/src/main/java/org/egov/filestore/repository/impl/minio/MinioRepository.java`

### Entity mapping locations

- `core-services/egov-filestore/src/main/java/org/egov/filestore/persistence/entity/Artifact.java`
...
| allowed.formats.map | {jpg:{'image/jpg','image/jpeg'},jpeg:{'image/jpeg','image/jpg'},png:{'image/png'},pdf:{'application/pdf'},odt:{'appli... |
| management.endpoints.web.base-path | / |
