...
> Generated from repository path `core-services/egov-survey-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Survey definition and response service.

## Responsibilities

- Own the `egov-survey-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/egov-survey-services**
...
- `core-services/egov-survey-services`: service root.
...
- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/EgovSurveyServicesApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /egov-ss/survey/_create | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-ss/survey/_search | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-ss/survey/_update | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-ss/survey/_delete | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-ss/survey/response/_submit | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-ss/survey/response/_results | SurveyController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_survey_services
...
- **Tables detected from migrations:** eg_ss_answer, eg_ss_question, eg_ss_survey
- **Migration files:** 5
- **Repositories/JDBC classes:** 2
- **Entity/table-mapped classes:** 2

### Migration locations

- `core-services/egov-survey-services/src/main/resources/db/migration`
- `core-services/egov-survey-services/src/main/resources/db/migration/main`

### Repository locations

- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/repository/ServiceRequestRepository.java`
- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/repository/SurveyRepository.java`

### Entity mapping locations

- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/web/models/AnswerEntity.java`
- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/web/models/SurveyEntity.java`
...
- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/producer/Producer.java`

### Consumers

- `core-services/egov-survey-services/src/main/java/org/egov/egovsurveyservices/consumer/NotificationConsumer.java`
...
| ss.notification.ui.redirect.url | upyog-ui/citizen/engagement/surveys/fill-survey?applicationNumber={APPNUMBER}&tenantId={TENANTID} |
...
- `core-services/egov-survey-services/src/main/resources/application.properties`
