...
> Generated from repository path `municipal-services/pqm-scheduler`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `pqm-scheduler` business or platform capability within the UPYOG ecosystem.
...
- `municipal-services/pqm-scheduler`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as pqm_scheduler
