...
> Generated from repository path `municipal-services/asset-calculator`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Asset fee calculator service.

## Responsibilities

- Own the `asset-calculator` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8077**
- Servlet/context path: **/asset-calculator**
...
- `municipal-services/asset-calculator`: service root.
...
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/AssetCalculatorApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /v1/depreciation/_calculate | CalculatorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| GET | /v1/depreciation/{assetId}/details | CalculatorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as asset_calculator
...
- **Tables detected from migrations:** public.eg_asset_depreciation_details
- **Migration files:** 2
...
- `municipal-services/asset-calculator/src/main/resources/db/migration`
- `municipal-services/asset-calculator/src/main/resources/db/migration/main`
- `municipal-services/asset-calculator/src/main/resources/db/migration/main/db`
- `municipal-services/asset-calculator/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/AssetRepository.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/CustomDepreciationRepository.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/CustomDepreciationRepositoryImpl.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/DepreciationDetailRepository.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/MdmsDataRepository.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/repository/ServiceRequestRepository.java`

### Entity mapping locations

- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/AssetCalculatorApplication.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/web/models/DepreciationDetail.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/web/models/contract/Asset.java`
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/web/models/contract/MdmsData.java`
...
- `municipal-services/asset-calculator/src/main/java/org/egov/asset/calculator/kafka/broker/Producer.java`
...
- `municipal-services/asset-calculator/src/main/resources/application.properties`
...
- `municipal-services/asset-calculator/src/main/resources/db/Dockerfile`
