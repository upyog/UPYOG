...
> Generated from repository path `core-services/egov-document-uploader`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Document upload and document metadata service.

## Responsibilities

- Own the `egov-document-uploader` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/egov-document-uploader**
...
| egovdocumentuploader | 1 source file(s) | Package area detected from source tree. |
...
- `core-services/egov-document-uploader`: service root.
...
- `core-services/egov-document-uploader/src/main/java/org/egov/egovdocumentuploader/EgovDocumentUploaderApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /egov-du/document/_create | DocumentController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-du/document/_search | DocumentController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-du/document/_update | DocumentController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-du/document/_delete | DocumentController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /egov-du/document/_count | DocumentController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_document_uploader
...
- **Tables detected from migrations:** eg_du_document
- **Migration files:** 3
...
- `core-services/egov-document-uploader/src/main/resources/db/migration`
- `core-services/egov-document-uploader/src/main/resources/db/migration/main`

### Repository locations

- `core-services/egov-document-uploader/src/main/java/org/egov/egovdocumentuploader/repository/DocumentRepository.java`
- `core-services/egov-document-uploader/src/main/java/org/egov/egovdocumentuploader/repository/ServiceRequestRepository.java`
...
- `core-services/egov-document-uploader/src/main/java/org/egov/egovdocumentuploader/producer/Producer.java`

### Consumers

- `core-services/egov-document-uploader/src/main/java/org/egov/egovdocumentuploader/consumer/NotificationConsumer.java`
