...
> Generated from repository path `frontend/micro-ui`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `micro-ui` business or platform capability within the UPYOG ecosystem.
...
- `frontend/micro-ui`: service root.
