...
> Generated from repository path `core-services/egov-persister`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Kafka-to-PostgreSQL persistence engine driven by persister YAML definitions.

## Responsibilities

- Own the `egov-persister` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8082**
- Servlet/context path: **/common-persist**
- Detected controllers/API mappings: **0**
- Detected migrations: **0**
- Detected tests: **14** files
...
| contract | 7 source file(s) | Package area detected from source tree. |
...
| service | 1 source file(s) | Business orchestration and domain logic. |
| util | 1 source file(s) | Reusable helpers and cross-cutting functions. |

## Folder Structure

- `core-services/egov-persister`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_persister
...
| core-services/egov-persister/src/main/resources/egov-pg-service-persister.yml topic | save-pg-txns |
| core-services/egov-persister/src/main/resources/egov-pg-service-persister.yml topic | save-pg-txns-dump |
| core-services/egov-persister/src/main/resources/egov-pg-service-persister.yml topic | update-pg-txns |
| core-services/egov-persister/src/main/resources/egov-pg-service-persister.yml topic | update-pg-txns-dump |
| core-services/egov-persister/src/main/resources/egov-user-event-persister.yml topic | save-user-events |
| core-services/egov-persister/src/main/resources/egov-user-event-persister.yml topic | update-user-events |
| core-services/egov-persister/src/main/resources/egov-user-event-persister.yml topic | user-events-lat |
| core-services/egov-persister/src/main/resources/hrms-employee-persister.yml topic | save-hrms-employee |
| core-services/egov-persister/src/main/resources/hrms-employee-persister.yml topic | update-hrms-employee |
| core-services/egov-persister/src/main/resources/persister.yml topic | save-index-jobs |
| core-services/egov-persister/src/main/resources/persister.yml topic | update-index-jobs |
| core-services/egov-persister/src/main/resources/pt-calculator-v2-persister.yml topic | save-pt-billingslab |
| core-services/egov-persister/src/main/resources/pt-calculator-v2-persister.yml topic | update-pt-billingslab |
| core-services/egov-persister/src/main/resources/tl-billing-slab-persister.yml topic | save-tl-billingslab |
| core-services/egov-persister/src/main/resources/tl-billing-slab-persister.yml topic | update-tl-billingslab |
| core-services/egov-persister/src/main/resources/application.yml topic | egov.persist |
| core-services/egov-persister/src/main/resources/application.yml topic | save-service-db |
| core-services/egov-persister/src/main/resources/application.yml topic | update-service-db |
| core-services/egov-persister/src/main/resources/application.yml topic | egov.marriageregn.create |
| core-services/egov-persister/src/main/resources/application.yml topic | egov.marriageregn.update |
| core-services/egov-persister/src/main/resources/application.yml topic | egov.regnunit.create |
| core-services/egov-persister/src/main/resources/application.yml topic | egov.regnunit.update |
| core-services/egov-persister/src/main/resources/application.yml topic | mr.marriagedocumenttype.create |
| core-services/egov-persister/src/main/resources/application.yml topic | mr.marriagedocumenttype.update |
...
- `core-services/egov-persister/src/main/resources/application.yml`
...
- `core-services/egov-persister/src/main/resources/pt-calculator-v2-persister.yml`
- `core-services/egov-persister/src/main/resources/tl-billing-slab-persister.yml`
- `core-services/egov-persister/src/main/resources/lcms-indexer.yml`
