...
> Generated from repository path `business-services/employee-dashboard`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `employee-dashboard` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/employee-dashboard**
...
| constant | 2 source file(s) | Package area detected from source tree. |
| controller | 1 source file(s) | HTTP endpoints and request/response orchestration. |
| dasboard | 1 source file(s) | Package area detected from source tree. |
...
- `business-services/employee-dashboard`: service root.
...
- `business-services/employee-dashboard/src/main/java/org/upyog/employee/dasboard/Main.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /_search | EmployeeDashaboardApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as employee_dashboard
...
- `business-services/employee-dashboard/src/main/resources/db/migration`
- `business-services/employee-dashboard/src/main/resources/db/migration/main`

### Repository locations

- `business-services/employee-dashboard/src/main/java/org/upyog/employee/dasboard/repository/ServiceRequestRepository.java`
- `business-services/employee-dashboard/src/main/java/org/upyog/employee/dasboard/repository/impl/ServiceRequestRepositoryImpl.java`
...
- `business-services/employee-dashboard/src/main/java/org/upyog/employee/dasboard/kafka/Producer.java`

### Consumers

- `business-services/employee-dashboard/src/main/java/org/upyog/employee/dasboard/kafka/Consumer.java`
...
- `business-services/employee-dashboard/src/main/resources/application.properties`
...
| server.servlet.context-path | /employee-dashboard |
| server.port | 8080 |
| app.timezone | UTC |
