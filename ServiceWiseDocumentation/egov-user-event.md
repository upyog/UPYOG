...
> Generated from repository path `municipal-services/egov-user-event`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

User event and notification feed service.

## Responsibilities

- Own the `egov-user-event` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8088**
- Servlet/context path: **/egov-user-event**
- Detected controllers/API mappings: **5**
- Detected migrations: **6**
- Detected tests: **47** files
...
| contract | 9 source file(s) | Package area detected from source tree. |
...
- `municipal-services/egov-user-event`: service root.
...
- `municipal-services/egov-user-event/src/main/java/org/egov/UserEventsApp.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /v1/events/_create | UserEventsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/events/_update | UserEventsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/events/_search | UserEventsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/events/notifications/_count | UserEventsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/events/lat/_update | UserEventsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_user_event
...
- **Tables detected from migrations:** eg_men_events, eg_men_recepnt_event_registry, eg_men_user_llt
- **Migration files:** 6
...
- `municipal-services/egov-user-event/src/main/resources/db/migration`
- `municipal-services/egov-user-event/src/main/resources/db/migration/main`
- `municipal-services/egov-user-event/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/egov-user-event/src/main/java/org/egov/userevent/repository/RestCallRepository.java`
- `municipal-services/egov-user-event/src/main/java/org/egov/userevent/repository/UserEventRepository.java`
...
- `municipal-services/egov-user-event/src/main/java/org/egov/userevent/producer/UserEventsProducer.java`

### Consumers

- `municipal-services/egov-user-event/src/main/java/org/egov/userevent/consumer/UserEventsConsumer.java`
...
- `municipal-services/egov-user-event/src/main/resources/application.properties`
...
- `municipal-services/egov-user-event/src/main/resources/db/Dockerfile`
- `municipal-services/egov-user-event/src/test/resources/db/Dockerfile`
