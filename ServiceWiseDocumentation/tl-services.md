...
> Generated from repository path `municipal-services/tl-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Trade license lifecycle and workflow service.

## Responsibilities

- Own the `tl-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8079**
- Servlet/context path: **/tl-services**
- Detected controllers/API mappings: **7**
- Detected migrations: **16**
...
| model | 33 source file(s) | Request, response, DTO, and domain models. |
| notification | 3 source file(s) | Package area detected from source tree. |
| producer | 1 source file(s) | Kafka/event producers. |
| property | 2 source file(s) | Package area detected from source tree. |
...
| tl | 1 source file(s) | Package area detected from source tree. |
...
- `municipal-services/tl-services`: service root.
...
- `municipal-services/tl-services/src/main/java/org/egov/tl/Main.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /v1/{servicename}/_create | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/_search | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/_update | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/{jobname}/_batch | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_plainsearch | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_test | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_test1 | TradeLicenseController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_tl_Accessory, eg_tl_ApplicationDocument, eg_tl_TradeLicense, eg_tl_TradeLicenseDetail, eg_tl_TradeLicenseDetail_audit, eg_tl_TradeLicense_audit, eg_tl_TradeUnit, eg_tl_VerificationDocument, eg_tl_address, eg_tl_document_owner, eg_tl_institution, eg_tl_owner
- **Migration files:** 16
...
- `municipal-services/tl-services/src/main/resources/db/migration`
- `municipal-services/tl-services/src/main/resources/db/migration/main`
- `municipal-services/tl-services/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/tl-services/src/main/java/org/egov/tl/repository/IdGenRepository.java`
- `municipal-services/tl-services/src/main/java/org/egov/tl/repository/ServiceRequestRepository.java`
- `municipal-services/tl-services/src/main/java/org/egov/tl/repository/TLRepository.java`
...
| municipal-services/tl-services/src/main/resources/tradelicense.yml topic | save-tl-tradelicense |
| municipal-services/tl-services/src/main/resources/tradelicense.yml topic | update-tl-tradelicense |
| municipal-services/tl-services/src/main/resources/tradelicense.yml topic | update-tl-workflow |
| municipal-services/tl-services/src/main/resources/tradelicense.yml topic | update-tl-adhoc-tradelicense |

### Producers

- `municipal-services/tl-services/src/main/java/org/egov/tl/producer/Producer.java`

### Consumers

- `municipal-services/tl-services/src/main/java/org/egov/tl/consumer/ReceiptConsumer.java`
- `municipal-services/tl-services/src/main/java/org/egov/tl/consumer/TradeLicenseConsumer.java`
...
- `municipal-services/tl-services/src/main/resources/application.properties`
...
| kafka.producer.config.linger_ms_config | 1 |
| kafka.producer.config.buffer_memory_config | 33554432 |
| persister.save.tradelicense.topic | <secret-value> |
| persister.update.tradelicense.topic | <secret-value> |
| persister.update.tradelicense.workflow.topic | <secret-value> |
...
- `municipal-services/tl-services/src/main/resources/db/Dockerfile`
