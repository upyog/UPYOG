...
> Generated from repository path `utilities/egov-pdf`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `egov-pdf` business or platform capability within the UPYOG ecosystem.
...
- `utilities/egov-pdf`: service root.
...
- `utilities/egov-pdf/src/app.js`
- `utilities/egov-pdf/src/index.js`
