...
> Generated from repository path `municipal-services/ewaste-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

E-waste collection request service.

## Responsibilities

- Own the `ewaste-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/ewaste-services**
...
| contracts | 8 source file(s) | Package area detected from source tree. |
...
| ewst | 1 source file(s) | Package area detected from source tree. |
...
- `municipal-services/ewaste-services`: service root.
...
- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/EwasteMainApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| ANY | /ewaste-request | EwasteController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /_create | EwasteController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /_search | EwasteController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /_update | EwasteController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as ewaste_services
...
- **Tables detected from migrations:** eg_ew_address, eg_ew_applicantdetails, eg_ew_ewastedetails, eg_ew_ewastedocuments, eg_ew_requests
- **Migration files:** 2
...
- `municipal-services/ewaste-services/src/main/resources/db/migration`
- `municipal-services/ewaste-services/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/repository/EwasteApplicationRepository.java`
- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/repository/IdGenRepository.java`
- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/repository/ServiceRequestRepository.java`
...
- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/producer/Producer.java`
- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/producer/SenderConfig.java`

### Consumers

- `municipal-services/ewaste-services/src/main/java/org/egov/ewst/consumer/EwasteNotificationConsumer.java`
...
- `municipal-services/ewaste-services/src/main/resources/application.properties`
...
- `municipal-services/ewaste-services/src/main/resources/db/Dockerfile`
