...
> Generated from repository path `business-services/verification-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Document/application verification service.

## Responsibilities

- Own the `verification-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/verification-service**
...
| mapper | 15 source file(s) | DTO/entity conversion. |
...
| upyog | 1 source file(s) | Package area detected from source tree. |
...
- `business-services/verification-service`: service root.
...
- `business-services/verification-service/src/main/java/org/upyog/Main.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /validity/_search | VerificationServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- `business-services/verification-service/src/main/resources/db/migration`
- `business-services/verification-service/src/main/resources/db/migration/main`

### Repository locations

- `business-services/verification-service/src/main/java/org/upyog/repository/ServiceRequestRepository.java`
...
| module.host.advertisement | http://localhost:8081/ |
| module.host.property | http://localhost:8082/ |
| module.host.tradelicense | http://localhost:8083/ |
| module.host.streetvending | http://localhost:8081/ |
| module.host.pet | http://localhost:8082/ |
| module.host.ewaste | http://localhost:8083/ |
| module.host.communityhall | http://localhost:8081/ |
| module.host.firenoc | http://localhost:8082/ |
| module.host.bpa | http://localhost:8082/ |
| module.host.sewerage | http://localhost:8082/ |
| module.host.wt | http://localhost:8082 |
| module.host.mt | http://localhost:8082 |
| module.host.cnd | http://localhost:8082 |
| module.host.tp | http://localhost:8082 |
| module.endpoint.advertisement | adv-services/booking/v1/_search |
| module.endpoint.property | property-services/property/_search |
| module.endpoint.tradelicense | tl-services/v1/_search |
| module.endpoint.streetvending | sv-services/street-vending/_search |
| module.endpoint.pet | pet-services/pet-registration/_search |
| module.endpoint.ewaste | ewaste-services/ewaste-request/_search |
| module.endpoint.communityhall | chb-services/booking/v1/_search |
| module.endpoint.firenoc | firenoc-services/v1/_search |
| module.endpoint.bpa | bpa-services/v1/bpa/_search |
| module.endpoint.sewerage | sw-services/swc/_search |
| module.endpoint.wt | /request-service/water-tanker/v1/_search |
| module.endpoint.mt | /request-service/mobile-toilet/v1/_search |
| module.endpoint.tp | /tp-services/tree-pruning/v1/_search |
...
- `business-services/verification-service/src/main/resources/application.properties`

### Key properties

| Property | Value / meaning |
| --- | --- |
| server.contextPath | /verification-service |
| server.servlet.context-path | /verification-service |
| server.port | 8080 |
| app.timezone | UTC |
...
| module.host.advertisement | http://localhost:8081/ |
| module.host.property | http://localhost:8082/ |
| module.host.tradelicense | <secret-value> |
| module.host.streetvending | http://localhost:8081/ |
| module.host.pet | http://localhost:8082/ |
| module.host.ewaste | http://localhost:8083/ |
| module.host.communityhall | http://localhost:8081/ |
...
| module.endpoint.advertisement | adv-services/booking/v1/_search |
| module.endpoint.property | property-services/property/_search |
| module.endpoint.tradelicense | <secret-value> |
