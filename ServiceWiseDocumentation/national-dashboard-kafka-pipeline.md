...
> Generated from repository path `core-services/national-dashboard-kafka-pipeline`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Kafka pipeline for national dashboard record transformation and persistence.

## Responsibilities

- Own the `national-dashboard-kafka-pipeline` business or platform capability within the UPYOG ecosystem.
...
| model | 1 source file(s) | Request, response, DTO, and domain models. |
| producer | 1 source file(s) | Kafka/event producers. |

## Folder Structure

- `core-services/national-dashboard-kafka-pipeline`: service root.
...
- `core-services/national-dashboard-kafka-pipeline/src/main/java/org/egov/nationaldashboardkafkapipeline/NationalDashboardKafkaPipelineApplication.java`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as national_dashboard_kafka_pipeline
...
- `core-services/national-dashboard-kafka-pipeline/src/main/java/org/egov/nationaldashboardkafkapipeline/models/ProducerPOJO.java`
- `core-services/national-dashboard-kafka-pipeline/src/main/java/org/egov/nationaldashboardkafkapipeline/producer/Producer.java`

### Consumers

- `core-services/national-dashboard-kafka-pipeline/src/main/java/org/egov/nationaldashboardkafkapipeline/consumers/NationalDashboardPipelineListener.java`
...
- `core-services/national-dashboard-kafka-pipeline/src/main/resources/application.properties`
...
| kafka.producer.config.buffer_memory_config | 33554432 |
| kafka.topics.national.events | persist-national-records |
| module.index.mapping | {"PT": "pt-national-dashboard-temp", "PGR": "pgr-national-dashboard", "WS": "ws-national-dashboard", "FIRENOC": "fire... |
