...
> Generated from repository path `frontend/mono-ui`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `mono-ui` business or platform capability within the UPYOG ecosystem.
