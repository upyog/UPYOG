...
> Generated from repository path `core-services/pdf-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `pdf-service` business or platform capability within the UPYOG ecosystem.
...
- `core-services/pdf-service`: service root.
...
- `core-services/pdf-service/src/index.js`
...
- **Tables detected from migrations:** egov_bulk_pdf_info, egov_defaulter_notice_pdf_info, egov_pdf_gen
- **Migration files:** 8
