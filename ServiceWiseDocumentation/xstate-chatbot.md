...
> Generated from repository path `core-services/xstate-chatbot`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `xstate-chatbot` business or platform capability within the UPYOG ecosystem.
...
- `core-services/xstate-chatbot`: service root.
...
- `core-services/xstate-chatbot/nodejs/src/app.js`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as xstate_chatbot
