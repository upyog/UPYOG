...
> Generated from repository path `municipal-services/bpa-calculator`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Building plan approval fee calculator.

## Responsibilities

- Own the `bpa-calculator` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8092**
- Servlet/context path: **/bpa-calculator**
...
| --- | --- | --- |
| bpa | 3 source file(s) | Package area detected from source tree. |
...
| landinfo | 12 source file(s) | Package area detected from source tree. |
...
- `municipal-services/bpa-calculator`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as bpa_calculator
...
- `municipal-services/bpa-calculator/src/main/java/org/egov/bpa/calculator/repository/DemandRepository.java`
- `municipal-services/bpa-calculator/src/main/java/org/egov/bpa/calculator/repository/PreapprovedPlanRepository.java`
- `municipal-services/bpa-calculator/src/main/java/org/egov/bpa/calculator/repository/ServiceRequestRepository.java`
...
- `municipal-services/bpa-calculator/src/main/java/org/egov/bpa/calculator/kafka/broker/BPACalculatorProducer.java`
...
- `municipal-services/bpa-calculator/src/main/resources/application.properties`
