...
> Generated from repository path `municipal-services/pqm-anomaly-finder`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

PQM anomaly detection service.

## Responsibilities

- Own the `pqm-anomaly-finder` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **7009**
- Servlet/context path: **/pqm-anomaly-finder**
...
| finder | 1 source file(s) | Package area detected from source tree. |
| mapper | 1 source file(s) | DTO/entity conversion. |
| model | 23 source file(s) | Request, response, DTO, and domain models. |
| notification | 9 source file(s) | Package area detected from source tree. |
...
- `municipal-services/pqm-anomaly-finder`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as pqm_anomaly_finder
...
- **Tables detected from migrations:** eg_pqm_anomaly_details, eg_pqm_anomaly_details_auditlog
- **Migration files:** 2
...
- `municipal-services/pqm-anomaly-finder/src/main/resources/db/migration`
- `municipal-services/pqm-anomaly-finder/src/main/resources/db/migration/main`
- `municipal-services/pqm-anomaly-finder/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/pqm-anomaly-finder/src/main/java/org/egov/pqm/anomaly/finder/repository/AnomalyRepository.java`
- `municipal-services/pqm-anomaly-finder/src/main/java/org/egov/pqm/anomaly/finder/repository/ServiceRequestRepository.java`
...
- `municipal-services/pqm-anomaly-finder/src/main/java/org/egov/pqm/anomaly/finder/producer/PqmAnomalyFinderProducer.java`

### Consumers

- `municipal-services/pqm-anomaly-finder/src/main/java/org/egov/pqm/anomaly/finder/consumer/PqmAnomalyFinderConsumer.java`
...
- `municipal-services/pqm-anomaly-finder/src/main/resources/application.properties`
...
- `municipal-services/pqm-anomaly-finder/src/main/resources/db/Dockerfile`
