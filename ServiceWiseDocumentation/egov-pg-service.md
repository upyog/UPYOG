...
> Generated from repository path `core-services/egov-pg-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Payment gateway transaction service and redirect/callback processor.

## Responsibilities

- Own the `egov-pg-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **9000**
- Servlet/context path: **/pg-service**
- Detected controllers/API mappings: **5**
- Detected migrations: **3**
- Detected tests: **7** files

## Packages

| Package area | Files | Role |
| --- | --- | --- |
| axis | 2 source file(s) | Package area detected from source tree. |
...
| dailyreconciliation | 2 source file(s) | Package area detected from source tree. |
| earlyreconciliation | 2 source file(s) | Package area detected from source tree. |
...
| nttdata | 24 source file(s) | Package area detected from source tree. |
| paygov | 3 source file(s) | Package area detected from source tree. |
| paytm | 2 source file(s) | Package area detected from source tree. |
| payu | 2 source file(s) | Package area detected from source tree. |
| pg | 1 source file(s) | Package area detected from source tree. |
| phonepe | 3 source file(s) | Package area detected from source tree. |
| producer | 1 source file(s) | Kafka/event producers. |
| repository | 8 source file(s) | Database or remote-service data access. |
| scheduler | 2 source file(s) | Scheduled jobs and periodic tasks. |
...
- `core-services/egov-pg-service`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_pg_service
...
- **Tables detected from migrations:** eg_pg_qrtz_blob_triggers, eg_pg_qrtz_calendars, eg_pg_qrtz_cron_triggers, eg_pg_qrtz_fired_triggers, eg_pg_qrtz_job_details, eg_pg_qrtz_locks, eg_pg_qrtz_paused_trigger_grps, eg_pg_qrtz_scheduler_state, eg_pg_qrtz_simple_triggers, eg_pg_qrtz_simprop_triggers, eg_pg_qrtz_triggers, eg_pg_transactions, eg_pg_transactions_dump
- **Migration files:** 3
...
- `core-services/egov-pg-service/src/main/resources/db/migration`
- `core-services/egov-pg-service/src/main/resources/db/migration/dev`
- `core-services/egov-pg-service/src/main/resources/db/migration/main`
- `core-services/egov-pg-service/src/main/resources/db/migration/seed`

### Repository locations

- `core-services/egov-pg-service/src/main/java/org/egov/pg/config/MainConfig.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/BankAccountRepository.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/CollectionsRepository.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/IdGenRepository.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/PgDetailRepository.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/ServiceCallRepository.java`
- `core-services/egov-pg-service/src/main/java/org/egov/pg/repository/TransactionRepository.java`
...
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | save-pg-txns |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | save-pg-txns-dump |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | update-pg-txns |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | update-pg-txns-dump |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | save-pg-txns |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | save-pg-txns-dump |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | update-pg-txns |
| core-services/egov-pg-service/src/main/resources/pg-service-persister.yml topic | update-pg-txns-dump |
...
- `core-services/egov-pg-service/src/main/java/org/egov/pg/producer/Producer.java`

### Consumers

- `core-services/egov-pg-service/src/main/java/org/egov/pg/consumer/NotificationConsumer.java`
...
- `core-services/egov-pg-service/src/main/resources/pg-service-persister.yml`
