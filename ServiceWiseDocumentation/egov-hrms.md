...
> Generated from repository path `business-services/egov-hrms`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `egov-hrms` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **9999**
- Servlet/context path: **/egov-hrms**
...
| hrms | 1 source file(s) | Package area detected from source tree. |
...
- `business-services/egov-hrms`: service root.
...
- `business-services/egov-hrms/src/main/java/org/egov/hrms/EgovEmployeeApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /employees/_create | EmployeeController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /employees/_update | EmployeeController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /employees/_search | EmployeeController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /employees/_count | EmployeeController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_hrms_assignment, eg_hrms_deactivationdetails, eg_hrms_departmentaltests, eg_hrms_educationaldetails, eg_hrms_empdocuments, eg_hrms_employee, eg_hrms_jurisdiction, eg_hrms_reactivationdetails, eg_hrms_servicehistory
- **Migration files:** 11
...
- `business-services/egov-hrms/src/main/resources/db/migration`
- `business-services/egov-hrms/src/main/resources/db/migration/main`
- `business-services/egov-hrms/src/main/resources/db/migration/seed`

### Repository locations

- `business-services/egov-hrms/src/main/java/org/egov/hrms/repository/EmployeeRepository.java`
- `business-services/egov-hrms/src/main/java/org/egov/hrms/repository/RestCallRepository.java`
...
| business-services/egov-hrms/src/main/resources/config/hrm-employee-update-persister.yml topic | update-hrms-employee |
| business-services/egov-hrms/src/main/resources/config/hrms-employee-persister.yml topic | save-hrms-employee |
| business-services/egov-hrms/src/main/resources/config/hrms-employee-persister.yml topic | update-hrms-employee |

### Producers

- `business-services/egov-hrms/src/main/java/org/egov/hrms/producer/HRMSProducer.java`
- `business-services/egov-hrms/src/main/java/org/egov/hrms/service/EmployeeService.java`

### Consumers

- `business-services/egov-hrms/src/main/java/org/egov/hrms/consumer/HrmsConsumer.java`
...
- `business-services/egov-hrms/src/main/resources/application.properties`
