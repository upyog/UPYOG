...
> Generated from repository path `municipal-services/firenoc-calculator`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `firenoc-calculator` business or platform capability within the UPYOG ecosystem.
...
- `municipal-services/firenoc-calculator`: service root.
...
- `municipal-services/firenoc-calculator/src/index.js`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as firenoc_calculator
...
- **Tables detected from migrations:** eg_firenoc_billingslab
- **Migration files:** 3
...
- `municipal-services/firenoc-calculator/migration/Dockerfile`
