...
> Generated from repository path `municipal-services/cnd-calculator`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

CND waste fee calculator.

## Responsibilities

- Own the `cnd-calculator` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8181**
- Servlet/context path: **/cnd-calculator**
...
- `municipal-services/cnd-calculator`: service root.
...
- `municipal-services/cnd-calculator/src/main/java/org/upyog/cdwm/calculator/CNDCalculator.java`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as cnd_calculator
...
- `municipal-services/cnd-calculator/src/main/java/org/upyog/cdwm/calculator/repository/DemandRepository.java`
- `municipal-services/cnd-calculator/src/main/java/org/upyog/cdwm/calculator/repository/ServiceRequestRepository.java`
...
- `municipal-services/cnd-calculator/src/main/java/org/upyog/cdwm/calculator/kafka/producer/CalculatorProducer.java`

### Consumers

- `municipal-services/cnd-calculator/src/main/java/org/upyog/cdwm/calculator/kafka/Consumer.java`
...
- `municipal-services/cnd-calculator/src/main/resources/application.properties`
