...
> Generated from repository path `municipal-services/fsm`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Faecal sludge management application and trip service.

## Responsibilities

- Own the `fsm` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **9098**
- Servlet/context path: **/fsm**
- Detected controllers/API mappings: **12**
...
| --- | --- | --- |
| calculator | 2 source file(s) | Package area detected from source tree. |
...
| dso | 5 source file(s) | Package area detected from source tree. |
...
| mdms | 3 source file(s) | Package area detected from source tree. |
| model | 26 source file(s) | Request, response, DTO, and domain models. |
...
| trip | 5 source file(s) | Package area detected from source tree. |
...
- `municipal-services/fsm`: service root.
...
- `municipal-services/fsm/src/main/java/org/egov/FSMApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /plantmap/v1/_create | PlantMappingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /plantmap/v1/_update | PlantMappingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /plantmap/v1/_search | PlantMappingController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_create | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_update | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_search | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_audit | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_plainsearch | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_getapplicationsforperiodic | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_schedular | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_createperiodicapplications | FSMController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/fetchApplicationIds | FSMInboxController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_fsm_address, eg_fsm_address_auditlog, eg_fsm_application, eg_fsm_application_auditlog, eg_fsm_geolocation, eg_fsm_geolocation_auditlog, eg_fsm_pit_detail, eg_fsm_pit_detail_auditlog, eg_fsm_plantmapping
- **Migration files:** 22
...
- `municipal-services/fsm/src/main/resources/db/migration`
- `municipal-services/fsm/src/main/resources/db/migration/main`
- `municipal-services/fsm/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/fsm/src/main/java/org/egov/fsm/repository/FSMInboxRepository.java`
- `municipal-services/fsm/src/main/java/org/egov/fsm/repository/FSMRepository.java`
- `municipal-services/fsm/src/main/java/org/egov/fsm/repository/IdGenRepository.java`
- `municipal-services/fsm/src/main/java/org/egov/fsm/repository/ServiceRequestRepository.java`
- `municipal-services/fsm/src/main/java/org/egov/fsm/plantmapping/repository/PlantMappingRepository.java`
...
- `municipal-services/fsm/src/main/java/org/egov/fsm/fsmProducer/FSMProducer.java`

### Consumers

- `municipal-services/fsm/src/main/java/org/egov/fsm/consumer/FSMConsumer.java`
- `municipal-services/fsm/src/main/java/org/egov/fsm/consumer/ReceiptConsumer.java`
...
- `municipal-services/fsm/src/main/resources/application.properties`
...
- `municipal-services/fsm/bin/src/main/resources/db/Dockerfile`
- `municipal-services/fsm/src/main/resources/db/Dockerfile`
