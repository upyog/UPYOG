...
> Generated from repository path `utilities/egov-custom-consumer`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Custom Kafka consumer utility.

## Responsibilities

- Own the `egov-custom-consumer` business or platform capability within the UPYOG ecosystem.
...
- Servlet/context path: **/egov-custom-consumer**
...
| --- | --- | --- |
| cosumer | 1 source file(s) | Package area detected from source tree. |
...
- `utilities/egov-custom-consumer`: service root.
...
- `utilities/egov-custom-consumer/src/main/java/org/egov/CustomConsumerApplication.java`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_custom_consumer
...
- `utilities/egov-custom-consumer/src/main/java/org/egov/CustomConsumerApplication.java`
- `utilities/egov-custom-consumer/src/main/java/org/egov/cosumer/CustomConsumer.java`
...
| egov.coexistence.singout.uri | <secret-value> |
...
- `utilities/egov-custom-consumer/src/main/resources/application.properties`
...
- `utilities/egov-custom-consumer/Dockerfile`
