...
> Generated from repository path `municipal-services/noc-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

No-objection certificate application service.

## Responsibilities

- Own the `noc-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8099**
- Servlet/context path: **/noc-services**
...
| --- | --- | --- |
| bpa | 17 source file(s) | Package area detected from source tree. |
...
| noc | 1 source file(s) | Package area detected from source tree. |
...
- `municipal-services/noc-services`: service root.
...
- `municipal-services/noc-services/src/main/java/org/egov/noc/NOCApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /v1/noc/_create | NOCController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/noc/_update | NOCController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/noc/_search | NOCController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** public.eg_noc, public.eg_noc_auditdetails, public.eg_noc_document
- **Migration files:** 1
...
- `municipal-services/noc-services/src/main/resources/db/migration`
- `municipal-services/noc-services/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/noc-services/src/main/java/org/egov/noc/repository/IdGenRepository.java`
- `municipal-services/noc-services/src/main/java/org/egov/noc/repository/NOCRepository.java`
- `municipal-services/noc-services/src/main/java/org/egov/noc/repository/ServiceRequestRepository.java`
...
- `municipal-services/noc-services/src/main/java/org/egov/noc/producer/Producer.java`

### Consumers

- `municipal-services/noc-services/src/main/java/org/egov/noc/consumer/NOCConsumer.java`
...
- `municipal-services/noc-services/src/main/resources/application.properties`
...
| server.servlet.context-path | /noc-services |
| app.timezone | UTC |
...
- `municipal-services/noc-services/bin/src/main/resources/db/Dockerfile`
- `municipal-services/noc-services/src/main/resources/db/Dockerfile`
