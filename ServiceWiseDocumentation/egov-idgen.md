...
> Generated from repository path `core-services/egov-idgen`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

ID and sequence generation service.

## Responsibilities

- Own the `egov-idgen` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8088**
- Servlet/context path: **/egov-idgen**
- Detected controllers/API mappings: **1**
- Detected migrations: **60**
...
| --- | --- | --- |
| api | 1 source file(s) | Package area detected from source tree. |
...
- `core-services/egov-idgen`: service root.
...
- `core-services/egov-idgen/src/main/java/org/egov/PtIdGenerationApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /id/_generate | IdGenerationController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** id_generator
- **Migration files:** 60
...
- `core-services/egov-idgen/src/main/resources/db/migration`
- `core-services/egov-idgen/src/main/resources/db/migration/dev`
- `core-services/egov-idgen/src/main/resources/db/migration/main`
- `core-services/egov-idgen/src/main/resources/db/migration/seed`

### Repository locations

- `core-services/egov-idgen/src/main/java/org/egov/id/service/IdGenerationService.java`
