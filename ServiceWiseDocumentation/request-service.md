...
> Generated from repository path `municipal-services/request-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

UPYOG generic request service.

## Responsibilities

- Own the `request-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/request-service**
- Detected controllers/API mappings: **6**
...
| --- | --- | --- |
| billing | 10 source file(s) | Package area detected from source tree. |
...
| mobiletoilet | 5 source file(s) | Package area detected from source tree. |
...
| rs | 1 source file(s) | Package area detected from source tree. |
...
| watertanker | 5 source file(s) | Package area detected from source tree. |
| workflow | 8 source file(s) | Workflow transition/search integration and state handling. |

## Folder Structure

- `municipal-services/request-service`: service root.
...
- `municipal-services/request-service/src/main/java/org/upyog/rs/RequestServiceMain.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /water-tanker/v1/_create | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /water-tanker/v1/_search | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /water-tanker/v1/_update | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /mobile-toilet/v1/_create | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /mobile-toilet/v1/_search | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /mobile-toilet/v1/_update | RequestServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as request_service
...
- **Tables detected from migrations:** upyog_rs_mobile_toilet_address_details, upyog_rs_mobile_toilet_applicant_details, upyog_rs_mobile_toilet_booking_details, upyog_rs_mobile_toilet_booking_details_auditdetails, upyog_rs_water_tanker_address_details, upyog_rs_water_tanker_applicant_details, upyog_rs_water_tanker_booking_details, upyog_rs_water_tanker_booking_details_auditdetails
- **Migration files:** 2
...
- `municipal-services/request-service/src/main/resources/db/migration`
- `municipal-services/request-service/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/request-service/src/main/java/org/upyog/rs/repository/DemandRepository.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/repository/IdGenRepository.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/repository/RequestServiceRepository.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/repository/ServiceRequestRepository.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/repository/impl/RequestServieRepositoryImpl.java`
...
| persister.create.water-tanker.topic | create-water-tanker-booking |
| persister.create.water-tanker.with.profile.topic | create-water-tanker-booking-with-profile |
| persister.create.mobile-toilet.topic | create-mobile-toilet-booking |
| persister.create.mobile-toilet.with.profile.topic | create-mobile-toilet-booking-with-profile |
| persister.update.water-tanker.topic | update-water-tanker-booking |
| persister.update.mobile-toilet.topic | update-mobile-toilet-booking |
...
- `municipal-services/request-service/src/main/java/org/upyog/rs/kafka/Producer.java`

### Consumers

- `municipal-services/request-service/src/main/java/org/upyog/rs/kafka/Consumer.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/kafka/consumer/NotificationConsumer.java`
- `municipal-services/request-service/src/main/java/org/upyog/rs/kafka/consumer/PaymentUpdateConsumer.java`
...
- `municipal-services/request-service/src/main/resources/application.properties`
...
- `municipal-services/request-service/src/main/resources/db/Dockerfile`
