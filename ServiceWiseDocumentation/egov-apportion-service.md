...
> Generated from repository path `business-services/egov-apportion-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Payment apportioning service.

## Responsibilities

- Own the `egov-apportion-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/apportion-service**
...
| --- | --- | --- |
| apportions | 2 source file(s) | Package area detected from source tree. |
...
- `business-services/egov-apportion-service`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_apportion_service
...
- **Tables detected from migrations:** eg_appr_bills_request, eg_appr_bills_response, eg_appr_demand_request, eg_appr_demand_response
- **Migration files:** 3
...
- `business-services/egov-apportion-service/src/main/resources/db/migration`
- `business-services/egov-apportion-service/src/main/resources/db/migration/main`

### Repository locations

- `business-services/egov-apportion-service/src/main/java/org/egov/repository/ServiceRequestRepository.java`
...
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-request |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-response |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-bill-request |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-bill-response |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-demand-request |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-demand-response |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-request |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-response |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-bill-request |
| business-services/egov-apportion-service/src/main/resources/apportion-persister.yml topic | save-apportion-bill-response |
...
- `business-services/egov-apportion-service/src/main/java/org/egov/producer/Producer.java`
...
- `business-services/egov-apportion-service/src/main/resources/application.properties`
- `business-services/egov-apportion-service/src/main/resources/apportion-persister.yml`
