...
> Generated from repository path `core-services/user-otp`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

User OTP orchestration and notification service.

## Responsibilities

- Own the `user-otp` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8090**
- Servlet/context path: **/user-otp**
- Detected controllers/API mappings: **1**
- Detected migrations: **0**
- Detected tests: **29** files

## Packages

| Package area | Files | Role |
| --- | --- | --- |
| contract | 17 source file(s) | Package area detected from source tree. |
...
| error | 6 source file(s) | Package area detected from source tree. |
...
- `core-services/user-otp`: service root.
...
- `core-services/user-otp/src/main/java/org/egov/persistence/repository/OtpEmailRepository.java`
- `core-services/user-otp/src/main/java/org/egov/persistence/repository/OtpRepository.java`
- `core-services/user-otp/src/main/java/org/egov/persistence/repository/OtpSMSRepository.java`
- `core-services/user-otp/src/main/java/org/egov/persistence/repository/RestCallRepository.java`
- `core-services/user-otp/src/main/java/org/egov/persistence/repository/UserRepository.java`
...
- `core-services/user-otp/src/main/resources/application.properties`
