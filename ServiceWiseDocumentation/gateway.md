...
> Generated from repository path `core-services/gateway`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Spring Cloud Gateway based reactive API gateway for routing, authentication, RBAC, rate limiting, and observability.

## Responsibilities

- Own the `gateway` business or platform capability within the UPYOG ecosystem.
...
| gateway | 1 source file(s) | Package area detected from source tree. |
| helpers | 9 source file(s) | Package area detected from source tree. |
| model | 10 source file(s) | Request, response, DTO, and domain models. |
| post | 4 source file(s) | Package area detected from source tree. |
| pre | 8 source file(s) | Package area detected from source tree. |
| producer | 1 source file(s) | Kafka/event producers. |
| ratelimiters | 1 source file(s) | Package area detected from source tree. |
| util | 5 source file(s) | Reusable helpers and cross-cutting functions. |

## Folder Structure

- `core-services/gateway`: service root.
...
- `core-services/gateway/src/main/java/com/example/gateway/GatewayApplication.java`
...
- `core-services/gateway/src/main/java/com/example/gateway/producer/Producer.java`
- `core-services/gateway/src/main/java/com/example/gateway/filters/post/CustomAsyncFilter.java`
...
| egov.encrypted-endpoints-list | <secret-value> |
...
| otel.exporter.jaeger.endpoint | http://jaeger-collector.tracing:14250 |
