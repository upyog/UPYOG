...
> Generated from repository path `core-services/zuul`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Legacy Netflix Zuul API gateway for routing, authentication pre-checks, RBAC enforcement, rate limiting, and request enrichment.

## Responsibilities

- Own the `zuul` business or platform capability within the UPYOG ecosystem.
...
| contract | 3 source file(s) | Package area detected from source tree. |
...
| post | 5 source file(s) | Package area detected from source tree. |
| pre | 8 source file(s) | Package area detected from source tree. |
| producer | 1 source file(s) | Kafka/event producers. |
| revenues | 1 source file(s) | Package area detected from source tree. |
| route | 1 source file(s) | Package area detected from source tree. |
| util | 5 source file(s) | Reusable helpers and cross-cutting functions. |
| wrapper | 1 source file(s) | Package area detected from source tree. |

## Folder Structure

- `core-services/zuul`: service root.
...
- `core-services/zuul/src/main/java/org/egov/ZuulGatewayApplication.java`
...
- `core-services/zuul/src/main/java/org/egov/Utils/UserUtils.java`
...
- `core-services/zuul/src/main/java/org/egov/producer/Producer.java`
- `core-services/zuul/src/main/java/org/egov/filters/post/CustomAsyncFilter.java`
...
| egov.auth-service-uri | <secret-value> |
| egov.authorize.access.control.host | http://localhost:8091/ |
| egov.authorize.access.control.uri | access/v1/actions/_authorize |
| egov.open-endpoints-whitelist | <secret-value> |
| egov.mixed-mode-endpoints-whitelist | /pgr/seva/v1/_create,/pgr/seva/v1/_search,/pgr/seva/v1/_count,/workflow/history/v1/_search,/filestore/v1/files/id,/fi... |
| url.posthook.lists |  |
| url.prehook.lists |  |
...
| security.basic.enabled | false |
| management.security.enabled | false |
| zuul.sensitiveHeaders | <secret-value> |
| egov.auth-service-host | http://localhost:8081/ |
| egov.auth-service-uri | <secret-value> |
| egov.authorize.access.control.host | http://localhost:8091/ |
| egov.authorize.access.control.uri | access/v1/actions/_authorize |
