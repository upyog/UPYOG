...
> Generated from repository path `frontend/sv-ui`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `sv-ui` business or platform capability within the UPYOG ecosystem.
