...
> Generated from repository path `municipal-services/pet-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `pet-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/pet-services**
...
| contracts | 9 source file(s) | Package area detected from source tree. |
...
| ptr | 1 source file(s) | Package area detected from source tree. |
...
- `municipal-services/pet-services`: service root.
...
- `municipal-services/pet-services/src/main/java/org/egov/ptr/PetApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| ANY | /pet-registration/_create | PetController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| ANY | /pet-registration/_search | PetController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| ANY | /pet-registration/_update | PetController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| ANY | /pet-registration/trigger-expire-petapplications | PetController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| ANY | /pet-registration/trigger-advance-notification | PetController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_ptr_address, eg_ptr_applicationdocuments, eg_ptr_petdetails, eg_ptr_registration, eg_ptr_renewalauditdetails, shedlock
- **Migration files:** 7
...
- `municipal-services/pet-services/src/main/resources/db/migration`
- `municipal-services/pet-services/src/main/resources/db/migration/main`
- `municipal-services/pet-services/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/pet-services/src/main/java/org/egov/ptr/PetApplication.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/repository/DemandRepository.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/repository/IdGenRepository.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/repository/PetRegistrationRepository.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/repository/ServiceRequestRepository.java`
...
- `municipal-services/pet-services/src/main/java/org/egov/ptr/producer/Producer.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/producer/SenderConfig.java`

### Consumers

- `municipal-services/pet-services/src/main/java/org/egov/ptr/consumer/PetNotificationConsumer.java`
- `municipal-services/pet-services/src/main/java/org/egov/ptr/consumer/ReceiptConsumer.java`
...
- `municipal-services/pet-services/src/main/resources/application.properties`
...
- `municipal-services/pet-services/src/main/resources/db/Dockerfile`
