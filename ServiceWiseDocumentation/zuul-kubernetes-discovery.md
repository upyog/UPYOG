# zuul-kubernetes-discovery

> Generated from repository path `utilities/zuul-kubernetes-discovery`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

zuul-kubernetes-discovery module in the UPYOG platform.

## Responsibilities

- Own the `zuul-kubernetes-discovery` business or platform capability within the UPYOG ecosystem.
...
- `utilities/zuul-kubernetes-discovery`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as zuul_kubernetes_discovery
...
- `utilities/zuul-kubernetes-discovery/Dockerfile`
