...
> Generated from repository path `municipal-services/pt-services-v2`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Property Tax v2 property registry service.

## Responsibilities

- Own the `pt-services-v2` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/pt-services-v2**
- Detected controllers/API mappings: **9**
- Detected migrations: **9**
- Detected tests: **12** files

## Packages

| Package area | Files | Role |
| --- | --- | --- |
| builder | 2 source file(s) | Package area detected from source tree. |
...
| model | 53 source file(s) | Request, response, DTO, and domain models. |
...
- `municipal-services/pt-services-v2`: service root.
...
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/PropertyApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /demandBased/_generate | DemandBasedController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /drafts/_create | DraftsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /drafts/_update | DraftsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /drafts/_search | DraftsController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as pt_services_v2
...
- **Tables detected from migrations:** eg_pt_address_audit_v2, eg_pt_address_v2, eg_pt_document_owner_v2, eg_pt_document_propertydetail_v2, eg_pt_drafts_v2, eg_pt_institution_v2, eg_pt_owner_v2, eg_pt_property_audit_v2, eg_pt_property_v2, eg_pt_propertydetail_v2, eg_pt_unit_v2
- **Migration files:** 9
...
- `municipal-services/pt-services-v2/src/main/resources/db/migration`
- `municipal-services/pt-services-v2/src/main/resources/db/migration/main`
- `municipal-services/pt-services-v2/src/main/resources/db/migration/seed`

### Repository locations

- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/repository/DraftRepository.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/repository/IdGenRepository.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/repository/PropertyRepository.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/repository/ServiceRequestRepository.java`
...
| municipal-services/pt-services-v2/src/main/resources/property-services.yml topic | save-pt-property |
| municipal-services/pt-services-v2/src/main/resources/property-services.yml topic | update-pt-property |
| municipal-services/pt-services-v2/src/main/resources/property-services.yml topic | cancel-pt-propertyDetail |
| municipal-services/pt-services-v2/src/main/resources/property-services.yml topic | cancel-pt-property |
| municipal-services/pt-services-v2/src/main/resources/pt-drafts.yml topic | save-pt-drafts |
| municipal-services/pt-services-v2/src/main/resources/pt-drafts.yml topic | update-pt-drafts |

### Producers

- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/config/KafkaConfigBatch.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/producer/Producer.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/web/controllers/DemandBasedController.java`

### Consumers

- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/config/KafkaConfigBatch.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/config/KakfaConfiguration.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/consumer/DemandBasedConsumer.java`
- `municipal-services/pt-services-v2/src/main/java/org/egov/pt/consumer/PropertyNotificationConsumer.java`
...
| egov.mdms.v2.host | https://dev.digit.org/ |
...
- `municipal-services/pt-services-v2/src/main/resources/application.properties`
...
- `municipal-services/pt-services-v2/src/main/resources/db/Dockerfile`
