...
> Generated from repository path `municipal-services/advertisement-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Advertisement booking/application service.

## Responsibilities

- Own the `advertisement-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/adv-services**
- Detected controllers/API mappings: **6**
- Detected migrations: **7**
...
| --- | --- | --- |
| adv | 1 source file(s) | Package area detected from source tree. |
...
| validator | 6 source file(s) | Input and domain validation. |

## Folder Structure

- `municipal-services/advertisement-service`: service root.
...
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/Main.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /booking/v1/_create | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /booking/v1/_slot-search | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /booking/v1/_update | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /booking/v1/_search | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /booking/v1/_estimate | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /booking/_deletedraft | AdvertisementServiceApiController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as advertisement_service
...
- **Tables detected from migrations:** eg_adv_address_detail, eg_adv_applicant_detail, eg_adv_booking_detail, eg_adv_booking_detail_audit, eg_adv_document_detail, eg_adv_draft_detail, eg_adv_payment_timer, public.eg_adv_cart_detail, public.eg_adv_cart_detail_audit
- **Migration files:** 7
...
- `municipal-services/advertisement-service/src/main/resources/db/migration`
- `municipal-services/advertisement-service/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/repository/BookingRepository.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/repository/DemandRepository.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/repository/IdGenRepository.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/repository/ServiceRequestRepository.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/service/SchedulerService.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/repository/impl/BookingRepositoryImpl.java`
...
| municipal-services/advertisement-service/src/main/resources/advertisement-service-persister.yml topic | save-advertisement-booking |
| municipal-services/advertisement-service/src/main/resources/advertisement-service-persister.yml topic | save-advertisement-booking |

### Producers

- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/kafka/Producer.java`

### Consumers

- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/kafka/Consumer.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/kafka/consumer/NotificationConsumer.java`
- `municipal-services/advertisement-service/src/main/java/org/upyog/adv/kafka/consumer/PaymentUpdateConsumer.java`
...
- `municipal-services/advertisement-service/src/main/resources/application.properties`
- `municipal-services/advertisement-service/src/main/resources/advertisement-service-persister.yml`
...
- `municipal-services/advertisement-service/src/main/resources/db/Dockerfile`
