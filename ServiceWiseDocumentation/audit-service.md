...
> Generated from repository path `core-services/audit-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Audit log ingestion and query service.

## Responsibilities

- Own the `audit-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8280**
- Servlet/context path: **/audit-service**
- Detected controllers/API mappings: **4**
- Detected migrations: **2**
- Detected tests: **15** files
...
| contract | 11 source file(s) | Package area detected from source tree. |
| controller | 1 source file(s) | HTTP endpoints and request/response orchestration. |
| encryptionclient | 2 source file(s) | Package area detected from source tree. |
| enums | 1 source file(s) | Package area detected from source tree. |
| implementations | 2 source file(s) | Package area detected from source tree. |
| mapper | 1 source file(s) | DTO/entity conversion. |
| model | 7 source file(s) | Request, response, DTO, and domain models. |
| persisterauditclient | 2 source file(s) | Package area detected from source tree. |
...
- `core-services/audit-service`: service root.
...
- `core-services/audit-service/src/main/java/org/egov/auditservice/AuditServiceApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /log/v1/_create | AuditServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /log/v1/_search | AuditServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /log/v1/_verify | AuditServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /log/v1/_test | AuditServiceController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_audit_logs
- **Migration files:** 2
...
- `core-services/audit-service/src/main/resources/db/migration`
- `core-services/audit-service/src/main/resources/db/migration/main`

### Repository locations

- `core-services/audit-service/src/main/java/org/egov/auditservice/repository/AuditServiceRepository.java`
- `core-services/audit-service/src/main/java/org/egov/auditservice/repository/ServiceRequestRepository.java`
...
| core-services/audit-service/src/main/resources/configs/pgr-services-audit-persister.yml topic | save-pgr-request-audit |
| core-services/audit-service/src/main/resources/configs/pgr-services-audit-persister.yml topic | update-pgr-request |
| core-services/audit-service/src/main/resources/configs/pgr-services-audit-persister.yml topic | pgr-auto-escalation |

### Producers

- `core-services/audit-service/src/main/java/org/egov/auditservice/persisterauditclient/PersisterAuditClientService.java`
- `core-services/audit-service/src/main/java/org/egov/auditservice/producer/Producer.java`

### Consumers

- `core-services/audit-service/src/main/java/org/egov/auditservice/consumers/AuditLogsConsumer.java`
