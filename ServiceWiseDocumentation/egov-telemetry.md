...
> Generated from repository path `core-services/egov-telemetry`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

egov-telemetry module in the UPYOG platform.

## Responsibilities

- Own the `egov-telemetry` business or platform capability within the UPYOG ecosystem.
...
- `core-services/egov-telemetry`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_telemetry
