...
> Generated from repository path `core-services/egov-localization`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Localization message catalog and cache service.

## Responsibilities

- Own the `egov-localization` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8087**
- Servlet/context path: **/localization**
- Detected controllers/API mappings: **8**
- Detected migrations: **4**
- Detected tests: **25** files
...
| dto | 2 source file(s) | Package area detected from source tree. |
...
| model | 9 source file(s) | Request, response, DTO, and domain models. |
...
- `core-services/egov-localization`: service root.
...
- `core-services/egov-localization/src/main/java/org/egov/LocalizationServiceApplication.java`
...
| POST | /messages/v1/_search | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/v2/_search | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/v1/_upsert | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/v1/_create | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/cache-bust | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/v1/_update | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /messages/v1/_delete | MessageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_localization
...
- **Tables detected from migrations:** message
- **Migration files:** 4
...
- `core-services/egov-localization/src/main/resources/db/migration`
- `core-services/egov-localization/src/main/resources/db/migration/ddl`

### Repository locations

- `core-services/egov-localization/src/main/java/org/egov/persistence/repository/MessageCacheRepository.java`
- `core-services/egov-localization/src/main/java/org/egov/persistence/repository/MessageJpaRepository.java`
- `core-services/egov-localization/src/main/java/org/egov/persistence/repository/MessageRepository.java`

### Entity mapping locations

- `core-services/egov-localization/src/main/java/org/egov/persistence/entity/Message.java`
