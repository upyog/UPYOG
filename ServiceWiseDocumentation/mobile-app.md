...
> Generated from repository path `mobile-app`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `mobile-app` business or platform capability within the UPYOG ecosystem.
