...
> Generated from repository path `municipal-services/tl-calculator`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Trade license fee calculator and billing slab service.

## Responsibilities

- Own the `tl-calculator` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8085**
- Servlet/context path: **/tl-calculator**
...
| --- | --- | --- |
| broker | 1 source file(s) | Package area detected from source tree. |
...
| enums | 4 source file(s) | Package area detected from source tree. |
| mapper | 2 source file(s) | DTO/entity conversion. |
| model | 22 source file(s) | Request, response, DTO, and domain models. |
...
- `municipal-services/tl-calculator/src/main/java/org/egov/TLCalculatorApp.java`
...
| POST | /billingslab/{servicename}/_search | BillingslabController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/_calculate | CalculatorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/_getbill | CalculatorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/{servicename}/_estimate | CalculatorController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as tl_calculator
...
- **Tables detected from migrations:** eg_tl_billingslab, eg_tl_calculator_accessory, eg_tl_calculator_tradetype
- **Migration files:** 8
...
- `municipal-services/tl-calculator/src/main/resources/db/migration`
- `municipal-services/tl-calculator/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/tl-calculator/src/main/java/org/egov/tlcalculator/repository/BillingslabRepository.java`
- `municipal-services/tl-calculator/src/main/java/org/egov/tlcalculator/repository/CalculationRepository.java`
- `municipal-services/tl-calculator/src/main/java/org/egov/tlcalculator/repository/DemandRepository.java`
- `municipal-services/tl-calculator/src/main/java/org/egov/tlcalculator/repository/ServiceRequestRepository.java`
...
| municipal-services/tl-calculator/src/main/resources/config/tl-billing-slab-persister.yml topic | save-tl-billingslab |
| municipal-services/tl-calculator/src/main/resources/config/tl-billing-slab-persister.yml topic | update-tl-billingslab |
| municipal-services/tl-calculator/src/main/resources/config/tl-calculation-persister.yml topic | save-tl-calculation |

### Producers

- `municipal-services/tl-calculator/src/main/java/org/egov/tlcalculator/kafka/broker/TLCalculatorProducer.java`
...
- `municipal-services/tl-calculator/src/main/resources/application.properties`
...
- `municipal-services/tl-calculator/src/main/resources/db/Dockerfile`
