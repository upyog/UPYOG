...
> Generated from repository path `municipal-services/cnd-service`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Construction and demolition waste management service.

## Responsibilities

- Own the `cnd-service` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8080**
- Servlet/context path: **/cnd-service**
...
| --- | --- | --- |
| cdwm | 1 source file(s) | Package area detected from source tree. |
...
| model | 16 source file(s) | Request, response, DTO, and domain models. |
| notification | 5 source file(s) | Package area detected from source tree. |
...
| user | 9 source file(s) | Package area detected from source tree. |
...
- `municipal-services/cnd-service`: service root.
...
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/CNDApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /v1/_create | CNDController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_search | CNDController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /v1/_update | CNDController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** public.ug_cnd_address_details, public.ug_cnd_applicant_details, ug_cnd_application_details, ug_cnd_application_details_audit, ug_cnd_disposal_deposit_centre_detail, ug_cnd_disposal_deposit_centre_detail_audit, ug_cnd_document_detail, ug_cnd_document_detail_audit, ug_cnd_waste_detail, ug_cnd_waste_detail_audit
- **Migration files:** 3
...
- `municipal-services/cnd-service/src/main/resources/db/migration`
- `municipal-services/cnd-service/src/main/resources/db/migration/main`

### Repository locations

- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/repository/CNDServiceRepository.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/repository/DemandRepository.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/repository/IdGenRepository.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/repository/ServiceRequestRepository.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/repository/impl/CNDServiceRepositoryImpl.java`
...
| persister.create.cnd.service.with.profile.topic | save-cnd-application-with-profile |
...
| municipal-services/cnd-service/src/main/resources/cnd-persister.yml topic | save-cnd-application |
| municipal-services/cnd-service/src/main/resources/cnd-persister.yml topic | save-cnd-application |

### Producers

- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/kafka/Producer.java`

### Consumers

- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/kafka/Consumer.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/kafka/consumer/NotificationConsumer.java`
- `municipal-services/cnd-service/src/main/java/org/upyog/cdwm/kafka/consumer/PaymentUpdateConsumer.java`
...
| egov.cnd.calculator.host | http://localhost:8181/ |
| egov.cnd.calculator.endpoint | cnd-calculator/v1/_calculate |
...
| notification.url | https://upyog.niua.org/ |
...
- `municipal-services/cnd-service/src/main/resources/application.properties`
- `municipal-services/cnd-service/src/main/resources/cnd-persister.yml`
...
- `municipal-services/cnd-service/src/main/resources/db/Dockerfile`
