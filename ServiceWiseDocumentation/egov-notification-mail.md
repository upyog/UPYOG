...
> Generated from repository path `core-services/egov-notification-mail`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Kafka consumer for email notification delivery.

## Responsibilities

- Own the `egov-notification-mail` business or platform capability within the UPYOG ecosystem.
...
| mail | 1 source file(s) | Package area detected from source tree. |
...
- `core-services/egov-notification-mail`: service root.
...
- `core-services/egov-notification-mail/src/main/java/org/egov/web/notification/mail/EgovNotificationMailApplication.java`
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_notification_mail
...
- `core-services/egov-notification-mail/src/main/java/org/egov/web/notification/mail/repository/ServiceRequestRepository.java`
- `core-services/egov-notification-mail/src/main/java/org/egov/web/notification/mail/repository/UserRepository.java`
...
- `core-services/egov-notification-mail/src/main/java/org/egov/web/notification/mail/consumer/EmailNotificationListener.java`
- `core-services/egov-notification-mail/src/main/java/org/egov/web/notification/mail/consumer/SmsNotificationListener.java`
...
| mail.sender.password | <secret-value> |
