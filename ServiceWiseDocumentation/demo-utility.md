...
> Generated from repository path `utilities/demo-utility`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Demonstration/setup utility service.

## Responsibilities

- Own the `demo-utility` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8094**
- Servlet/context path: **/demoutility**
...
| model | 35 source file(s) | Request, response, DTO, and domain models. |
...
- `utilities/demo-utility`: service root.
...
- `utilities/demo-utility/src/main/java/org/egov/demoutility/DemoUtility.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /_createdemousers | DemoUtilityController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- `utilities/demo-utility/src/main/java/org/egov/demoutility/querybuilder/DemoQueryBuilder.java`
- `utilities/demo-utility/src/main/java/org/egov/demoutility/repository/ServiceCallRepository.java`
...
- `utilities/demo-utility/src/main/java/org/egov/demoutility/producer/Producer.java`

### Consumers

- `utilities/demo-utility/src/main/java/org/egov/demoutility/consumer/DemoUtilityConsumer.java`
...
| --- | --- |
| egov.user.host | http://egov-user:8080.egov/ |
| egov.user.oauth.url | <secret-value> |
| egov.hrms.host | http://egov-hrms:8080.egov/ |
| egov.hrms.create.endpoint | egov-hrms/employees/_create |
| egov.vendor.host | http://vendor:8080.egov/ |
...
- `utilities/demo-utility/src/main/resources/application.properties`
...
| --- | --- |
| server.port | 8094 |
| server.context-path | /demoutility |
| server.servlet.context-path | /demoutility |
...
| egov.hrms.password | <secret-value> |
| egov.user.password.update | <secret-value> |
| egov.hrms.host | http://egov-hrms:8080.egov/ |
| egov.hrms.create.endpoint | egov-hrms/employees/_create |
| egov.vendor.host | http://vendor:8080.egov/ |
...
- `utilities/demo-utility/Dockerfile`
