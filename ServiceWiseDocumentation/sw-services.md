...
> Generated from repository path `municipal-services/sw-services`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.

## Purpose

Sewerage connection lifecycle and workflow service.

## Responsibilities

- Own the `sw-services` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8091**
- Servlet/context path: **/sw-services**
...
- `municipal-services/sw-services`: service root.
...
- `municipal-services/sw-services/src/main/java/org/egov/swservice/SwServiceApplication.java`

## APIs

| Method | Endpoint | Controller | Input | Output | Authentication | Exceptions |
| --- | --- | --- | --- | --- | --- | --- |
| POST | /swc/_create | SewarageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /swc/_search | SewarageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /swc/_update | SewarageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /swc/_plainsearch | SewarageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
| POST | /swc/_encryptOldData | SewarageController.java | Request body follows service model/Swagger contract; validation is typically Bean Validation plus service validators. | Response follows DIGIT ResponseInfo pattern or service-specific model. | Gateway-authenticated unless listed in gateway open/mixed whitelist or explicitly anonymous. | Controller/service/repository/custom validation exceptions propagate through tracer/global handlers. |
...
- **Tables detected from migrations:** eg_sw_applicationdocument, eg_sw_connection, eg_sw_connection_audit, eg_sw_connectionholder, eg_sw_enc_audit, eg_sw_id_enc_audit, eg_sw_plumberinfo, eg_sw_roadcuttinginfo, eg_sw_service, eg_sw_service_audit
- **Migration files:** 21
...
- `municipal-services/sw-services/src/main/resources/db/migration`
- `municipal-services/sw-services/src/main/resources/db/migration/ddl`

### Repository locations

- `municipal-services/sw-services/src/main/java/org/egov/swservice/repository/IdGenRepository.java`
- `municipal-services/sw-services/src/main/java/org/egov/swservice/repository/ServiceRequestRepository.java`
- `municipal-services/sw-services/src/main/java/org/egov/swservice/repository/SewerageDaoImpl.java`
...
- `municipal-services/sw-services/src/main/java/org/egov/swservice/producer/SewarageConnectionProducer.java`

### Consumers

- `municipal-services/sw-services/src/main/java/org/egov/swservice/consumer/EditWorkflowNotificationConsumer.java`
- `municipal-services/sw-services/src/main/java/org/egov/swservice/consumer/FileStoreIdsConsumer.java`
- `municipal-services/sw-services/src/main/java/org/egov/swservice/consumer/ReceiptConsumer.java`
- `municipal-services/sw-services/src/main/java/org/egov/swservice/consumer/WorkflowNotificationConsumer.java`
...
- `municipal-services/sw-services/src/main/resources/application.properties`
...
- `municipal-services/sw-services/src/main/resources/db/Dockerfile`
