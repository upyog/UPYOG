...
> Generated from repository path `core-services/egov-url-shortening`. This page documents detected runtime configuration and source-code structure. Validate deployment-specific values against the environment/Helm chart used outside this repository.
...
- Own the `egov-url-shortening` business or platform capability within the UPYOG ecosystem.
...
- HTTP port: **8091**
- Servlet/context path: **/egov-url-shortening**
...
- `core-services/egov-url-shortening`: service root.
...
sequenceDiagram
    ...
    participant Client
    participant Gateway
    participant S as egov_url_shortening
...
- **Tables detected from migrations:** eg_url_shortener
- **Migration files:** 1
...
- `core-services/egov-url-shortening/src/main/resources/db/migration`
- `core-services/egov-url-shortening/src/main/resources/db/migration/main`

### Repository locations

- `core-services/egov-url-shortening/src/main/java/org/egov/url/shortening/repository/URLRedisRepository.java`
- `core-services/egov-url-shortening/src/main/java/org/egov/url/shortening/repository/URLRepository.java`
- `core-services/egov-url-shortening/src/main/java/org/egov/url/shortening/repository/UrlDBRepository.java`
...
- `core-services/egov-url-shortening/src/main/java/org/egov/url/shortening/producer/Producer.java`
